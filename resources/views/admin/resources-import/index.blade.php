    ...
    <section id="codeweek-resources-import-page" class="codeweek-page">
        ...
        <section class="codeweek-content-wrapper">
            ...
            <div class="mb-8">
                ...
                <form method="POST" action="{{ route('admin.resources-import.verify') }}" enctype="multipart/form-data" class="codeweek-form">
                    @csrf
                    ...
                    <div class="codeweek-form-inner-container">
                        ...
                        <div class="codeweek-form-button-container">
                            <div class="codeweek-button">
                                <input type="submit" value="Verify" class="bg-primary cursor-pointer px-6 py-3 rounded-full font-semibold text-[#20262C] hover:bg-hover-orange duration-300">
                            </div>
                        </div>
                    </div>
                </form>
