...
@section('content')
    ...
    <div class="container">
        ...
        <p class="aluminum">Required fields are marked with an * asterisk. Feel free to add the event listing in your
            local language.</p>
        ...
        <form enctype="multipart/form-data" method="post" id="event" role="form" class="form-horizontal clearfix"
            ...
            <div class="clearfix">
                <div class="col-md-6 first">
                    ...
                    <label for="id_title" class="col-sm-3 control-label">* Event title</label>

                        <div class="col-sm-9">
                            <input class="form-control" id="id_title" maxlength="255" name="title"
                                   placeholder="How do you call this event?" type="text"
                                   value="{{old('title')}}">
                        </div>
                    ...
                    <div class="form-group @if($errors->has('organizer')) has-error @endif">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" id="id_organizer" maxlength="255"
                                   name="organizer"
                                   placeholder="Who is organizing this event?" type="text"
                                   value="{{old('organizer')}}"
                            >
                        </div>
                            ...
                            <ul id="id_theme">
                                ...
                                @foreach($themes as $theme)
                                    <li><label for="id_theme_0"><input id="id_theme_{{$theme->id}}" name="theme[]"
                                                                       type="checkbox"
                                                                       value="{{$theme->id}}"> {{$theme->name}}</label></li>
                                @endforeach
                ...
                <div class="col-md-6">
                                        ...
                                        <div style="z-index: 1; position: absolute; top: 0px; left: 0px; width: 100%; transform-origin: 0px 0px 0px; transform: matrix(1, 0, 0, 1, 0, 0);">
                                            ...
                                            <div style="position: absolute; z-index: 0; left: 0px; top: 0px;">
                                                <div style="overflow: hidden; width: 389px; height: 250px;">
                                                    <img
                                                            src="https://maps.googleapis.com/maps/api/js/StaticMapService.GetMapImage?1m2&amp;1i2018&amp;2i1331&amp;2e1&amp;3u4&amp;4m2&amp;1u389&amp;2u250&amp;5m5&amp;1e0&amp;5sen-US&amp;6sus&amp;10b1&amp;12b1&amp;token=23326"
                                                            style="width: 389px; height: 250px;"></div>
                                            </div>
                                            <div style="position: absolute; left: 0px; top: 0px; z-index: 0;">
                                                <div aria-hidden="true"
                                                     style="position: absolute; left: 0px; top: 0px; z-index: 1; visibility: inherit;">
                    ...
                    <div class="form-group @if($errors->has('start_date')) has-error @endif">
                        ...
                        <div class="col-sm-9 input-group">
                            ...
                            <input autocomplete="off" class="form-control" id="id_datepicker_start"
                                   name="start_date"
                                   placeholder="When does it start?" type="text"
                                   value="{{old('start_date')}}">

                        </div>

                        <span class="help-block col-sm-9 col-sm-offset-3">Example: YYYY/MM/DD h:m</span>
                    ...
                    <div class="form-group @if($errors->has('end_date')) has-error @endif">
                        ...
                        <div class="col-sm-9 input-group">
                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                            <input autocomplete="off" class="form-control" id="id_datepicker_end"
                                   name="end_date"
                                   placeholder="When does it end?" type="text"
                                   value="{{old('end_date')}}">
...
@push('scripts')
    ...
    <script type="text/javascript" src="/lib/bootstrap-sass/javascripts/bootstrap/tooltip.js"></script>
