                        ...
                        <div class="codeweek-form-inner-container">
                                ...
                                <div
                                    ...
                                    <div class="flex flex-col w-full md:max-w-[472px]">
                                        <input
                                            ...
                                            type="text" value="{{ old('title', $event->title) }}">
                                    </div>
                                        ...
                                        <div class="relative inline-block w-full text-gray-700">
                                            <select id="id_activity_type" name="activity_type"
                                                ...
                                                <option value="open-online"
                                                    {{ $event->activity_type == 'invite-online' ? 'selected' : '' }}>
                                                ...
                                                <option value="open-in-person"
                                                    {{ $event->activity_type == 'open-in-person' ? 'selected' : '' }}>
                                                    @lang('event.activitytype.open-in-person')
                                                </option>
                                                <option value="invite-in-person"
                                                    {{ $event->activity_type == 'invite-in-person' ? 'selected' : '' }}>
                                                    @lang('event.activitytype.invite-in-person')
                                                </option>
                                                <option value="other"
                                                    {{ is_null($event->activity_type) || $event->activity_type == 'other' ? 'selected' : '' }}>
                            ...
                            <div class="flex flex-wrap mt-4 codeweek-form-field-wrapper">
                                <div
                                    ...
                                    <date-time :start-date-value="'{{ old('start_date', $event->start_date) }}'"
                                        :end-date-value="'{{ old('end_date', $event->end_date) }}'"
                                        placeholder-start="@lang('event.start.placeholder')" placeholder-end="@lang('event.end.placeholder')"></date-time>
                                </div>
                                <div
                                    class="flex flex-row items-center justify-between w-full codeweek-form-field max-sm:flex-col max-sm:items-start">
                                    <label class="text-form  leading-6 text-black w-[147px] whitespace-nowrap"
                            ...
                            <div class="flex flex-wrap mt-4 codeweek-form-field-wrapper">
                                <div
                                    ...
                                    <textarea
                                        ...
                                        cols="40" id="id_description" name="description" placeholder="@lang('event.description.placeholder')" rows="10">{{old('description',$event->description)}}</textarea>
                                </div>
                                <div
                                    class="flex flex-row items-center justify-between w-full codeweek-form-field max-sm:flex-col max-sm:items-start">
                                    <label class="text-form leading-6 text-black w-[147px] whitespace-nowrap"
                            ...
                            <div class="flex flex-wrap mt-4 codeweek-form-field-wrapper">
                                <div
                                    ...
                                    <multiselect 
                                        class="w-full max-w-[472px]" 
                                        :options="{{ $audiences }}"
                                        value="{{$selected_audiences}}" 
                                        name="audience" 
                                        :multiple="true"
                                        label="event.audience" 
                                        placeholder="Select audience"></multiselect>
                            ...
                            <div class="flex flex-wrap mt-4 codeweek-form-field-wrapper">
                                <div
                                    ...
                                    <multiselect class="w-full max-w-[472px]" 
                                        :options="{{ $themes }}"
                                        value="{{$selected_themes}}" 
                                        name="theme" 
                                        :multiple="true"
                                        label="event.theme" 
                                        placeholder="Select activity type"></multiselect>
                                </div>
                                <div
                                    class="flex flex-row items-center justify-between w-full codeweek-form-field max-sm:flex-col max-sm:items-start">
                                    <label class="text-form  leading-6 text-black w-[147px] whitespace-nowrap"
                                ...
                                <div
                                    ...
                                    <div class="flex flex-col w-full md:max-w-[472px]">
                                        <input type="number" id="id_participants_count" name="participants_count"
                                            ...
                                            value="{{ old('participants_count', $event->participants_count) }}" />

                                        <div class="flex flex-col p-4 mt-4 rounded-2xl bg-pearl max-w-[472px]"
                                            aria-labelledby="gender-count-title" x-data="{
                                                femaleCount: {{ old('percentage_of_females', $event->percentage_of_females, 0) }},
                                                maleCount: {{ old('percentage_of_males', $event->percentage_of_males, 0) }},
                                                otherCount: {{ old('percentage_of_other', $event->percentage_of_other, 0) }}
                                            }">
                                            ...
                                            <div class="flex flex-row flex-wrap justify-between w-full gap-2 mb-2">
                                                ...
                                                <div class="flex flex-row items-center max-w-[218px]">
                                                    ...
                                                    <input type="number" id="percentage_of_females"
                                                        ...
                                                        value="{{ old('percentage_of_females', $event->percentage_of_females) }}" />
                                                </div>
                                                ...
                                                <div class="flex flex-row items-center max-w-[218px]">
                                                    ...
                                                    <input type="number" id="percentage_of_males" name="percentage_of_males"
                                                        ...
                                                        class="text-center py-3 text-form w-[141px] rounded-3xl shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-dark-orange focus-within:placeholder-dark-orange max-md:px-5 max-md:max-w-full"
                                                        value="{{ old('percentage_of_males', $event->percentage_of_males) }}" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex flex-row flex-wrap w-full gap-2">
                                                ...
                                                <div class="flex flex-row items-center max-w-[218px]">
                                                    ...
                                                    <input type="number" id="percentage_of_other" name="percentage_of_other"
                                                        ...
                                                        class="text-center py-3 text-form w-[141px] rounded-3xl shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-dark-orange focus-within:placeholder-dark-orange max-md:px-5 max-md:max-w-full"
                                                        value="{{ old('percentage_of_other', $event->percentage_of_other) }}" />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="flex flex-col gap-2.5 w-full md:max-w-[472px]">
                                        ...
                                        <div class="flex flex-row items-center mr-4">
                                            <input type="radio" id="age_0_5" name="age_group" value="0-5"
                                                ...
                                                {{ old('age_group', $event->age_group) == '0-5' ? 'checked' : '' }}
                                        ...
                                        <div class="flex items-center flex-row mb-2.5">
                                            <input type="radio" id="age_6_18" name="age_group" value="6-18"
                                                class="w-[24px] h-[24px] mr-2 text-black bg-gray-100 border-gray-300 focus:ring-dark-orange focus:ring-2"
                                                {{ old('age_group', $event->age_group) == '6-18' ? 'checked' : '' }}
                                        ...
                                        <div class="flex items-center flex-row mb-2.5">
                                            <input type="radio" id="age_19_25" name="age_group" value="19-25"
                                                class="w-[24px] h-[24px] mr-2 text-black bg-gray-100 border-gray-300 focus:ring-dark-orange focus:ring-2"
                                                {{  old('age_group', $event->age_group) == '19-25' ? 'checked' : '' }}
                                        ...
                                        <div class="flex items-center flex-row mb-2.5">
                                            <input type="radio" id="age_over_25" name="age_group" value="Over 25"
                                                class="w-[24px] h-[24px] mr-2 text-black bg-gray-100 border-gray-300 focus:ring-dark-orange focus:ring-2"
                                               {{ old('age_group', $event->age_group) == 'Over 25' ? 'checked' : '' }}
                                    ...
                                    <div class="flex flex-row items-center w-full md:max-w-[472px]">
                                        <div class="flex flex-row items-center mr-4">
                                            <input type="radio" id="extracurricular_yes" name="extracurricular_activity"
                                                value="yes"
                                                class="w-[24px] h-[24px] mr-2 text-black bg-gray-100 border-gray-300 focus:ring-dark-orange focus:ring-2"
                                                @if (old('extracurricular_activity', $event->extracurricular_activity) == 'yes') checked @endif required />
                                        ...
                                        <div class="flex items-center">
                                            <input type="radio" id="extracurricular_no" name="extracurricular_activity"
                                                value="no"
                                                class="w-[24px] h-[24px] mr-2 text-black bg-gray-100 border-gray-300 focus:ring-dark-orange focus:ring-2"
                                                @if (old('extracurricular_activity', $event->extracurricular_activity) == 'no') checked @endif required />
                                        ...
                                        <div class="flex flex-row items-center w-full mb-4">
                                            <div class="flex flex-row items-center mr-4">
                                                <input type="radio" id="recurring_event_yes" name="recurring_event"
                                                    value="yes"
                                                    class="w-[24px] h-[24px] mr-2 text-black bg-gray-100 border-gray-300 focus:ring-dark-orange focus:ring-2"
                                                    @if (old('recurring_event', $event->recurring_event) == 'yes') checked @endif
                                            ...
                                            <div class="flex items-center">
                                                <input type="radio" id="recurring_event_no" name="recurring_event"
                                                    value="no"
                                                    class="w-[24px] h-[24px] mr-2 text-black bg-gray-100 border-gray-300 focus:ring-dark-orange focus:ring-2"
                                                    @if (old('recurring_event', $event->recurring_event) == 'no') checked @endif
                                            ...
                                            <div class="flex items-center w-full gap-6 mt-4 whitespace-nowrap">
                                                <div class="relative flex items-center self-stretch gap-2 my-auto">
                                                    <input type="radio" id="daily" name="frequency" value="daily"
                                                        ...
                                                        @if (old('frequency', $event->frequency) == 'daily') checked @endif />
                                ...
                                <div
                                    ...
                                    <div class="w-full group-fields max-w-[472px]">
                                        <input
                                            ...
                                            value="{{ old('codeweek_for_all_participation_code', $event->codeweek_for_all_participation_code) }}"
                            ...
                            <div class="flex flex-wrap mt-4 codeweek-form-field-wrapper">
                                <div
                                    ...
                                    <singleselect class="w-full max-w-[472px]"
                                        ...
                                        value="{{ old('leading_teacher_tag', $event->leading_teacher_tag) }}" name="leading_teacher_tag"
                        ...
                        <div class="flex flex-col mt-4 codeweek-form-field-wrapper">
                            <div
                                ...
                                <input
                                    ...
                                    type="text" value="{{ old('organizer', $event->organizer) ?: $location->name ?? '' }}">
                            </div>
                            <div
                                class="flex flex-row items-center justify-between w-full codeweek-form-field max-sm:flex-col max-sm:items-start">
                                <label class="text-form  leading-6 text-black w-[147px] whitespace-nowrap"
                                ...
                                <div class="flex flex-col w-full md:max-w-[472px]">
                                    <div class="relative inline-block w-full text-gray-700">
                                        <select
                                            ...
                                            <option value="school" {{ old('organizer_type', $event->organizer_type) == 'school' ? 'selected' : '' }}>
                                                @lang('event.organizertype.school')</option>
                                            <option value="library"
                                                {{ old('organizer_type', $event->organizer_type) == 'library' ? 'selected' : '' }}>@lang('event.organizertype.library')
                                            </option>
                                            <option value="non profit"
                                                {{ old('organizer_type', $event->organizer_type) == 'non profit' ? 'selected' : '' }}>
                                                @lang('event.organizertype.non profit')</option>
                                            <option value="private business"
                                                {{ old('organizer_type', $event->organizer_type) == 'private business' ? 'selected' : '' }}>
                                                @lang('event.organizertype.private business')</option>
                                            <option value="other" {{ old('organizer_type', $event->organizer_type) == 'other' ? 'selected' : '' }}>
                        ...
                        <div class="flex flex-wrap mt-4 codeweek-form-field-wrapper">
                            <div
                                ...
                                <input
                                    ...
                                    type="text" value="{{ old('event_url',$event->event_url) }}">
                            </div>
                            <div
                                class="flex flex-row items-center justify-between w-full codeweek-form-field max-sm:flex-col max-sm:items-start">
                                <label class="text-form  leading-6 text-black w-[147px] whitespace-nowrap"
                        ...
                        <div class="flex flex-wrap mt-4 codeweek-form-field-wrapper">
                            <div
                                ...
                                <input
                                    ...
                                    placeholder="@lang('event.public.placeholder')" type="text" value="{{ old('contact_person',$event->contact_person) }}">
                            </div>
                            <!-- Error Display -->
                            <div
                                class="flex flex-row items-center justify-between w-full codeweek-form-field max-sm:flex-col max-sm:items-start">
                                ...
                                <div
                                    ...
                                    <div class="flex flex-col w-full md:max-w-[472px]">
                                        <input
                                            ...
                                            placeholder="@lang('event.contact.placeholder')" value="{{ old('user_email',$event->user_email) }}" track-by="tag"
                                            label="tag">
                                    </div>
                                </div>
                                <div
