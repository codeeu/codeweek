    ...
    <div class="card-content">
        ...
        <h5 class="card-title">{{ $event->title }}</h5>
            <div class="card-subtitle"
                 style="text-transform: capitalize;">Updated at: {{Carbon\Carbon::parse($event->updated_at)->isoFormat('llll')}}</div>
            <div class="card-subtitle"
             style="text-transform: capitalize;">Activity Date: {{Carbon\Carbon::parse($event->start_date)->isoFormat('llll')}}</div>
