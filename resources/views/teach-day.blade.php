            ...
            <div style="background-color:#DBEFF3" class="p-10">
                <div><h2><strong>What to expect from Teach Day?</strong></h2>
                    <ul class="leading-7 ml-2 mt-0 checklist">
                        <li style="font-size: 15px; font-family: PT Sans, Roboto;">Opening speech by <strong>Thierry Breton,
                                European Commissioner for Internal Market</strong></li>
                        <li style="font-size: 15px; font-family: PT Sans, Roboto;"><strong>Keynotes</strong> and different point
                        ...
                        <li style="font-size: 15px; font-family: PT Sans, Roboto;"><strong>Panel debates</strong> with education
                            experts and researchers
                        </li>
                        <li style="font-size: 15px; font-family: PT Sans, Roboto;"><strong>Workshops</strong> hosted by
                            international education experts addressing various topics and sharing fresh ideas from the
                            coding world
                        </li>
                        <li style="font-size: 15px; font-family: PT Sans, Roboto;"><strong>Exhibitions</strong> organized by top
                        ...
                        <li style="font-size: 15px; font-family: PT Sans, Roboto;">Enjoying an online experience similar to a
                            <strong>real-life</strong> event
                        </li>
                        <li style="font-size: 15px; font-family: PT Sans, Roboto;"><strong>Interactions</strong> with
