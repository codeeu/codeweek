            ...
            <div style="background-color:#DBEFF3" class="p-10">
                <div><h2><strong>What to expect from Teach Day?</strong></h2>
                    <ul class="leading-7 ml-2 mt-0 checklist">
                            <li style="font-size: 15px; font-family: PT Sans;">Opening speech by <strong>Thierry Breton, European Commissioner for Internal Market</strong></li>
                            <li style="font-size: 15px; font-family: PT Sans;"><strong>Keynotes</strong> and different point of views on coding, digital creativity, and other topics from inspiring speakers such as <strong>Massimo Banzi</strong>, Co-founder of Arduino and <strong>Alessandro Bogliolo</strong>, EU Code Week ambassador coordinator, Professor, School of Information, Science and Technology at the University of Urbino</li>
                            <li style="font-size: 15px; font-family: PT Sans;"><strong>Panel debates</strong> with education experts and researchers</li>
                            <li style="font-size: 15px; font-family: PT Sans;"><strong>Workshops</strong> hosted by international education experts addressing various topics and sharing fresh ideas from the coding world</li>
                            <li style="font-size: 15px; font-family: PT Sans;"><strong>Exhibitions</strong> organized by top IT companies and major NGOs active in the education field and supporting coding in schools. Among them: Code Club, Code.org, Google, Meet&amp;Code, Public Libraries 2030</li>
                            <li style="font-size: 15px; font-family: PT Sans;">Enjoying an online experience similar to a <strong>real-life</strong> event</li>
                            <li style="font-size: 15px; font-family: PT Sans;"><strong>Interactions</strong> with participants and speakers, exchange ideas, knowledge, success stories and have fun</li>
                    </ul>
                    <p>&nbsp;</p>
                    <h2><strong>Our workshops</strong></h2>
                    <ul class="leading-7 ml-2 mt-0 checklist">

                            <li style="font-size: 15px; font-family: PT Sans;"><strong>AI and machine learning: real life use cases </strong>– Marco Neves, Informatics Teacher, AE Batalha<br>An ecosystem of various digital technologies is revolutionizing our world and our lifestyle. Artificial intelligence is probably the most powerful and impactful, especially through Machine Learning. During the workshop, you will explore some of the most striking examples of AI in our lives and understand how they shape our daily activities.</li>
                            <li style="font-size: 15px; font-family: PT Sans;"><strong>e-literature, the poetic side of coding </strong>– Jaka Zeleznikar, Guest Teacher, School of Arts of the University of Nova Gorica<br>This workshop will provide basic insight into e-literature (creative writing + digital platforms + computation, not e-books). In practice, you will focus on a simple but interesting task: writing over websites. No damage will be done as changes will be only local, but this task provides great insight into the importance of the context of a message, as well as practical experience of the easy manipulation of digital content, raising awareness of the dangers of on-line manipulation.</li>
                            <li style="font-size: 15px; font-family: PT Sans;"><strong>Game Design for Starters! Creating interactive experiences in 30 minutes or less</strong> – Matthias Löwe, EU Code Week ambassador for Germany<br>Games can be many things – from big 3D worlds to a form of artistic expression, an entry in a game jam or an experimental performance…In this workshop, we will showcase some games, talk about game design as a creative method, and finally: create a full game in 30min or less. No prior knowledge necessary!</li>
                            <li style="font-size: 15px; font-family: PT Sans;"><strong>Inclusion, Accessibility and Coding </strong> (TBC) – Marijana Smolcec &amp; Danijel Forjan<br></li>
                            <li style="font-size: 15px; font-family: PT Sans;"><strong>Learn to code creatively with music! </strong> – Elisabetta Nanni, EU Code Week Leading Teacher &amp; Music Teacher and Digital Innovator, Istituto Comprensivo Rovereto Nord<br>STEM or STEAM? What’s the meaning of A in STEAM? A is for Arts and schools must develop creativity in their students with Art and Music. Elisabetta Nanni will introduce you to a digital toolbox that can help to improve the creativity of your students. Scratch3.0 and Sonic Pi will help you learn to compose or perform music using code.</li>
                            ...
                            <li style="font-size: 15px; font-family: PT Sans;"><strong>Schools, defenders of the Earth</strong> – Anthi Arkouli, Kindergarten Teacher of 2nd Kindergarten of Peristeri &amp; ICT Trainer; Maria Tsapara, EU Code Week Leading Teacher, Kindergarten Teacher of 2nd Kindergarten of Perama, ICT Trainer &amp; Scientix Ambassador<br>This workshop will present activities inspired by the framework of the 17 sustainable development goals as a part of an eTwinning project called “Schools, defenders of the Earth”.The purpose of the project was to inform and raise awareness of the causes of climate change and to take action to eradicate them and create a green planet. In this project, coding has become a tool to enrich the educational practices of teachers. Through these activities pre-primary school pupils can develop and cultivate competencies such as collaboration, communication, creativity and computational thinking.</li>
                            <li style="font-size: 15px; font-family: PT Sans;"><strong>Tinkering and STEAM with micro:bit</strong> – Pauline Maas, EU Code Week ambassador for the Netherlands &amp; EU Code Week Leading Teacher<br>This workshop will demonstrate how to use micro:bit in your STEAM lessons. You will learn about the creative ideas and tinkering examples Pauline Maas has done with her students. She will explain the use of a design canvas for micro:bit, so you can use the 21st century learning skills in your lessons. Take a look at her Instagram to get an ideas : @microbit101.</li>
