            ...
            <div style="background-color:#DBEFF3" class="p-10">
                <div><h2><strong>What to expect from Teach Day?</strong></h2>
                    ...
                    <ul class="leading-7 ml-2 mt-0 checklist">
                            ...
                            <li style="font-size: 15px; font-family: PT Sans;"><strong> In the age of Web 3.0</strong> – Adil Tugyan, EU Code Week Leading Teacher <br> Web 3.0 shifts the web from an informational medium to a service-oriented and community-based medium. Web 3.0 is being referred to by experts as the ‘semantic web’ (semantic meaning data driven). The data will come from the user and the web will essentially adjust to meet their needs.</li>
