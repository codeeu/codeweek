...
{{--         alt="" class="absolute inset-0 -z-10 h-full w-full object-cover">--}}
    ...
    <div class="bg-blue-50/75 shadow sm:rounded-lg m-4">
        <div class="px-4 py-5 sm:p-6 flex flex-col justify-center h-full">
            ...
            <div class="mt-5">
                <button onclick="location.href='{{route("coding@home")}}';" type="button" class="inline-flex items-center rounded-md bg-orange-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">View Materials</button>
            </div>
        </div>
    </div>
    ...
    <div class="bg-blue-50/75 shadow sm:rounded-lg m-4">
        <div class="px-4 py-5 sm:p-6 flex flex-col justify-center h-full">
            ...
            <div class="mt-2 max-w-xl text-sm text-gray-500 grow">
                <p>Here you can find free training materials & resources that will help you get started and plan your next innovative lesson. Short modules to explain computational thinking.</p>
                <p>Online courses offer professional development opportunities and support teachers with coding and computational thinking in the classroom.</p>
            </div>
            <div class="mt-5">
                <button onclick="location.href='{{route("training.index")}}';" type="button" class="inline-flex items-center rounded-md bg-orange-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">View Materials</button>
            </div>
        </div>
    </div>
        ...
        <div class="bg-blue-50/75 shadow sm:rounded-lg m-4">
            <div class="px-4 py-5 sm:p-6 flex flex-col justify-center h-full">
                ...
                <div class="mt-2 max-w-xl text-sm text-gray-500 grow">
                    <p>Browse our repository and find the perfect resource to start or to continue your coding journey. All of these resources are free of charge.</p>
                </div>
                <div class="mt-5">
                    <button onclick="location.href='{{route("resources_learn")}}';" type="button" class="inline-flex items-center rounded-md bg-orange-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">View Materials</button>
                </div>
            </div>
        </div>
        ...
        <div class="bg-blue-50/75 shadow sm:rounded-lg m-4">
            <div class="px-4 py-5 sm:p-6 flex flex-col justify-center h-full">
                ...
                <div class="mt-2 max-w-xl text-sm text-gray-500 grow">
                    <p>Access a repository of resources that will help you teach coding at home, in the classroom or in a code club. Browse free-fof-charge teaching resources to bring coding and programming to your teacher practice.</p>
                </div>
                <div class="mt-5">
                    <button onclick="location.href='{{route("resources_teach")}}';" type="button" class="inline-flex items-center rounded-md bg-orange-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">View Materials</button>
                </div>
            </div>
        </div>
