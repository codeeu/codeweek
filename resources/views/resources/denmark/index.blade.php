...
@section('content')
  ...
  <ul>
    ...
    <li><a href="http://www.codeavengers.com/javascript/17?l=da">Code Avengers</a> I denne 40 minutters introduktion vil du komme til at bruge JavaScript til at bygge et spil som du kan dele med dine venner.</li>
   	...
   	<li><a href="http://html-hajen.dk/">HTML-Hajen</a> Tips, trick og workarounds til opbygning og desig af hjemmesider. Fra grundliggende HTML-koder til style sheets, JavaScripts og XML-databaser.</li>
   	<li><a href="http://www.kodeklub.cfdp.dk/">Kodeklub</a> - dansk udgave af Code Club med dansksprogede værktøjer til at starte din egen kodeklub</a></li>
   	<li><a href="https://docs.google.com/a/okfn.org/spreadsheets/d/1uXvSZWBy-IcWOl0LlUG_2-SxQJzsLOobf2ZddP85GIQ/edit#gid=0">Programmering i skolen</a> - independently produced list of grade schools doing coding-activities (still being expanded, work in progress - join in!)</a></li>
   	<li><a href="https://docs.google.com/a/okfn.org/document/d/1QyQ5Tm4XEHpizRvju3RBytGsMv6Qv0OM-Gw6cZhXdTU/edit#">Programmering i skolen, projektidé - by <a href="https://twitter.com/mathiaspoulsen">@mathiaspoulsen</a> and <a href="http://twitter.com/mosgaard">@mosgaard</a></a> - grade school teachers planning potential Codeweek activities (work in progress - join in!)</a></li>
   	<li><a href="http://vejentilteknologi.vejenskoler.dk/">Vejen til Teknolologi</a> - ressourcer til brug i grundskolen</li>
  </ul>
