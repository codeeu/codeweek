...
{{--                        <div class="location">@lang('hackathons.cities.1.country')</div>--}}
                ...
                <div class="codeweek-card-grid">
                    <div class="city-image">
                        <img src="/images/hackathons/flags/italy.png" style="opacity: 0.4;filter: alpha(opacity=40); background-color: #000;">
                        <div class="text">
                            <div class="title hackathon">Coming Soon</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="codeweek-card-grid">
                    <div class="city-image">
                        <img src="/images/hackathons/flags/greece.png" style="opacity: 0.4;filter: alpha(opacity=40); background-color: #000;">
                        <div class="text">
                            <div class="title hackathon">Coming Soon</div>
                        </div>
                    </div>
                ...
                <div class="codeweek-card-grid">
                    <div class="city-image">
                        <img src="/images/hackathons/flags/slovenia.png" style="opacity: 0.4;filter: alpha(opacity=40); background-color: #000;">
                        <div class="text">
                            <div class="title hackathon">Coming Soon</div>
                        </div>
                    </div>
                ...
                <div class="codeweek-card-grid">
                    <div class="city-image">
                        <img src="/images/hackathons/flags/latvia.png" style="opacity: 0.4;filter: alpha(opacity=40); background-color: #000;">
                        <div class="text">
                            <div class="title hackathon">Coming Soon</div>
                        </div>
                    </div>
...
{{--                            </div>--}}
{{--                        </div>--}}
{{--                        <div class="date">@lang('hackathons.cities.6.country')</div>--}}
