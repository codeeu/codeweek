...
@section('hackathons.header')
    @include('hackathons.before.header', ["registration_link"=>"https://ec.europa.eu/eusurvey/runner/EUCWHackathonItaly"])
@endsection
...
{{--                </section>--}}
        ...
        <section id="about-codeweek">
            <div class="text">
                ...
                <p>@lang('hackathon-italy.sections.12.content.0') @lang('hackathon-italy.sections.12.content.1') @lang('hackathon-italy.sections.12.content.2')</p><br/><br/>
                <p>@lang('hackathon-italy.sections.12.content.3') <b>@lang('hackathon-italy.sections.12.content.4')</b> @lang('hackathon-italy.sections.12.content.5') <b>@lang('hackathon-italy.sections.12.content.6')</b>
            ...
            <a target="_blank" href="https://codeweek.eu/about" class="codeweek-action-link-button">@lang('hackathon-italy.sections.12.content.9')</a>
        </section>
