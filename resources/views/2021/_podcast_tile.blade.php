<div class="bg-gray-200 w-90 shadow-lg rounded p-2">
    <div class="group relative">
        ...
        <div x-on:click="window.location='{{route('podcast', $podcast)}}'" class="cursor-pointer absolute bg-black rounded bg-opacity-0 group-hover:bg-opacity-60 w-full h-full top-0 flex items-center group-hover:opacity-100 duration-700 transition justify-evenly">
