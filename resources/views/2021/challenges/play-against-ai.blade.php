                    ...
                    <div id="challenge-left-col" class="flex flex-col gap-6">
                        <div class="bg-white p-6 rounded-lg flex lg:flex-col 2xl:flex-row flex-wrap gap-4 2xl:gap-8">
                            <div>
                                ...
                                <div class="w-fit px-4 py-1.5 bg-light-blue-100 rounded-full flex items-center gap-2">
                                    ...
                                    <p class="text-slate-500 p-0 text-default font-semibold">@lang("challenges-content.$slug.duration")</p>
                                </div>
                            </div>
                            <div>
                        ...
                        <div class="bg-white p-6 rounded-lg">
                            ...
                            <ol class="list-decimal ml-4">
                                ...
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">@lang("challenges-content.$slug.purposes.3")</li>
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">@lang("challenges-content.$slug.purposes.4")</li>
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">@lang("challenges-content.$slug.purposes.5")</li>
                            </ol>
                        </div>
                        <div class="bg-white p-6 rounded-lg">
                            ...
                            <ol class="list-decimal ml-4">
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">
                                    <a class="text-dark-blue" target="_blank" href="https://teachablemachine.withgoogle.com/">Teachable Machine</a>
                                </li>
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">
                                    <a class="text-dark-blue" target="_blank" href="https://pictoblox.ai/">Pictoblox</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                    <div class="col-span-2">
                        <div class=" bg-white px-6 py-8 lg:p-16 rounded-lg">
                            ...
                            <div class="mb-6">
                                ...
                                <ol class="list-disc ml-4 mb-6 [&_li]:my-2 leading-[22px] md:leading-[30px]">
                                ...
                                <p class="font-semibold text-xl p-0 mb-2">Teachable Machine:</p>
                                <ol class="list-disc ml-4 mb-6 [&_li]:my-2 leading-[22px] md:leading-[30px]">
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-content.$slug.instructions.2")
                                        <img class="mt-3" width="400px"  src="{{asset('img/2021/challenges/play-against-ai-1.png')}}"/>
                                    </li>
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-content.$slug.instructions.3")
                                        <img class="mt-3" width="400px"  src="{{asset('img/2021/challenges/play-against-ai-2.png')}}"/>
                                    </li>
                                </ol>
                                <p class="font-semibold text-xl p-0 mb-2">Pictoblox:</p>
                                <ol class="list-disc ml-4 mb-6 [&_li]:my-2 leading-[22px] md:leading-[30px]">
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-content.$slug.instructions.4")
                                        <img class="mt-3" width="400px"  src="{{asset('img/2021/challenges/play-against-ai-3.png')}}"/>
                                    </li>
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-content.$slug.instructions.5")
                                        <img class="mt-3" width="400px"  src="{{asset('img/2021/challenges/play-against-ai-4.png')}}"/>
                                    </li>
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-content.$slug.instructions.6")
                                        <img class="mt-3" width="400px"  src="{{asset('img/2021/challenges/play-against-ai-5.png')}}"/>
                                    </li>
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-content.$slug.instructions.7")
                                        <img class="mt-3" width="400px"  src="{{asset('img/2021/challenges/play-against-ai-6.png')}}"/>
                                    </li>
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-content.$slug.instructions.8")
                                        <img class="mt-3" width="400px"  src="{{asset('img/2021/challenges/play-against-ai-7.png')}}"/>
                                    </li>
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-content.$slug.instructions.9")
                                        <img class="mt-3" width="400px"  src="{{asset('img/2021/challenges/play-against-ai-8.png')}}"/>
                                    </li>
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-content.$slug.instructions.10")
                                        <img class="mt-3" width="400px"  src="{{asset('img/2021/challenges/play-against-ai-9.png')}}"/>
                                    </li>
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-content.$slug.instructions.11")
                                        <img class="mt-3" width="400px"  src="{{asset('img/2021/challenges/play-against-ai-10.png')}}"/>
                                    </li>
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-content.$slug.instructions.12")
                                        <img class="mt-3" width="400px"  src="{{asset('img/2021/challenges/play-against-ai-11.png')}}"/>
                                    </li>
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-content.$slug.instructions.13")
                                        <img class="mt-3" width="400px"  src="{{asset('img/2021/challenges/play-against-ai-12.png')}}"/>
                                    </li>
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-content.$slug.instructions.14")
                                        <img class="mt-3" width="400px"  src="{{asset('img/2021/challenges/play-against-ai-13.png')}}"/>
                                    </li>
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-content.$slug.instructions.15")
                                        <img class="mt-3" width="400px"  src="{{asset('img/2021/challenges/play-against-ai-14.png')}}"/>
                                    </li>
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-content.$slug.instructions.16")
                                        <img class="mt-3" width="400px"  src="{{asset('img/2021/challenges/play-against-ai-15.png')}}"/>
                                    </li>
                                </ol>
