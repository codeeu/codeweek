                    ...
                    <div class="col-span-2">
                        <div class=" bg-white px-6 py-8 lg:p-16 rounded-lg">
                            ...
                            <div class="mb-6">
                                ...
                                <p class="font-normal text-default md:text-xl p-0 text-slate-500 mb-2 leading-[22px] md:leading-[30px]">
                                    @lang("challenges-content.$slug.instructions.0"): <a class="text-dark-blue" target="_blank" href="{{$url}}">{{$url}}</a><br/>
