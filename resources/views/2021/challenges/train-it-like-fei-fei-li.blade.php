                ...
                <div class="grid grid-cols-1 gap-y-6 lg:grid-cols-3 lg:gap-16">
                    <div id="challenge-left-col" class="flex flex-col gap-6">
                        ...
                        <div class="p-6 bg-white rounded-lg">
                            ...
                            <p class="p-0 font-normal leading-7 text-slate-500 text-default">@lang("challenges-content.$slug.target_audience")</p>
                        </div>
                        <div class="p-6 bg-white rounded-lg">
                        ...
                        <div class="p-6 bg-white rounded-lg">
                            <p class="p-0 mb-4 text-2xl font-normal">@lang("challenges-content.$slug.examples_title")</p>
                            <ul class="list-decimal ml-4 [&_li]:my-2 leading-[22px] md:leading-[30px]">
                                @foreach (trans("challenges-content.$slug.examples") as $example)
                                    @if (str_contains($example, ':'))
                                        <li class="p-0 font-bold leading-7 text-slate-500 text-default">{{ $example }}
                                        </li>
                                    @else
                        ...
                        <div class="px-6 py-8 bg-white rounded-lg lg:p-16">
                            ...
                            <div class="flex flex-wrap gap-2 mb-6">
                                <div class="flex gap-2 items-center px-4 py-1.5 bg-light-blue-100 rounded-full">
                                    ...
                                    <p class="p-0 font-semibold text-slate-500 text-default">@lang("challenges-content.$slug.target_audience")</p>
                                </div>
                            </div>
                            <div class="mb-6">
                            ...
                            <div class="mb-6">
                                ...
                                <a href="https://teachablemachine.withgoogle.com/models/hRNy1ZPlQ/"
                                    class="font-normal leading-7 text-primary text-default">https://teachablemachine.withgoogle.com/models/hRNy1ZPlQ/</a>
