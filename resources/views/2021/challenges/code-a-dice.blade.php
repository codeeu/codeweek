                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-y-6 lg:gap-16">
                    <div id="challenge-left-col" class="flex flex-col gap-6">
                        ...
                        <div class="bg-white p-6 rounded-lg">
                            ...
                            <ol class="list-decimal ml-4">
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">@lang("challenges-content.create-a-spiral.purposes.1")</li>
                    ...
                    <div class="col-span-2">
                        <div class=" bg-white px-6 py-8 lg:p-16 rounded-lg">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="font-normal text-default md:text-xl mt-2 text-slate-500 leading-[22px] md:leading-[30px]">@lang("challenges-content.$slug.example"): <a class="text-dark-blue" href="https://scratch.mit.edu/projects/877857926">https://scratch.mit.edu/projects/877857926</a> </div>
                                <div class="font-normal text-default md:text-xl mt-2">
