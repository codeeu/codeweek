                    ...
                    <div class="col-span-2">
                        <div class=" bg-white px-6 py-8 lg:p-16 rounded-lg">
                            ...
                            <div class="mb-6">
                                ...
                                <ol class="list-disc ml-4 [&_li]:my-2 leading-[22px] md:leading-[30px]">
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-content.$slug.instructions.0") <a class="text-dark-blue" target="_blank"
                                        ...
                                        <a class="text-dark-blue" target="_blank" href="https://tinyurl.com/virtualflowerfield">@lang("challenges-content.$slug.instructions.3")</a> @lang("challenges-content.$slug.instructions.4").
                                    </li>
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                            ...
                            <div class="mb-6">
                                ...
                                <img class="my-3" src="{{asset('img/2021/challenges/virtual-flower-field.png')}}"/>
                            </div>
