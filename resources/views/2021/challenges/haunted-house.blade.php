                    ...
                    <div class="flex flex-col gap-6">
                        ...
                        <div class="bg-white p-6 rounded-lg">
                            ...
                            <ol class="list-decimal ml-4">
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">@lang("challenges-content.$slug.audience")</li>
                            </ol>
                        </div>
                        <div class="bg-white p-6 rounded-lg">
                        ...
                        <div class="bg-white p-6 rounded-lg">
                            ...
                            <ol class="list-decimal ml-4">
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">
                                    @lang("challenges-content.$slug.materials.0") <a class="text-dark-blue" target="_blank" href="https://www.hedycode.com">hedycode.com</a>, @lang("challenges-content.$slug.materials.1")
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class=" bg-white px-6 py-8 lg:p-16 rounded-lg">
                            ...
                            <div class="flex flex-wrap gap-2 mb-6">
                                <div class="px-4 py-1.5 bg-light-blue-100 rounded-full flex items-center gap-2">
                                    ...
                                    <p class="text-slate-500 p-0 text-default font-semibold">@lang("challenges-content.$slug.audience")</p>
                                </div>
                            </div>
                            <div class="mb-6">
                            ...
                            <div class="mb-6">
                                ...
                                <ol class="list-disc ml-4 [&_li]:my-2 leading-[22px] md:leading-[30px]">
                                    ...
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-content.$slug.instructions.3") <a class="text-dark-blue" target="_blank" href="https://www.hedycode.com/hedy#haunted">@lang("challenges-content.$slug.instructions.4")</a>.
                                    </li>
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-content.$slug.instructions.5") <a class="text-dark-blue" target="_blank" href="https://www.youtube.com/watch?v=EdqT313rM40&t=1s">@lang("challenges-content.$slug.instructions.6")</a>.
                                    </li>
                            ...
                            <div class="mb-6">
                                ...
                                <ol class="list-disc ml-4 [&_li]:my-2 leading-[22px] md:leading-[30px]">
                                    <li class="font-normal text-default md:text-xl text-slate-500"><a class="text-dark-blue" href="https://www.hedycode.com/hedy/2#haunted">@lang("challenges-content.$slug.example") 2</a></li>
                                    <li class="font-normal text-default md:text-xl text-slate-500"><a class="text-dark-blue" href="https://www.hedycode.com/hedy/4#haunted">@lang("challenges-content.$slug.example") 4</a></li>
                                </ol>
                                <img class="my-3" src="{{asset('img/2021/challenges/haunted-house-1.png')}}"/>
                            </div>
