                        ...
                        <div class="bg-white p-6 rounded-lg">
                            ...
                            <ol class="list-decimal ml-4">
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">
                                    <a class="text-dark-blue" target="_blank" href="https://scratch.mit.edu/download/scratch-link">Scratch Link</a>
                                </li>
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">
                                    <a class="text-dark-blue" target="_blank" href="https://scratch.mit.edu/">Scratch online</a>
                                </li>
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">
                                    <a class="text-dark-blue" target="_blank" href="https://play.google.com/store/apps/details?id=com.lego.boost.boost&hl=en">Android
                                        App LegoBoost</a>
                                </li>
                            </ol>
                        </div>
                        ...
                        <div class=" bg-white px-6 py-8 lg:p-16 rounded-lg">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="font-normal text-default md:text-xl text-slate-500 leading-[22px] md:leading-[30px]">
                                    <a class="text-dark-blue" href="https://scratch.mit.edu/projects/896188895/editor/">https://scratch.mit.edu/projects/896188895/editor/</a>
                                    <img width="700px"
                                    ...
                                    <p class="p-0 mb-2">@lang("challenges-content.$slug.example.4")</p>
                                    <p class="p-0 mb-2">@lang("challenges-content.$slug.example.5")</p>
                                    <p class="p-0 mb-2">@lang("challenges-content.$slug.example.6")</p>
                                    <a class="text-dark-blue" href="https://drive.google.com/drive/folders/1gvapCHY3b6rENV2HBIIbM35XGdufj1U0?usp=sharing">https://drive.google.com/drive/folders/1gvapCHY3b6rENV2HBIIbM35XGdufj1U0?usp=sharing</a>
                                </div>
                            </div>
