                ...
                <div class="grid grid-cols-1 gap-y-6 lg:grid-cols-3 lg:gap-16">
                    <div id="challenge-left-col" class="flex flex-col gap-6">
                        <div class="p-6 bg-white rounded-lg">
                            <p class="p-0 mb-4 text-2xl font-normal">@lang("challenges-content.$slug.educational_goals_title")</p>
                            <ul class="list-decimal ml-4 [&_li]:my-2 leading-[22px] md:leading-[30px]">
                                @foreach (trans("challenges-content.$slug.educational_goals") as $goal)
                                    @if (str_contains($goal, ':'))
                                        <li class="p-0 font-bold leading-7 text-slate-500 text-default">{{ $goal }}
                                        </li>
                                    @else
                        ...
                        <div class="p-6 bg-white rounded-lg">
                            ...
                            <ul class="ml-4 list-decimal">
                                @foreach (trans("challenges-content.$slug.target_audience") as $audience)
                        ...
                        <div class="p-6 bg-white rounded-lg">
                            ...
                            <ul class="ml-4 list-decimal">
                                @foreach (trans("challenges-content.$slug.purposes") as $purpose)
                        ...
                        <div class="p-6 bg-white rounded-lg">
                            ...
                            <ul class="ml-4 list-decimal">
                                @foreach (trans("challenges-content.$slug.materials") as $material)
                    ...
                    <div class="col-span-2">
                        <div class="px-6 py-8 bg-white rounded-lg lg:p-16">
                            ...
                            <div class="mb-6">
                                <p class="p-0 mb-2 text-2xl font-semibold">@lang("challenges-content.$slug.instructions_title")</p>
                                <ol class="list-decimal ml-4 [&_li]:my-2 leading-[22px] md:leading-[30px]">
                                    @foreach (trans("challenges-content.$slug.instructions") as $instruction)
                            ...
                            <div class="mb-6">
                                <p class="p-0 mb-2 text-2xl font-semibold">
                                    @lang("challenges-content.$slug.examples_title")
                                </p>

                                @php
                                    $examples = trans("challenges-content.$slug.examples");
                                    // Ensure we have an array (trans() can return a string if key missing)
                                ...
                                @else
                                    <p class="text-slate-500">@lang('challenges.no_examples_available')</p>
                                @endif
                            </div>
