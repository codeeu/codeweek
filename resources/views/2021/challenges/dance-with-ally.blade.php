                ...
                <div class="grid grid-cols-1 gap-y-6 lg:grid-cols-3 lg:gap-16">
                        ...
                        <div class="p-6 bg-white rounded-lg">
                            ...
                            <ul class="ml-4 list-decimal">
                                @foreach ($tarr("challenges-content.$slug.materials") as $material)
                                    <li class="p-0 font-normal leading-7 text-slate-500 text-default md:text-xl">{{ is_array($material) ? json_encode($material) : $material }}</li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-span-2">
                        <div class="px-6 py-8 bg-white rounded-lg lg:p-16">
                            ...
                            <div class="flex flex-wrap gap-2 mb-6">
                                @foreach ($tarr("challenges-content.$slug.target_audience") as $audience)
                                    <div class="flex gap-2 items-center px-4 py-1.5 bg-light-blue-100 rounded-full">
                                        ...
                                        <p class="p-0 font-semibold text-slate-500 text-default md:text-xl">{{ $audience }}</p>
                                    </div>
                                @endforeach
                            </div>
                            ...
                            <div class="mb-6">
                                <p class="p-0 mb-2 text-2xl font-semibold">{{ $ts("challenges-content.$slug.examples_title") }}</p>
                                @php
    ...
    <script>
        (function() {
            ...
            function linkifyNode(textNode) {
                ...
                // don’t process if inside a link or in code/pre
