                        ...
                        <div class="p-6 bg-white rounded-lg">
                            ...
                            <ul class="list-decimal ml-4 [&_li]:my-2 leading-[22px] md:leading-[30px]">
                                @foreach (trans("challenges-content.$slug.educational_goals") as $goal)
                                    <li class="p-0 font-normal text-default md:text-xl text-slate-500">{{ $goal }}
                                    </li>
                                @endforeach
                            </ul>
                        </div>
                        ...
                        <div class="px-6 py-8 bg-white rounded-lg lg:p-16">
                            ...
                            <div class="mb-6">
                                ...
                                <ul class="list-disc ml-4 [&_li]:my-2 leading-[22px] md:leading-[30px]">
                                    @foreach (trans("challenges-content.$slug.real-life-applications") as $real_life_application)
                                        <li class="p-0 font-normal text-default md:text-xl text-slate-500">
                            ...
                            <div class="mb-6">
                                <p class="p-0 mb-2 text-2xl font-semibold">@lang("challenges-content.$slug.variations_title")</p>
                                <ul class="list-disc ml-4 [&_li]:my-2 leading-[22px] md:leading-[30px]">
                                    @foreach (trans("challenges-content.$slug.variations") as $variation)
                                        <li class="p-0 font-normal text-default md:text-xl text-slate-500">
                                            {{ $variation }}</li>
                                    @endforeach
                                </ul>
