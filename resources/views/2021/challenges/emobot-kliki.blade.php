                        ...
                        <div class="bg-white p-6 rounded-lg">
                            ...
                            <ol class="list-decimal ml-4">
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">
                                    <a class="text-dark-blue" target="_blank" href="https://machinelearningforkids.co.uk/">Machine learning for kids</a>
                                </li>
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">
                                    <a class="text-dark-blue" target="_blank" href="https://scratch.mit.edu/">Scratch</a>
                                </li>
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">
                                    <a class="text-dark-blue" target="_blank" href="https://www.bing.com/create">Microsoft Bing Image Creator</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class=" bg-white px-6 py-8 lg:p-16 rounded-lg">
                            ...
                            <div class="mb-6">
                                ...
                                <ol class="list-disc ml-4 [&_li]:my-2 leading-[22px] md:leading-[30px]">
                                    ...
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        ...
                                        <img class="mt-3" width='500px' src="{{asset('img/2021/challenges/emobot-kliki-1.png')}}"/>
                                    </li>
                                </ol>
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <div class="font-normal text-default md:text-xl text-slate-500 leading-[22px] md:leading-[30px]">
                                    <a class="block my-3" href="https://machinelearningforkids.co.uk/#!/mlproject/auth0%257C642ff7b023f96cf587fba498/be048650-ddda-11ed-8768-6d044a8149b1/training">
                                        <img src="{{asset('img/2021/challenges/emobot-kliki-2.png')}}"/>
                                    </a>
                                    <p class="p-0">@lang("challenges-content.$slug.example.0")</p>
                                    <p class="p-0">@lang("challenges-content.$slug.example.1")</p>
                                </div>
                            </div>
