                    ...
                    <div class="flex flex-col gap-6">
                        <div class="bg-white p-6 rounded-lg flex lg:flex-col 2xl:flex-row flex-wrap gap-4 2xl:gap-8">
                            <div>
                                ...
                                <div class="w-fit px-4 py-1.5 bg-light-blue-100 rounded-full flex items-center gap-2">
                                    ...
                                    <p class="text-slate-500 p-0 text-default font-semibold">@lang("challenges-content.coding-escape-room.duration")</p>
                                </div>
                            </div>
                            <div>
                        ...
                        <div class="bg-white p-6 rounded-lg">
                            ...
                            <ol class="list-decimal ml-4">
                                ...
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">@lang('challenges.common.pre-primary') (3-6)</li>
                        ...
                        <div class="bg-white p-6 rounded-lg">
                            ...
                            <ol class="list-decimal ml-4">
                                ...
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">
                                    <a class="text-dark-blue" target="_blank" href="https://drive.google.com/file/d/1Zk5g4WJ-dCK0AMwjBcz3GTSLXRR6XtwU/view?usp=sharing">https://drive.google.com/file/d/1Zk5g4WJ-dCK0AMwjBcz3GTSLXRR6XtwU/view?usp=sharing</a> (@lang("challenges-content.$slug.materials.2"))
                                </li>
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">
                                    <a class="text-dark-blue" target="_blank" href="https://drive.google.com/file/d/1xLupy-TCYw3vd2Y30m2ivOrpwCt-_tug/view?usp=sharing">https://drive.google.com/file/d/1xLupy-TCYw3vd2Y30m2ivOrpwCt-_tug/view?usp=sharing</a> (@lang("challenges-content.$slug.materials.2"))
                                </li>
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">
                                    @lang("challenges-content.$slug.materials.3") <a class="text-dark-blue" target="_blank" href="https://pz.harvard.edu/thinking-routines">https://pz.harvard.edu/thinking-routines</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                    <div class="col-span-2">
                        <div class=" bg-white px-6 py-8 lg:p-16 rounded-lg">
                            ...
                            <div class="flex flex-wrap gap-2 mb-6">
                                ...
                                <div class="px-4 py-1.5 bg-light-blue-100 rounded-full flex items-center gap-2">
                                    <img src="{{asset('img/2021/challenges/icons/fi_users.svg')}}" />
                                    <p class="text-slate-500 p-0 text-default font-semibold">@lang('challenges.common.pre-primary') (3-6)</p>
                                </div>
                                <div class="px-4 py-1.5 bg-light-blue-100 rounded-full flex items-center gap-2">
                                    <img src="{{asset('img/2021/challenges/icons/fi_users.svg')}}" />
                            ...
                            <div class="mb-6">
                                ...
                                <div class="font-normal text-default md:text-xl text-slate-500 leading-[22px] md:leading-[30px]">
                                    <p class="p-0 mb-2">@lang("challenges-content.$slug.example.0")</p>
                                    <p class="p-0 mb-2">@lang("challenges-content.$slug.example.1")</p>
                                    <p class="p-0 mb-2">@lang("challenges-content.$slug.example.2")</p>
                                    <p class="p-0 mb-2">@lang("challenges-content.$slug.example.3")</p>
                                </div>
