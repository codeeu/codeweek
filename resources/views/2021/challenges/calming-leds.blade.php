                        ...
                        <div class=" bg-white px-6 py-8 lg:p-16 rounded-lg">
                            ...
                            <div class="mb-6">
                                ...
                                <ol class="list-disc ml-4 [&_li]:my-2 leading-[22px] md:leading-[30px]">
                                    ...
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-content.$slug.instructions.3") <a class="text-dark-blue" target="_blank" href="https://microbit.org/news/2020-05-01/microbit-at-home-calming-leds/">@lang("challenges-content.$slug.instructions.4")</a>.
                                    </li>
                                </ol>
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <div class="font-normal text-default md:text-xl leading-[22px] md:leading-[30px]">
                                    <p class="p-0 mb-2">@lang("challenges-content.$slug.example"): <a class="text-dark-blue" href="https://microbit.org/news/2020-05-01/microbit-at-home-calming-leds/">https://microbit.org/news/2020-05-01/microbit-at-home-calming-leds/</a> </p>
                                    <a class="block mt-3" href="https://microbit.org/news/2020-05-01/microbit-at-home-calming-leds/">
