                        ...
                        <div class=" bg-white px-6 py-8 lg:p-16 rounded-lg">
                            ...
                            <div class="mb-6">
                                ...
                                <p class="font-normal text-default md:text-xl p-0 text-slate-500 leading-[22px] md:leading-[30px]">
                                    @lang("challenges-content.$slug.description.0") <a class="text-dark-blue" target="_blank"
                            ...
                            <div class="mb-6">
                                ...
                                <ol class="list-disc ml-4 [&_li]:my-2 leading-[22px] md:leading-[30px]">
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        ...
                                        <a class="text-dark-blue" href="https://forms.gle/btEHZx6X1muHoJfx7" target="_blank"> https://forms.gle/btEHZx6X1muHoJfx7</a>
                                        @php
                                        ...
                                        @if($locale !== 'me')
                                            <div>
                                                <a class="text-dark-blue" target="_blank" href="https://codeweek-s3.s3.eu-west-1.amazonaws.com/cw2023/{{strtolower($locale)}}_escape_coding.docx">WORD
                                                    DOCUMENT</a>
                                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <div class="font-normal text-default md:text-xl mt-2 text-slate-500 leading-[22px] md:leading-[30px]">
                                    <p class="p-0 mb-2">@lang("challenges-content.$slug.example.0")</p>
                                    <p class="p-0 mb-2">@lang("challenges-content.$slug.example.1")</p>
                                    <p class="p-0">@lang("challenges-content.$slug.example.2")</p>
                                </div>
                            </div>
