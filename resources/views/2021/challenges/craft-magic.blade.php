                    ...
                    <div id="challenge-left-col" class="flex flex-col gap-6">
                        <div class="bg-white p-6 rounded-lg flex lg:flex-col 2xl:flex-row flex-wrap gap-4 2xl:gap-8">
                            <div>
                                ...
                                <div class="w-fit px-4 py-1.5 bg-light-blue-100 rounded-full flex items-center gap-2">
                                    ...
                                    <p class="text-slate-500 p-0 text-default font-semibold">@lang("challenges-content.$slug.duration.0")</p>
                                </div>
                                <div class="w-fit px-4 py-1.5 bg-light-blue-100 rounded-full flex items-center gap-2 mt-2">
                                    <img src="{{asset('img/2021/challenges/icons/fi_clock.svg')}}" />
                                    <p class="text-slate-500 p-0 text-default font-semibold">@lang("challenges-content.$slug.duration.1")</p>
                                </div>
                            </div>
                            <div>
                        ...
                        <div class="bg-white p-6 rounded-lg">
                            ...
                            <ol class="list-decimal ml-4">
                                ...
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">@lang("challenges-content.$slug.purposes.6")</li>
                            </ol>
                        </div>
                        <div class="bg-white p-6 rounded-lg">
                            ...
                            <ol class="list-decimal ml-4">
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">
                                    <a class="text-dark-blue" target="_blank" href="https://ai.thestempedia.com">@lang("challenges-content.$slug.materials.0")</a>
                                </li>
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">
                                    @lang("challenges-content.$slug.materials.1")
                                </li>
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">
                                    @lang("challenges-content.$slug.materials.2")
                                </li>
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">
                                    @lang("challenges-content.$slug.materials.3")
                                </li>
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">
                            ...
                            <div class="mb-6">
                                ...
                                <ol class="list-disc ml-4 [&_li]:my-2 leading-[22px] md:leading-[30px]">
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        <a class="text-dark-blue" href="https://ai.thestempedia.com" target="_blank"> @lang("challenges-content.$slug.instructions.0")</a>
                                    </li>
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
