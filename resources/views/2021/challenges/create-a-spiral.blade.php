                        ...
                        <div class="bg-white p-6 rounded-lg">
                            ...
                            <ol class="list-decimal ml-4">
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">
                                    <a class="text-dark-blue" target="_blank" href="https://scratch.mit.edu/">Scratch</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                    <div class="col-span-2">
                        <div class=" bg-white px-6 py-8 lg:p-16 rounded-lg">
                            ...
                            <div class="mb-6">
                                ...
                                <p class="font-semibold text-xl p-0 mb-2">@lang("challenges-content.$slug.instructions.0")</p>
                                ...
                                <p class="font-semibold text-xl p-0 mb-2">@lang("challenges-content.$slug.instructions.11")</p>
                                <ol class="list-disc ml-4 mb-6 [&_li]:my-2 leading-[22px] md:leading-[30px]">
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                ...
                                <p class="font-semibold text-xl p-0 mb-2">@lang("challenges-content.$slug.instructions.14")</p>
                                <ol class="list-disc ml-4 mb-6 [&_li]:my-2 leading-[22px] md:leading-[30px]">
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                    ...
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-content.$slug.instructions.22")
                                        <img width="240px" src="{{asset('img/2021/challenges/create-a-spiral-16.png')}}"/>
                                    </li>
                                </ol>

                                <p class="font-semibold text-xl p-0 mb-2">@lang("challenges-content.$slug.instructions.23")</p>
                                <ol class="list-disc ml-4 mb-6 [&_li]:my-2 leading-[22px] md:leading-[30px]">
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-content.$slug.instructions.24")
                                        <img width="400px" src="{{asset('img/2021/challenges/create-a-spiral-17.png')}}"/>
                                    </li>
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-content.$slug.instructions.25")
                                        <img width="120px" class="inline" src="{{asset('img/2021/challenges/create-a-spiral-18.png')}}"/>
                                    </li>
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-content.$slug.instructions.26")
                                    </li>
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-content.$slug.instructions.27")
                                        <img width="180px" src="{{asset('img/2021/challenges/create-a-spiral-19.png')}}"/>
                                    </li>
                                    <p class="font-semibold text-xl p-0 mb-2">@lang("challenges-content.$slug.instructions.28")</p>
                                </ol>
                            </div>
                            @include('2021.challenges._share')
                            <div class="mb-6">
                                <p class="font-semibold text-2xl p-0 mb-2">@lang('challenges.common.example')</p>
                                <div class="font-normal text-default md:text-xl">
                                    <a class="text-dark-blue" href="https://scratch.mit.edu/projects/901425275">https://scratch.mit.edu/projects/901425275</a>
                                </div>
