                    ...
                    <div id="challenge-left-col" class="flex flex-col gap-6">
                        ...
                        <div class="bg-white p-6 rounded-lg">
                            ...
                            <ol class="list-decimal ml-4">
                                ...
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">@lang('challenges.common.students') (7-14)</li>
                            </ol>
                        </div>
                        <div class="bg-white p-6 rounded-lg">
                        ...
                        <div class="bg-white p-6 rounded-lg">
                            ...
                            <ol class="list-decimal ml-4">
                                ...
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">@lang("challenges-content.$slug.materials.4")</li>
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">@lang("challenges-content.$slug.materials.5")</li>
                            </ol>
                        </div>
                    </div>
                    <div class="col-span-2">
                        <div class=" bg-white px-6 py-8 lg:p-16 rounded-lg">
                            ...
                            <div class="flex flex-wrap gap-2 mb-6">
                                ...
                                <div class="px-4 py-1.5 bg-light-blue-100 rounded-full flex items-center gap-2">
                                    <img src="{{asset('img/2021/challenges/icons/fi_users.svg')}}" />
                                    <p class="text-slate-500 p-0 text-default font-semibold">@lang('challenges.common.students') (7-14)</p>
                                </div>
                            </div>
                            <div class="mb-6">
                                <p class="font-semibold text-2xl p-0 mb-2">@lang('challenges.common.description')</p>
                                <p class="font-normal text-default md:text-xl p-0 text-slate-500 leading-[22px] md:leading-[30px]">@lang("challenges-content.$slug.description.0") <a class="text-dark-blue" href="{{route('toolkits')}}">@lang("challenges-content.$slug.description.1")</a> @lang("challenges-content.$slug.description.2")</p>
                            </div>
                            <div class="mb-6">
                            ...
                            <div class="mb-6">
                                ...
                                <img class="mt-3" src="{{asset('img/2021/challenges/paper-circuit-example-1.png')}}"/>
                            </div>
