                  ...
                  <div class="flex flex-col gap-6">
                      ...
                      <div class="bg-white p-6 rounded-lg">
                          ...
                          <ol class="list-decimal ml-4">
                              ...
                              <li class="text-slate-500 p-0 text-default font-normal leading-7">@lang('challenges.common.students') (8-12)</li>
                          </ol>
                      </div>
                      <div class="bg-white p-6 rounded-lg">
                      ...
                      <div class="bg-white p-6 rounded-lg">
                          ...
                          <ol class="list-decimal ml-4">
                              <li class="text-slate-500 p-0 text-default font-normal leading-7">
                                  <a class="text-dark-blue" target="_blank" href="https://www.tynker.com/">Tynker</a>
                              </li>
                          </ol>
                      </div>
                  </div>
                  <div class="col-span-2">
                      <div class=" bg-white px-6 py-8 lg:p-16 rounded-lg">
                          ...
                          <div class="flex flex-wrap gap-2 mb-6">
                              ...
                              <div class="px-4 py-1.5 bg-light-blue-100 rounded-full flex items-center gap-2">
                                  <img src="{{asset('img/2021/challenges/icons/fi_users.svg')}}" />
                                  <p class="text-slate-500 p-0 text-default font-semibold">@lang('challenges.common.students') (8-12)</p>
                              </div>
                          </div>
                          <div class="mb-6">
                          ...
                          <div class="mb-6">
                              ...
                              <ol class="list-disc ml-4 [&_li]:my-2 leading-[22px] md:leading-[30px]">
                                  <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                      @lang("challenges-content.$slug.instructions.0") <a class="text-dark-blue" target="_blank" href="https://www.tynker.com/">Tynker</a> @lang("challenges-content.$slug.instructions.1")
                                  </li>
                                  <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                      @lang("challenges-content.$slug.instructions.2") <strong>Create a project – Blank Block Coding Project</strong> @lang("challenges-content.$slug.instructions.3").
                                  </li>
                                  <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                      @lang("challenges-content.$slug.instructions.4") <strong>Stage</strong> @lang("challenges-content.$slug.instructions.5")
                                      <img class="m-4" width="400" src="{{asset('img/2021/challenges/dance-1.png')}}"/>
                                  </li>
                                  <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                      @lang("challenges-content.$slug.instructions.6") <strong>Add Actor</strong> @lang("challenges-content.$slug.instructions.7")
                                  </li>
                                  <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                  ...
                                  <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                      @lang("challenges-content.$slug.instructions.9") <strong>@lang("challenges-content.$slug.instructions.10")</strong> @lang("challenges-content.$slug.instructions.11").
                          ...
                          <div class="mb-6">
                              ...
                              <div class="font-normal text-default md:text-xl text-slate-500 leading-[22px] md:leading-[30px]">
                                  @lang("challenges-content.$slug.example.0") <a target="_blank" rel="noreferer noopener" href="https://www.tynker.com/play/dancing-robots/612249dd2d3eb65f2b0c6b1f-728057XjzbT,f5GeQFBM,dlKC2n,wk">@lang("challenges-content.$slug.example.1")</a> @lang("challenges-content.$slug.example.2")
                              </div>
                              <div>
                                <iframe class="max-w-full w-full mt-3" width="660" height="408" src="//www.tynker.com/ide/embedded?p=612249dd2d3eb65f2b0c6b1f&controls=false&autostart=false" frameborder="0" allowfullscreen></iframe>
                              </div>
                          </div>
