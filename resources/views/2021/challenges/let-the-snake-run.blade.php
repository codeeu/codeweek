                        ...
                        <div class=" bg-white px-6 py-8 lg:p-16 rounded-lg">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="font-normal text-default md:text-xl text-slate-500 leading-[22px] md:leading-[30px]">
                                    <div class="my-3">@lang("challenges-content.$slug.example.0")</div>
                                    <div class="my-3">1. @lang("challenges-content.$slug.example.1")</div>
                                    <div class="my-3">@lang("challenges-content.$slug.example.2")
                                    </div>
                                    <img width="400px" src="{{asset('img/2021/challenges/let-the-snake-run-1.png')}}"/>
                                    <div class="my-3">2. @lang("challenges-content.$slug.example.3")</div>
                                    <div class="my-3">@lang("challenges-content.$slug.example.4")</div>
                                    <div class="my-3">@lang("challenges-content.$slug.example.5")</div>
                                    <div class="my-3">@lang("challenges-content.$slug.example.6")</div>
                                    <div class="my-3">@lang("challenges-content.$slug.example.7")</div>
