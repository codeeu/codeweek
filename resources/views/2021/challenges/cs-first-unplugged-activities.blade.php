                            ...
                            <div class="mb-6">
                                ...
                                <ol class="list-disc ml-4 [&_li]:my-2 leading-[22px] md:leading-[30px]">
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        ...
                                        <a class="text-dark-blue" target="_blank" href="https://docs.google.com/document/d/1OV0Ooodf2ge4_5xqxoKsIsp7xKNqhMFO4VrRY89Pdm0/edit">@lang("challenges-content.$slug.instructions.1")</a>.
                                    </li>
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                    ...
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-extra.$slug.0")
                                        <a class="text-dark-blue" target="_blank" href="@lang("challenges-extra.cs-first-link")">@lang("challenges-extra.$slug.1")</a>.
                                    </li>
                                </ol>
                            </div>
