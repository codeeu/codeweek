                        ...
                        <div class=" bg-white px-6 py-8 lg:p-16 rounded-lg">
                            ...
                            <div class="mb-6">
                                ...
                                <ol class="list-disc ml-4 [&_li]:my-2 leading-[22px] md:leading-[30px]">
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        ...
                                        <img class="mt-3" width='400px' src="{{asset('img/2021/challenges/circle-of-dots-1.png')}}"/>
                                    </li>
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-content.$slug.instructions.1")
                                        <img class="mt-3" width='400px' src="{{asset('img/2021/challenges/circle-of-dots-2.png')}}"/>
                                    </li>
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                    ...
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        ...
                                        <img class="mt-3" width='400px' src="{{asset('img/2021/challenges/circle-of-dots-3.png')}}"/>
                                    </li>
                                </ol>
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <div class="font-normal text-default md:text-xl">
                                    <a class="block text-dark-blue mb-4" href="https://scratch.mit.edu/projects/891333343/">https://scratch.mit.edu/projects/891333343/</a>
