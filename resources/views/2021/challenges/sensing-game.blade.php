                    ...
                    <div class="flex flex-col gap-6">
                        ...
                        <div class="bg-white p-6 rounded-lg">
                            ...
                            <ol class="list-decimal ml-4">
                                ...
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">@lang('challenges.common.students') (10-14)</li>
                            </ol>
                        </div>
                        <div class="bg-white p-6 rounded-lg">
                        ...
                        <div class="bg-white p-6 rounded-lg">
                            ...
                            <ol class="list-decimal ml-4">
                                <li class="text-slate-500 p-0 text-default font-normal leading-7"><a class="text-dark-blue" href="https://scratch.mit.edu/" target="_blank">Scratch</a></li>
                            </ol>
                        </div>
                    </div>
                    <div class="col-span-2">
                        <div class=" bg-white px-6 py-8 lg:p-16 rounded-lg">
                            ...
                            <div class="flex flex-wrap gap-2 mb-6">
                                ...
                                <div class="px-4 py-1.5 bg-light-blue-100 rounded-full flex items-center gap-2">
                                    <img src="{{asset('img/2021/challenges/icons/fi_users.svg')}}" />
                                    <p class="text-slate-500 p-0 text-default font-semibold">@lang('challenges.common.students') (10-14)</p>
                                </div>
                            </div>
                            <div class="mb-6">
                            ...
                            <div class="mb-6">
                                ...
                                <ol class="list-disc ml-4 [&_li]:my-2 leading-[22px] md:leading-[30px]">
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">@lang("challenges-content.$slug.instructions.0") <a class="text-dark-blue" href="https://scratch.mit.edu/">Scratch</a>.</li>
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">@lang("challenges-content.$slug.instructions.1") <strong>@lang("challenges-content.$slug.instructions.2")</strong> @lang("challenges-content.$slug.instructions.3") <strong>@lang("challenges-content.$slug.instructions.4")</strong>. @lang("challenges-content.$slug.instructions.5")</li>
                                    <img class="w-80 my-3" src="{{asset('img/2021/challenges/sensing-game-1.png')}}"/>
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">@lang("challenges-content.$slug.instructions.6") <strong>@lang("challenges-content.$slug.instructions.7")</strong> @lang("challenges-content.$slug.instructions.8") </li>
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">@lang("challenges-content.$slug.instructions.9") <strong>@lang("challenges-content.$slug.instructions.10")</strong> @lang("challenges-content.$slug.instructions.11") <strong>@lang("challenges-content.$slug.instructions.12")</strong> @lang("challenges-content.$slug.instructions.13") <strong>@lang("challenges-content.$slug.instructions.14")</strong>.</li>
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">@lang("challenges-content.$slug.instructions.15") <strong>@lang("challenges-content.$slug.instructions.16")</strong> @lang("challenges-content.$slug.instructions.17")</li>
                                    <img class="w-full my-3"
                                         src="{{asset('img/2021/challenges/sensing-game-2.png')}}"/>
                                </ol>
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <div class="font-normal text-default md:text-xl text-slate-500 leading-[22px] md:leading-[30px]">
                                    @lang("challenges-content.$slug.example.0") <a class="text-dark-blue" href="https://scratch.mit.edu/projects/563163565" target="_blank">@lang("challenges-content.$slug.example.1")</a>.
                                </div>
