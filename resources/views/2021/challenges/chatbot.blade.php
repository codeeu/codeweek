    ...
    <section id="codeweek-schools-page" class="codeweek-page">
        ...
        <section class="flex flex-row justify-between" style="background-color: #EEA44E">
            <div class="flex justify-center items-center w-full">
                            <div class="text-center m-12">
                                ...
                                <div class="text-5xl mt-2" style="color: #1756a0">@lang('challenges.content.chatbot.title')</div>
                            </div>
            </div>
        ...
        <section class="codeweek-content-wrapper">
            ...
            <div class="m-6">
                ...
                @include('2021.challenges._author', ['author' => __('challenges.content.chatbot.author')])
                <section class="grid grid-cols-1 gap-6 md:grid-cols-5 mx-6 my-4">
                    ...
                    <div>
                        ...
                        <ol class="list-disc ml-5">
                            <li>@lang('challenges.content.chatbot.purposes.0')</li>
                            <li>@lang('challenges.content.chatbot.purposes.1')</li>
                        </ol>
                ...
                <div class="leading-6 text-base text-left">
                    ...
                    <div class="mt-2">
                        @lang('challenges.content.chatbot.description')
                    </div>
                    </section>
                    ...
                    <section class="p-2">
                        <div class="leading-8">
                            ...
                            <ul class="leading-7 ml-2 mt-0 checklist mt-2">
                                <li>@lang('challenges.content.chatbot.instructions.0').</li>
                                <li>@lang('challenges.content.chatbot.instructions.1') <a href="https://pencilcode.net/" target="_blank">Pencil Code</a> @lang('challenges.content.chatbot.instructions.2')
                                </li>
                                <li>@lang('challenges.content.chatbot.instructions.3').</li>
                                <li>@lang('challenges.content.chatbot.instructions.4').
                                ...
                                <li>
                                    @lang('challenges.content.chatbot.instructions.5')
                                     <a href="https://abfromz.pencilcode.net/edit/Riddle"
                                                                  target="_blank">@lang('challenges.content.chatbot.instructions.6')</a> <a href="#pencil-code"><sup>1</sup></a> @lang('challenges.content.chatbot.instructions.7').
                                </li>
                            </ul>
                    ...
                    <section class="p-2">
                        ...
                        <div class="mt-2">@lang('challenges.content.chatbot.example') <iframe src="//abfromz.pencilcode.net/home/Riddle" width="640" height="640" frameborder="0" allowfullScreen></iframe>
                        </div>
                    </section>

                    <div id="pencil-code" class="text-sm">
                        1. @lang('challenges.content.chatbot.more.0') <a href="https://gym.pencilcode.net/imagine/#/imagine/troll.html" target="_blank">@lang('challenges.content.chatbot.more.1')</a>
                    </div>
