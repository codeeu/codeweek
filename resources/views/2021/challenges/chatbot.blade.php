                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-y-6 lg:gap-16">
                    <div id="challenge-left-col" class="flex flex-col gap-6">
                        <div class="bg-white p-6 rounded-lg flex lg:flex-col 2xl:flex-row flex-wrap gap-4 2xl:gap-8">
                            ...
                            <div>
                                ...
                                <div class="w-fit px-4 py-1.5 bg-light-blue-100 rounded-full flex items-center gap-2">
                                    ...
                                    <p class="text-slate-500 p-0 text-default font-semibold">@lang('challenges.common.advanced')</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white p-6 rounded-lg">
                            ...
                            <ol class="list-decimal ml-4">
                                <li class="text-slate-500 p-0 text-default font-normal leading-7"><a class="text-dark-blue" href="https://pencilcode.net/" target="_blank">Pencil code</a></li>
                                <li class="text-slate-500 p-0 text-default font-normal leading-7"><a class="text-dark-blue" href="https://machinelearningforkids.co.uk/" target="_blank">Machine learning for kids</a></li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class=" bg-white px-6 py-8 lg:p-16 rounded-lg">
                            ...
                            <div class="mb-6">
                                ...
                                <ol class="list-disc ml-4 [&_li]:my-2 leading-[22px] md:leading-[30px]">
                                    ...
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">@lang("challenges-content.$slug.instructions.1") <a class="text-dark-blue" href="https://pencilcode.net/" target="_blank">Pencil
                                    ...
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">@lang("challenges-content.$slug.instructions.4").
                                    ...
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        ...
                                        <a href="https://abfromz.pencilcode.net/edit/Riddle" class="text-dark-blue"
                                           target="_blank">@lang("challenges-content.$slug.instructions.6")</a> <a
                                                href="#pencil-code"><sup class="text-dark-blue">1</sup></a> @lang("challenges-content.$slug.instructions.7")
                                        .
                                    </li>
                                </ol>
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <div class="font-normal text-default md:text-xl">@lang("challenges-content.$slug.example")
                                    <iframe class="w-full max-w-full mt-2" src="" width="640" height="640" frameborder="0"  src="//abfromz.pencilcode.net/home/Riddle" allowfullScreen></iframe>
                                </div>
                                <div id="pencil-code" class="font-normal text-default md:text-xl text-slate-500 leading-[22px] md:leading-[30px]">
