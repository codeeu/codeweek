                    ...
                    <div id="challenge-left-col" class="flex flex-col gap-6">
                        ...
                        <div class="bg-white p-6 rounded-lg">
                            ...
                            <ol class="list-decimal ml-4">
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">@lang('challenges.common.students') (6-12)</li>
                            </ol>
                        </div>
                        <div class="bg-white p-6 rounded-lg">
                        ...
                        <div class="bg-white p-6 rounded-lg">
                            ...
                            <ol class="list-decimal ml-4">
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">
                                    <a class="text-dark-blue" target="_blank" href="https://code.org/dance">@lang("challenges-content.$slug.materials")</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class=" bg-white px-6 py-8 lg:p-16 rounded-lg">
                            ...
                            <div class="flex flex-wrap gap-2 mb-6">
                                <div class="px-4 py-1.5 bg-light-blue-100 rounded-full flex items-center gap-2">
                                    ...
                                    <p class="text-slate-500 p-0 text-default font-semibold">@lang('challenges.common.students') (6-12)</p>
                                </div>
                            </div>
                            <div class="mb-6">
                                <p class="font-semibold text-2xl p-0 mb-2">@lang('challenges.common.description')</p>
                                <img class="mb-3 w-full" src="{{asset('img/2021/challenges/create-a-dance-2.jpg')}}"/>
                                <p class="font-normal text-default md:text-xl p-0 text-slate-500 leading-[22px] md:leading-[30px]">@lang("challenges-content.$slug.description.0") <a class="text-dark-blue" target="_blank" href="https://code.org/dance">@lang("challenges-content.$slug.description.1")</a> @lang("challenges-content.$slug.description.2")</p>
                            </div>
                            <div class="mb-6">
                                ...
                                <ol class="list-disc ml-4 [&_li]:my-2 leading-[22px] md:leading-[30px]">
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-content.$slug.instructions.0") <a class="text-dark-blue" target="_blank" href="https://code.org/dance">@lang("challenges-content.$slug.instructions.1")</a> @lang("challenges-content.$slug.instructions.2").
                                    </li>
                                </ol>
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <div class="font-normal text-default md:text-xl text-slate-500 leading-[22px] md:leading-[30px]">
                                    @lang("challenges-content.$slug.example"): <a class="text-dark-blue" href="https://code.org/dance">https://code.org/dance</a>
                                </div>
                                <a class="block my-3" href="https://code.org/dance">
