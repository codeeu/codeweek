                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-y-6 lg:gap-16">
                    <div id="challenge-left-col" class="flex flex-col gap-6">
                        ...
                        <div class="bg-white p-6 rounded-lg">
                            ...
                            <ol class="list-decimal ml-4">
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">@lang("challenges-content.$slug.purpose")</li>
                            </ol>
                        </div>
                        <div class="bg-white p-6 rounded-lg">
                            ...
                            <ol class="list-decimal ml-4">
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">
                                    @lang("challenges-content.$slug.materials.0") <a class="text-dark-blue" target="_blank" href="https://studio.code.org/s/artist/lessons/1/levels/1">@lang("challenges-content.$slug.materials.1")</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                    <div class="col-span-2">
                        <div class=" bg-white px-6 py-8 lg:p-16 rounded-lg">
                            ...
                            <div class="mb-6">
                                ...
                                <img class="w-full mb-3" src="{{asset('img/2021/challenges/create-your-own-masterpiece-1.png')}}"/>
                            ...
                            <div class="mb-6">
                                ...
                                <ol class="list-disc ml-4 [&_li]:my-2 leading-[22px] md:leading-[30px]">
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        @lang("challenges-content.$slug.instructions") (<a class="text-dark-blue" target="_blank" href="https://studio.code.org/s/artist/">https://studio.code.org/s/artist/</a>).
                                    </li>
                                </ol>
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <div class="font-normal text-default md:text-xl mb-3 text-slate-500 leading-[22px] md:leading-[30px]">
                                    @lang("challenges-content.$slug.example"): <a class="text-dark-blue" href="https://studio.code.org/projects/public">https://studio.code.org/projects/public </a>
                                </div>
