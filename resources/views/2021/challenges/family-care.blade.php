                    ...
                    <div id="challenge-left-col" class="flex flex-col gap-6">
                        <div class="bg-white p-6 rounded-lg flex lg:flex-col 2xl:flex-row flex-wrap gap-4 2xl:gap-8">
                            ...
                            <div>
                                ...
                                <div class="w-fit px-4 py-1.5 bg-light-blue-100 rounded-full flex items-center gap-2">
                                    ...
                                    <p class="text-slate-500 p-0 text-default font-semibold">@lang("challenges-content.$slug.experience")</p>
                                </div>
                            </div>
                        </div>
                        <div class="bg-white p-6 rounded-lg">
                            ...
                            <ol class="list-decimal ml-4">
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">@lang('challenges.common.students') (6-13)</li>
                            </ol>
                        </div>
                        <div class="bg-white p-6 rounded-lg">
                        ...
                        <div class="bg-white p-6 rounded-lg">
                            ...
                            <ol class="list-decimal ml-4">
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">
                                    @lang("challenges-content.$slug.materials.0") <a class="text-dark-blue" target="_blank" href="https://ide.mblock.cc/">mBlock 5</a> @lang("challenges-content.$slug.materials.1") <a class="text-dark-blue" target="_blank"
                                ...
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">
                                    @lang("challenges-content.$slug.materials.4")
                                </li>
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">
                                    @lang("challenges-content.$slug.materials.5")
                                </li>
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">
                                    @lang("challenges-content.$slug.materials.6")
                                </li>
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">
                                    @lang("challenges-content.$slug.materials.7") <a class="text-dark-blue" target="_blank"
                                                                                     href="https://spark.makex.io/2021-makex-spark-code-for-health/">https://spark.makex.io/2021-makex-spark-code-for-health/</a>
                                    @lang("challenges-content.$slug.materials.8") <a class="text-dark-blue"  href="mailto:allen.yan@makeblock.com">allen.yan@makeblock.com</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class=" bg-white px-6 py-8 lg:p-16 rounded-lg">
                            ...
                            <div class="flex flex-wrap gap-2 mb-6">
                                <div class="px-4 py-1.5 bg-light-blue-100 rounded-full flex items-center gap-2">
                                    ...
                                    <p class="text-slate-500 p-0 text-default font-semibold">@lang('challenges.common.students') (6-13)</p>
                                </div>
                            </div>
                            <div class="mb-6">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="font-normal text-default md:text-xl text-slate-500 leading-[22px] md:leading-[30px]">
                                    @lang("challenges-content.$slug.example.0"): <a class="text-dark-blue" href="https://www.makex.cc/en/blog/238431">https://www.makex.cc/en/blog/238431</a>
                                    @lang("challenges-content.$slug.example.1") <a class="text-dark-blue" href="https://www.makex.cc/en/blog/235153">https://www.makex.cc/en/blog/235153</a>
                                </div>
                                <img class="my-3" src="{{asset('img/2021/challenges/family-care.png')}}"/>
                            </div>
