                    ...
                    <div class="flex flex-col gap-6">
                        ...
                        <div class="bg-white p-6 rounded-lg">
                            ...
                            <ol class="list-decimal ml-4">
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">@lang("resources.resources.levels.Pre-primary education") (3-5)</li>
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">@lang("resources.resources.levels.Primary school (5-12)")</li>
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">@lang("resources.resources.levels.Lower secondary school (12-16)")</li>
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">@lang("resources.resources.levels.Upper secondary school (16-18)")</li>
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">@lang("resources.resources.levels.Higher Education")  (18-20)</li>
                            </ol>
                        </div>
                        <div class="bg-white p-6 rounded-lg">
                        ...
                        <div class="bg-white p-6 rounded-lg">
                            ...
                            <ol class="list-decimal ml-4">
                                ...
                                <li class="text-slate-500 p-0 text-default font-normal leading-7">@lang('challenges-content.ai-hour-of-code.materials.1') <a class="text-dark-blue"
                                            href="https://education.minecraft.net/en-us/lessons/minecraft-hour-of-code">@lang('challenges-content.ai-hour-of-code.materials.2')</a></li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class=" bg-white px-6 py-8 lg:p-16 rounded-lg">
                            ...
                            <div class="flex flex-wrap gap-2 mb-6">
                                <div class="px-4 py-1.5 bg-light-blue-100 rounded-full flex items-center gap-2">
                                    ...
                                    <p class="text-slate-500 p-0 text-default font-semibold">@lang("resources.resources.levels.Pre-primary education") (3-5)</p>
                                </div>
                                <div class="px-4 py-1.5 bg-light-blue-100 rounded-full flex items-center gap-2">
                                    <img src="{{asset('img/2021/challenges/icons/fi_users.svg')}}" />
                                ...
                                <div class="px-4 py-1.5 bg-light-blue-100 rounded-full flex items-center gap-2">
                                    <img src="{{asset('img/2021/challenges/icons/fi_users.svg')}}" />
                                    <p class="text-slate-500 p-0 text-default font-semibold">@lang("resources.resources.levels.Lower secondary school (12-16)")</p>
                                </div>
                                <div class="px-4 py-1.5 bg-light-blue-100 rounded-full flex items-center gap-2">
                                    <img src="{{asset('img/2021/challenges/icons/fi_users.svg')}}" />
                                    <p class="text-slate-500 p-0 text-default font-semibold">@lang("resources.resources.levels.Upper secondary school (16-18)")</p>
                                </div>
                                <div class="px-4 py-1.5 bg-light-blue-100 rounded-full flex items-center gap-2">
                                    <img src="{{asset('img/2021/challenges/icons/fi_users.svg')}}" />
                                    <p class="text-slate-500 p-0 text-default font-semibold">@lang("resources.resources.levels.Higher Education") (18-20)</p>
                                </div>
                            </div>
                            <div class="mb-6">
                                <p class="font-semibold text-2xl p-0 mb-2">@lang('challenges.common.description')</p>
                                <p class="font-normal text-default md:text-xl p-0 text-slate-500 [&_li]:my-2 leading-[22px] md:leading-[30px]">@lang("challenges-content.$slug.description")</p>
                            </div>
                            <div class="mb-6">
                                ...
                                <ol class="list-disc ml-4 [&_li]:my-2 leading-[22px] md:leading-[30px]">
                                    <li class="font-normal text-default md:text-xl p-0 text-slate-500">
                                        <a class="text-dark-blue" href="https://meedownloads.blob.core.windows.net/learning-experience/HOC%202019/EducatorGuide_en_US.pdf">@lang('challenges-content.ai-hour-of-code.instructions')</a>
                                    </li>
                                </ol>
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <div>
                                    <img src="{{asset('img/2021/challenges/ai-hour-of-code-1.png')}}"/>
                                </div>
                            </div>
