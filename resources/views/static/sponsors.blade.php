<ul class="clients-grid grid-4 nobottommargin clearfix">
    ...
    <li><a href="https://mooc.uniurb.it/wp/codeweekmooc/"><img
                    src="img/partners/urbinocarlo.png" alt="CodeWeek in Your Classroom, Now!"></a></li>

    <li><a href="https://facebook.com/"><img
                    src="img/partners/facebook.png" alt="Facebook"></a></li>
