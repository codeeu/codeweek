...
<section class="relative overflow-hidden">
  ...
  <div class="absolute hidden w-full h-full bg-[#F4F6FA] md:block lg:hidden" style="clip-path: ellipse(188% 90% at 50% 90%);"></div>
  <div class="absolute hidden w-full h-full bg-[#F4F6FA] lg:block xl:hidden" style="clip-path: ellipse(128% 90% at 50% 90%);"></div>
  <div class="absolute hidden w-full h-full bg-[#F4F6FA] xl:block" style="clip-path: ellipse(93% 90% at 50% 90%);"></div>
  <div class="relative flex justify-center pt-20 pb-16 codeweek-container-lg md:pt-40 md:pb-28">
    <div class="w-full gap-2">
      <h3 class="text-dark-blue tablet:text-center text-[22px] md:text-4xl leading-7 md:leading-[44px] font-medium font-['Montserrat'] md:mb-6 text-center">
        @lang('codeweek4all.howto.title')
      </h3>
      <div class="flex flex-col items-center w-full pt-5 pb-5 mx-auto">
        <div class="flex gap-2">
        <button
            class="tab-btn rounded-tl rounded-tr px-5 py-3 border border-solid border-b-0 border-[#A4B8D9] text-blue-800 whitespace-nowrap text-[16px] lg:text-[20px]"
            data-tab="first"
        >
            If you are the first one in your alliance
        </button>
        <button
            class="tab-btn px-5 py-3 rounded-tl rounded-tr border border-solid border-b-0 border-[#A4B8D9] text-blue-800 whitespace-nowrap text-[16px] lg:text-[20px]"
            data-tab="existing"
        >
            If you are joining an existing alliance
        </button>
        </div>
        <div class="w-full h-px mt-0 bg-[#A4B8D9]"></div>
        <div class="w-full max-w-[907px] mt-16">
          <div id="first" class="tab-panel">
            <div class="overflow-hidden max-md:max-w-full">
              <div class="relative flex pb-4 gap-x-8 tablet:pb-16">
                <div class="w-10 h-10 rounded-full flex justify-center items-center text-['#20262C'] font-semibold text-2xl bg-primary">1</div>
                ...
                <div class="flex-1">
                  <p class="text-slate-500 font-normal text-[16px] md:text-xl leading-[22px] md:leading-[30px]">
                    @lang('codeweek4all.howto.content') @lang('codeweek4all.howto.first_alliance.1')
                  </p>
                </div>
              </div>
              <div class="relative flex pb-4 gap-x-8 tablet:pb-16">
                <div class="w-10 h-10 rounded-full flex justify-center items-center text-['#20262C'] font-semibold text-2xl bg-primary">2</div>
                <div class="absolute after:content-[''] after:block after:w-[2px] after:h-full after:bg-[#5F718A] left-5 bottom-2 top-12 tablet:top-16"></div>
                <div class="flex-1">
                  <p class="text-slate-500 font-normal text-[16px] md:text-xl leading-[22px] md:leading-[30px]">
              ...
              <div class="relative flex pb-4 gap-x-8 tablet:pb-16">
                <div class="w-10 h-10 rounded-full flex justify-center items-center text-['#20262C'] font-semibold text-2xl bg-primary">3</div>
                <div class="absolute after:content-[''] after:block after:w-[2px] after:h-full after:bg-[#5F718A] left-5 bottom-2 top-12 tablet:top-16"></div>
                <div class="flex-1">
                  <p class="text-slate-500 font-normal text-[16px] md:text-xl leading-[22px] md:leading-[30px]">
              ...
              <div class="relative flex mb-8 gap-x-8">
                <div class="w-10 h-10 rounded-full flex justify-center items-center text-['#20262C'] font-semibold text-2xl bg-primary">4</div>
                <div class="flex-1">
                  <p class="text-slate-500 font-normal text-[16px] md:text-xl leading-[22px] md:leading-[30px]">
              ...
              <div class="flex flex-col justify-start w-full gap-2 p-6 bg-white rounded-lg tablet:flex-row">
                ...
                <div class="text-slate-500">
                  <p class="font-normal leading-[22px] text-default tablet:leading-[30px] tablet:text-xl">
          ...
          <div id="existing" class="hidden tab-panel">
            <div class="overflow-hidden max-md:max-w-full">
              <div class="relative flex pb-4 gap-x-8 tablet:pb-16">
                <div class="w-10 h-10 rounded-full flex justify-center items-center text-['#20262C'] font-semibold text-2xl bg-primary">1</div>
                <div class="absolute after:content-[''] after:block after:w-[2px] after:h-full after:bg-[#5F718A] left-5 bottom-2 top-12 tablet:top-16"></div>
...
jQuery(function($){
  $('.tab-btn').on('click', function(){
    ...
    // reset all: gray border + blue text + white bg
    $('.tab-btn')
      .removeClass('border-blue-800 bg-blue-800 text-white')
      .addClass('border-[#A4B8D9] text-blue-800');

    // activate clicked: blue border + white text + blue bg
    $(this)
      .removeClass('border-[#A4B8D9] text-blue-800')
      .addClass('border-blue-800 bg-blue-800 text-white');
