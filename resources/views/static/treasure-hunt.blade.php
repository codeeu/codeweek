...
@php
    ...
    $hasTreasureTable = \Illuminate\Support\Facades\Schema::hasTable('treasure_hunt_page');
    $page = $hasTreasureTable ? \App\TreasureHuntPage::config() : null;
            ...
            <div class="codeweek-container-lg relative pt-20 pb-16 md:pt-40 md:pb-28 flex justify-center">
                <div class="w-full max-w-[907px] gap-2">
                    <h2 class="text-dark-blue tablet:text-center text-[22px] md:text-4xl leading-7 md:leading-[44px] font-medium font-['Montserrat'] mb-6 tablet:mb-8">
                        {{ $dynamic && $page->how_to_play_title ? $page->how_to_play_title : 'How to play' }}
                    </h2>
            ...
            <div class="codeweek-container-lg relative pt-20 pb-16 md:pt-40 md:pb-28 flex justify-center">
                <div class="flex flex-col lg:flex-row gap-10 lg:gap-20">
                    ...
                    <div class="flex-1 h-full flex flex-col justify-center order-0 md:order-2">
                        ...
                        <div class="mb-6 flex gap-2 items-center"><div class="bg-primary w-3 h-3 rounded-full"></div><a class="text-white font-normal text-base tablet:text-xl hover:underline" href="{{ $dynamic && $page->get_involved_link_4 ? $page->get_involved_link_4 : 'https://bit.ly/DEEPDIVE2020' }}">@lang('cw2020.get-involved.content.3')</a></div>
                        <div class="mb-6 flex gap-2 items-center"><div class="bg-primary w-3 h-3 rounded-full"></div><a class="text-white font-normal text-base tablet:text-xl hover:underline" href="{{ $dynamic && $page->get_involved_link_5 ? $page->get_involved_link_5 : route('coding@home') }}">@lang('cw2020.get-involved.content.4')</a></div>
                    </div>
                </div>
            </div>
        </section>
