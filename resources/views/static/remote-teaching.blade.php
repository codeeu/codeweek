...
@section('content')
    ...
    <section id="codeweek-remote-teaching-page" class="font-['Blinker'] overflow-hidden">
        <section class="relative flex overflow-hidden">
            <div class="flex relative transition-all w-full bg-[#00B3E3] md:py-20">
                <div class="w-full overflow-hidden pb-10 md:p-0 flex flex-col md:flex-row justify-end md:items-center flex-shrink-0">
                    <div class="codeweek-container-lg flex flex-col justify-end md:justify-start md:flex-row md:items-center duration-1000 gap-28 md:gap-4 xl:gap-28 h-[560px]">
                        <div class="px-6 py-10 md:px-14 md:py-[4.5rem] bg-white rounded-[32px] z-10 relative">
                            <h2 class="text-dark-blue text-[30px] md:text-[60px] leading-9 md:leading-[72px] font-normal font-['Montserrat'] max-md:max-w-full max-w-[532px]">
                        ...
                        >
                            <img src="images/banner_scoreboard.svg" class="mx-auto h-full static-image translate-y-[10%]">
                        </div>
                        <div
