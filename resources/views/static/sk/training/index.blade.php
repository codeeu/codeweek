            ...
            <div class="content-wrap nopadding">
                ...
                <div class="container clearfix ">
                    ...
                    <div class="flex flex-wrap" style="margin-bottom: 30px;">
                        <div class="learning-card"><a href="/training/coding-without-computers"> <img src="img/learning/replace"><div class="text-xl">Programovanie bez digit&aacute;lnej technol&oacute;gie (bez poč&iacute;tača)</div>
                                <div class="text-base text-black">Alessandro Bogliolo</div></a></div>
                        <div class="learning-card"><a href="/training/computational-thinking-and-problem-solving"> <img src="img/learning/replace"><div class="text-xl">V&yacute;počtov&eacute; myslenie a rie&scaron;enie probl&eacute;mov</div>
                                <div class="text-base text-black">Miles Berry</div></a></div>
                        <div class="learning-card"><a href="/training/visual-programming-introduction-to-scratch"> <img src="img/learning/replace"><div class="text-xl">Vizu&aacute;lne programovanie &ndash; &uacute;vod do jazyka Scratch</div>
                                <div class="text-base text-black">Margo Tinawi</div></a></div>
                        <div class="learning-card"><a href="/training/creating-educational-games-with-scratch"> <img src="img/learning/replace"><div class="text-xl">Tvorba vzdel&aacute;vac&iacute;ch hier v&nbsp;jazyku Scratch</div>
                                <div class="text-base text-black">Jes&uacute;s Moreno Le&oacute;n</div></a></div>
                        <div class="learning-card"><a href="/training/making-robotics-and-tinkering-in-the-classroom"> <img src="img/learning/replace"><div class="text-xl">Tvorba, robotika a majstrovanie v&nbsp;triede</div>
