    ...
    <section id="codeweek-homepage" class="codeweek-page font-['Blinker']">
      <section class="relative flex overflow-hidden">
          <div id="slider-wrapper" class="flex relative transition-all duration-500" style="width: fix-content">
            @foreach ($activities as $index => $activity)
              <div id="activity-{{ $index }}" class="relative bg-secondary-gradient overflow-hidden md:px-16 pb-16 pt-80 md:py-[140px] w-[calc(100vw-15px)] flex-shrink-0">
                  <div class="codeweek-container-lg mx-auto flex items-end md:items-center">
                      <div class="px-6 py-10 md:px-14 md:py-[4.5rem] bg-white rounded-[32px] z-10 relative">
                          ...
                          <a
                            ...
                            class="inline-block rounded-full py-4 px-6 md:px-10 text-white mb-4 font-semibold text-[16px] w-full md:w-auto bg-gray-200"
                            href="{{ $activity->url }}"
                          >
        ...
        <section class="relative bg-yellow-2">
            ...
            <div class=" relative z-10 codeweek-container-lg mx-auto flex flex-col-reverse md:flex-row items-center py-16 pb-32 md:pb-48 gap-12">
                <div class="flex-1">
        ...
        <section class="relative bg-yellow-2">
            <div class="relative z-10 codeweek-container-lg mx-auto flex flex-col md:flex-row items-center py-16 md:py-[186px] gap-12">
                <div class="flex-1">
        ...
        <section class="relative overflow-hidden">
            <div class="relative z-10 codeweek-container-lg mx-auto flex flex-col-reverse md:flex-row items-center py-16 gap-12">
                <div class="flex-1">
        ...
        <section class="relative">
            ...
            <div class="relative z-10 codeweek-container-lg mx-auto flex flex-col md:flex-row items-center pt-28 md:pt-48 pb-16 gap-12">
                <div class="flex-1">
