...
return [
    'when-title' => 'EU Code Week 2019 anordnas mellan den 5 och 20 oktober.',
    'when-text' => '<p>EU Code Week &auml;r ett gr&auml;srotsinitiativ som hyllar kreativitet, probleml&ouml;sning och samarbete via programmering och andra tekniska aktiviteter. Tanken &auml;r att g&ouml;ra programmering mer synligt, att visa unga, vuxna och &auml;ldre hur man kan f&ouml;rverkliga id&eacute;er med kod, att avmystifiera dessa f&auml;rdigheter och f&aring; motiverade m&auml;nniskor att l&auml;ra sig tillsammans.</p>',
    ...
    'run_by_volunteers-title' => 'Leds av volont&auml;rer',
    'run_by_volunteers-text' => '<p>EU Code Week organiseras av frivilliga. En eller flera <a href="/ambassadors">ambassad&ouml;rer f&ouml;r Code Week</a> samordnar initiativet i de olika l&auml;nderna, men vem som helst kan organisera en aktivitet och l&auml;gga till den p&aring; kartan p&aring; <a href="/">codeweek.eu</a>.</p>',
    'supported_by_commission-title' => 'St&ouml;ds av Europeiska kommissionen',
    ...
    'why_coding-quote' => '<p>Alessandro Bogliolo, samordnare av EU Code Weeks frivilliga ambassad&ouml;rer s&auml;ger:<blockquote>
    ...
    'join_codeweek-text' => '<p>Delta i EU Code Week genom att <a href="/guide">organisera en kodningsaktivitet</a> p&aring; din ort, delta i <a href="/codeweek4all">Code Week 4 All Challenge</a> och andra aktiviteter som f&ouml;renar n&auml;rsamh&auml;llen och g&aring;r &ouml;ver gr&auml;nserna. Eller hj&auml;lp oss att sprida information om Code Week som <a href="/ambassadors">ambassad&ouml;r f&ouml;r EU Code Week</a> i ditt land!</p>'
];
