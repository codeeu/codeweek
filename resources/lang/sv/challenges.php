...
return [
    ...
    'main' => [
        ...
        'Vem kan vara med?',
        'Alla (skolor, lärare, bibliotek, kodningsklubbar, företag, offentliga myndigheter) är inbjudna att delta i EU Code Week 2021 genom att genomföra en #CodeWeekChallenge.',
    ...
    'share-box' => [
        ...
        'Länk i profilen',
        'lägger till hashtaggen #CodeWeekChallenge och nämner @CodeWeekEU',
