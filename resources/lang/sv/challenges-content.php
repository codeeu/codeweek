...
return [
    'chatbot' => [
        ...
        'description' =>
            'Koda en konversation mellan en chattbot och en användare som försöker lösa en gåta. Försök göra en chattbot som kan chatta som en människa. Istället för en gåta kan du skapa en dialog mellan en chattbot och en användare.',
        'instructions' => [
            'Tänk ut en gåta',
            'Logga in på',
    ...
    'calming-leds' => [
        ...
        'example' =>
            'Besök den här sidan för instruktioner och videor av den genomförda utmaningen plus om hur man kodar',
        'purposes' => [
    ...
    'haunted-house' => [
        ...
        'author' =>
            'Felienne Hermans, Leidens universitet-Ramon Moorlag, I&I-CodeWeek NL',
        ...
        'description' =>
            'Med Hedy kommer du att skapa en berättelse om ett hemsökt hus med interaktiva element. Varje gång koden körs kommer en ny berättelse att skapas. Berättelsen kan också läsas upp av din dator och delas på nätet.',
        'instructions' => [
    ...
    'train-ai-bot' => [
        ...
        'purposes' =>
            'Att lära sig om artificiell intelligens (AI), maskininlärning, dataset, och partiskhet, samtidigt som du utforskar etiska utmaningar och hur AI kan användas för att hantera globala problem.',
        'description' =>
            'Träna en AI-bot med AI för haven. I den här aktiviteten kommer du att programmera eller träna AI (artificiell intelligens) i att identifiera fisk eller skräp. Låtoss städa havet!',
        'instructions' => [
    ...
    'build-calliope' => [
        ...
        'description' =>
            'Deltagarna får utveckla en digitalt kontrollerad prototyp där en färgglad lysande diod används för att återge en förhandsbestämd 10 enheters fitnessövning.',
        'materials' => [
