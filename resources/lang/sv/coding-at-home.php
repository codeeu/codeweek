...
return [
    ...
    'ada-charles-roby' => [
        ...
        'text' =>
            'Historien om Ada Lovelace och Charles Babbage är intressant. De byggde och programmerade datorer 100 år innan de uppfanns på riktigt',
    ...
    'cody-and-roby' => [
        ...
        'material' =>
            'rutbräde med bokstäver och siffror, instruktionskort (vänster, höger, rakt fram)',
    ...
    'material2' => [
        ...
        'cards' =>
            '24 st. ”gå framåt”, 8 st. ”sväng vänster” och 8 st. ”sväng höger”',
        'larger-cards' => 'Ni kan använda större kort om ni spelar på golvet',
        'video' => 'Videon förklarar även hur ni spelar utan en kortlek',
        'pieces-of-paper' =>
            'Ni behöver även 24 pappersbitar som placeras på de rutor som ni har besökt',
        'card-alternative' =>
            'I stället för CodyRoby-korten kan man också använda de kortsymboler som finns här',
        'small-drawings' =>
            'Små teckningar kan användas för att hjälpa till att berätta historien. De som används i videon finns här',
        'rest-of-cards' =>
            'I övrigt använde vi korten från CodyRoby, CodyFeet och CodyColor.'
    ],
    ...
    'two-snakes' => [
        ...
        'material' =>
            'CodyRoby-kort, ett spelbräde med 5 × 5 rutor, två spelpjäser, pappersbitar för att markera de rutor som redan har besökts.',
        'questions' => [
            'content' => [
    ...
    'meeting-point' => [
        ...
        'material' =>
            'CodyRoby-kort, ett spelbräde med 5 × 5 rutor, två spelpjäser.',
        'questions' => [
            'content' => [
    ...
    'follow-the-music' => [
        ...
        'material' =>
            'Utöver CodyRoby-korten behövs spelbrädet och en spelpjäs och något som kan göra tre olika ljud. Jag använde tre glas fyllda med olika mycket vatten. Vad kommer du själv att använda?',
        'questions' => [
            'content' => [
    ...
    'colour-everything' => [
        ...
        'material' =>
            'CodyRoby-kort, ett spelbräde och en spelpjäs. För att färglägga rutorna använder du pappersbitar som du lägger på fälten eller så färgar du fälten med färgpennor.',
        'questions' => [
            'content' => [
    ...
    'codyplotter-and-codyprinter' => [
        ...
        'material' =>
            'Förutom CodyRoby-kitet har jag använt en grön penna och en ny robot i modellera, men det behöver du inte göra.',
        'questions' => [
            'content' => [
    ...
    'boring-pixels' => [
        ...
        'material' =>
            'Rutblock, eller ett rutfält med 5 × 5 rutor ritat på ett papper och en tuschpenna. För att beskriva teckningens kod kan du använda papper och penna.',
        'questions' => [
            'content' => [
