...
return [
    ...
    "guide" => [
        "tutorials" => [
            "1" => "Pogledajte naše",
            "2" => "vodiče i treninge",
            "3" => "dostupne na 29 jezika, kako biste se pripremili za organizaciju aktivnosti u kojima mladi uče kodiranje i računarsko razmišljanje.",
        ]
    ],
    "dance" => [
        "menu" => "Plesni izazov",
        "subtitle" => "Ko je rekao da programeri ne znaju plesati? Dokazaćemo suprotno izazovom #EUCodeWeekDance.",
        "content" => "Pozivaju se svi, od škola, nastavnika, biblioteka do klubova za kodiranje, preduzeća i javnih vlasti da proslave Sedmicu kodiranja Evropske Unije, organizovanjem #EUCodeWeekDance aktivnosti i dodavanjem na mapu Sedmice kodiranja."
    ],
    "treasure-hunt" => [
        "menu" => "Lov na blago",
        "subtitle" => "Ovo je igra na Telegramu",
    ],


    "videos" => [
        1 => "Pogledajte videozapise ambasadora Sedmice kodiranja Evropske Unije o našim vrijednostima",
        2 => "Pogledajte Katju Ošljak, ambasadorku za Sloveniju, o tome zašto je Sedmica kodiranja nezavisna",
        3 => "Pogledajte Laurenta Touchéa, ambasadora za Francusku, zašto je Sedmica kodiranja namijenjena svima",
        4 => "Pogledajte Fatmu Bouaziz, ambasadorku za Tunis, o tome zašto je Sedmica kodiranja glokalna",
        5 => "Pogledajte Lindu Sinku, ambasadorku za Letoniju, o tome zašto Sedmica kodiranja govori o saradnji",
        6 => "Pogledajte Alessandra Bogliola, ambasadora za Italiju, o tome zašto je Sedmica kodiranja neprofitna",
        7 => "Pogledajte Marjanu Prifti, ambasadorku za Albaniju, o tome zašto Sedmica kodiranja podstiče inovacije i kreativnost",
        8 => "Pogledajte Cristianu Lucaci, ambasadorku za Rumuniju, zašto je Sedmica kodiranja zahvalna svojoj zajednici",
    ]
