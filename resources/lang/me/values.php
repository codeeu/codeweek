...
return [
    ...
    'description' => [
        ...
        4 => 'Ponosni smo što smo EU Code Week. Ovo su naše vrijednosti. Njima se u svakom trenutku vodimo kroz posao koji obavljamo i odluke koje donosimo.',
    ],
    '1' => [
        'title' => 'EU Code Week je nezavisna',
        'content' => 'Evropska nedjelja kodiranja je zajednica koju vode volonteri. Naš rad nema ekonomski interes. Poštujemo i vrednujemo tuđe ideje, vjerovanja i kulture. Angažovani smo kroz EU Code Week jer vjerujemo da je ono što radimo važno. U tome je naša snaga. Želimo da računarsko razmišljanje, kodiranje, robotiku, rukovanje hardverom, računarske nauke i digitalne vještine približimo i učinimo dostupnim svima.',
    ],
    '2' => [
        'title' => 'EU Code Week je namijenjena svima',
        'content' => 'Svako može da organizuje aktivnosti EU Code week. U potpunosti razumijemo da je od suštinske važnosti da svi EU Code week događaji budu organizovani za sve, bez obzira na uzrast, boju kože, pol, porijeklo ili intelektualne kapacitete. Aktivnosti mogu imati za cilj da podstaknu interesovanje i radoznalost ili pomognu dodatno razvijanje vještina. Naši principi su ravnopravnost, poštovanje, sloboda i inkluzivnost. Želimo da svi učesnici steknu iskustvo i stvaraju tehnologiju na zabavan način.',
    ],
    '3' => [
