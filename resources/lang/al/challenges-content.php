...
return [
    'chatbot' => [
        ...
        'description' =>
            'Kodoni një bisedë midis një chatbot dhe një përdoruesi që po përpiqet të zgjidhë një gjëegjëzë. Mundohuni të bëni një chatbot që mund të bisedojë si një njeri. Në vend të një gjëegjëze ju mund të krijoni një dialog midis një chatbot dhe një përdoruesi.',
        'instructions' => [
    ...
    'dance' => [
        ...
        'description' =>
            'Në këtë sfidë ju do të krijoni një grup personazhesh që do të kërcejnë së bashku. Ju do të përdorni një bibliotekë të integruar mediatike për të zgjedhur personazhe dhe klipe muzikore ose mund të krijoni tuajën. Ju do t\'i animoni personazhet që të kërcejnë dhe të flasin me njëri -tjetrin.',
        'instructions' => [
            'Identifikohuni',
    ...
    'calming-leds' => [
        ...
        'description' =>
            'Nxënësit krijojnë një pajisje dixhitale duke përdorur LED-e që mund t\'i ndihmojnë ata të rregullojnë frymëmarrjen dhe të ndihen më të qetë. Atyre do t\'u kërkohet të shkruajnë një kod të thjeshtë, duke eksploruar animacione dhe sekuenca.',
        'instructions' => [
        ...
        'example' =>
            'Vizitoni këtë faqe për udhëzime dhe video të sfidës së përfunduar plus si të kodoni',
        'purposes' => [
    ...
    'computational-thinking-and-computational-fluency' => [
        'title' =>
            'Mendimi kompjuterik dhe programimi kompjuterik me ScratchJr',
        ...
        'description' =>
            'Në këtë sfidë fëmijët do të integrojnë konceptet e mendimit kompjuterik në projektet e tyre duke përdorur aplikacionin ScratchJr për t’i bërë historitë e tyre më tërheqëse, emocionuese dhe emocionale.',
        'instructions' => [
    ...
    'create-a-dance' => [
        ...
        'purposes' =>
            'Për të praktikuar kodimin në një mënyrë argëtuese dhe të ndiheni i lidhur me komunitetin e EU Code Week.',
        'description' => [
        ...
        'example' =>
            'Krijimet e nxënësve të zgjedhur mund të gjenden në faqen në vijim',
    ...
    'create-a-simulation' => [
        ...
        'description' =>
            'Shkruani kod për të krijuar dhe drejtuar simulimin tuaj të shpërthimit të virusit në Monster Town. Mësoni të kodoni dhe bëni parashikime se çfarë do të ndodhë me fqinjët e Monster Town.',
        'instructions' => [
            'Udhëzimet shfaqen si video brenda',
            'tutorialit',
            'dhe gjithashtu shkruhen në krye të çdo niveli'
        ...
        'example' =>
            'Kur të keni mbaruar, mund ta ndani simulimin tuaj me të tjerët. Ndani mesazhin tuaj se çfarë mendoni se mund të bëjmë për të ndihmuar për t’i mbajtur të tjerët të shëndetshëm kur vjen një virus në qytet.',
        'materials' => 'Tutoriali i Code.org',
    ],
    'create-your-own-masterpiece' => [
        ...
        'purpose' =>
            'Për të futur konceptet e shkencës kompjuterike në mënyrë vizuale dhe për të frymëzuar krijimtarinë',
        'description' =>
            'Krijoni kryeveprën tuaj me artistin! Përdorni blloqe kodesh për ta bërë artistin tuaj të krijojë një vepër unike arti.',
    ...
    'cs-first-unplugged-activities' => [
        ...
        'description' =>
            'CS First Unplugged është një grup aktivitetesh që i prezantojnë nxënësit me konceptet e shkencës kompjuterike pa kompjuter. Ne e kemi projektuar këtë mësim për të demonstruar se shkenca kompjuterike është shumë më tepër sesa thjesht kod.',
        'instructions' => [
    ...
    'virtual-flower-field' => [
        ...
        'author' =>
            'Jadga Huegle - Njihuni me trajnerin e Code dhe pjesë e ekipit SAP Snap!',
        ...
        'description' =>
            'Zhvilloni një program në Snap! i cili rritet një fushë lulesh virtuale me lloje të ndryshme lulesh dhe numër të ndryshëm petalesh.',
        'instructions' => [
    ...
    'haunted-house' => [
        ...
        'description' =>
            'Me Hedy, ju do të krijoni një histori të Haunted House me elementë ndërveprues. Sa herë që kodi ekzekutohet, do të krijohet një histori e re. Historia gjithashtu mund të lexohet me zë të lartë nga kompjuteri juaj dhe të ndahet në internet.',
        'instructions' => [
    ...
    'inclusive-app-design' => [
        ...
        'description' =>
            'Aplikacionet e shkëlqyera fillojnë me ide të shkëlqyera. Në këtë aktivitet, nxënësit do të vijnë me një ide aplikacioni mbi një temë për të cilën interesohen, pastaj do të zbulojnë se si të hartojnë aplikacione me përfshirjen dhe aksesueshmërinë në mendje.',
        'instructions' => [
    ...
    'silly-eyes' => [
        ...
        'description' =>
            'Në këtë projekt, ju do të dizajnoni dhe krijoni një personazh syri qesharak. Sytë e mëdhenj dhe qesharakë të personazhit do të ndjekin treguesin e mausit për të sjellë në jetë personazhin tuaj.',
    ...
    'train-ai-bot' => [
        ...
        'purposes' =>
            'Për të mësuar rreth inteligjencës artificiale (AI), mësimit mekanik, të dhënave të trajnimit dhe paragjykimeve, ndërsa eksploroni çështje etike dhe sesi AI mund të përdoret për të adresuar problemet botërore.',
        'description' =>
            'Trajnoni një bot AI me AI for Oceans. Në këtë aktivitet, ju do të programoni ose trajnoni AI (inteligjencën artificiale) për të identifikuar peshqit ose plehrat. Le të pastrojmë oqeanin!',
        'instructions' => [
