...
return [
    'free-online-courses' => 'Безоплатні онлайн-курси',
    'intro' => 'Тиждень кодування ЄС пропонує можливості професійного розвитку у формі онлайн-курсів. Їхня мета — підтримати вчителів, які прагнуть донести кодування та обчислювальне мислення до учнів.',
    'icebreaker' => [
        ...
        'text' => [
            ...
            3 => 'You do not need any previous experience or knowledge in coding to participate in this course, just a
                    curious mind.',

        ],
        'registration' => [
            0 => 'Registrations are open here',
            1 => 'for the course that runs between 16 September and 30 October 2020. Please note that you need to create an account in the European Schoolnet Academy to register.',
        ],
        'check-out' => 'Check out the 2019 edition',
    ],
    'deep-dive' => [
        'title' => 'The in-depth “Deep Dive” course',
        'text' => [
            0 => 'The EU Code Week Deep Dive online course is a twenty-five-hour course in English that offers teachers
        ...
        'course-link' => 'Check out the 2019 “Deep dive” course',
    ],
    'social-media' => [
        0 => 'Стежте',
        1 => 'за Тижнем кодування ЄС у соціальних мережах,',
        2 => 'щоб дізнатися, коли розпочнеться наступний курс',
    ],
