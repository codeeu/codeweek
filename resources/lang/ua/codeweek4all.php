...
Критерії для отримання сертифіката про досконалість:
    ...
    'howto' => [
        ...
        'time' => 'Задача «Code Week 4 All» («Тиждень кодування для всіх») триватиме до кінця календарного року. Сертифікати видаватимуться на початку наступного року в січні або лютому.',
    ...
    'superorganiser-title' => 'Сертифікат супер організатора',
    'superorganiser' => 'Ви також можете отримати сертифікат суперорганізатора. Для цього вам потрібно організувати та <a href="https://codeweek.eu/add">зареєструвати</a> принаймні 10 окремих заходів у вашій школі, організації чи онлайн.',
