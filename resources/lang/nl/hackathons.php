...
return [
    ...
    'sections' => [
        ...
        3 => [
            ...
            'content' => [
                1 => 'De EU-programmeerweek hackathons worden mede georganiseerd door de Europese Commissie en lokale EU-',
                2 => 'programmeerweek-ambassadeurs',
                3 => ', en worden gefinancierd door het Europees Parlement. Het is de bedoeling om te laten zien hoe met behulp van de creativiteit, het enthousiasme, de vernieuwende ideeën en de programmeervaardigheden van jongeren concrete oplossingen tot leven komen.'
            ]
        ],
        4 => [
        ...
        5 => [
            'title' => 'Ik heb geen programmeerervaring – wat kan ik doen?',
            'content' => [
                1 => 'Tegelijkertijd met de hackathon zijn er workshops voor beginners op het gebied van programmeren, en is er voor deelnemers gelegenheid om te knutselen met hardware, robotica, enzovoort om de basisbeginselen van computationeel denken en programmeren onder de knie te krijgen. Ga naar jouw lokale pagina voor meer informatie over hoe je je kunt aanmelden.'
            ]
        ],
