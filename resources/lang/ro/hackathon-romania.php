...
return [
    ...
    'misc' => [
        ...
        'Înregistrările pentru EU Code Week Hackathon și pentru evenimentele conexe vor fi gestionate de EU Survey.',
        'Partenerii noștri'
    ],
    'sections' => [
        1 => [
            'content' => [
                'Visezi să dezvolți o aplicație cu care să dai lovitura? Știi moduri în care soluțiile inovatoare în tehnologie ar putea fi de ajutor pentru școala, orașul sau regiunea ta? Dacă dorești să devii antreprenor sau ai o idee genială pe care vrei să o prezinți lumii întregi, dar nu știi de unde să începi, atunci așteptarea ta a luat sfârșit! ',
                'EU Code Week Hackathon',
                'începe cu provocarea de a dezvolta un cod care să rezolve o provocare din viața reală în doar 24 de ore. Echipele clasate pe primele 5 locuri vor primi ulterior instruire și mentorat de la experți în domeniu, pentru a se pregăti pentru a doua rundă, cea finală, în urma căreia se va selecta câștigătorul absolut. Echipa norocoasă va beneficia în continuare de coaching și mentorat pentru ideile sale și va primi echipamente IT atractive. Echipa câștigătoare își va asigura și un loc în cadrul unei prezentări europene, în care toți câștigătorii hackathoanelor își vor prezenta ideile în fața unui juriu european, în timpul evenimentului oficial EU Code Week (Săptămâna UE a programării) derulat între 9 și 24 octombrie 2021.',
                'Hackathonul Săptămâna UE a programării îți va stârni cu siguranță curiozitatea, va fi o sursă de inspirație pentru creativitatea ta, îți va încuraja spiritul antreprenorial și va aduce la viață ideile tale. '
            ]
        ],
        2 => [
            'title' => 'La ce să te aștepți?',
            'content' => [
                'Coaching din partea unor experți',
                'Ateliere de aptitudini',
                'Activități distractive',
                'Șansa de a cunoaște persoane cu aceleași preocupări',
                'Șansa de a câștiga mentorat și coaching, dar și echipamente IT atractive',
                'Șansa de a participa la hackathonul final și de a face cunoștință cu cei mai buni dintre cei mai buni, în persoană!'
            ]
        ],
        3 => [
            'content' => [
                'Înregistrează-te acum la',
                'EU Code Week Hackathon România',
                'și dă viață ideilor tale!'
            ]
        ],
        4 => [
            'title' =>
                'Propune provocări care să fie soluționate în cadrul Hackathonului',
            'content' => [
                'Ai vrea să-ți transformi comunitatea într-un centru de inovație ecologică și sustenabilă în România? Dacă da, propune o provocare care să fie „rezolvată” în cadrul Hackathonului. Un lucru concret care te poate ajuta pe tine personal, școala, orașul sau comunitatea ta.',
                'Propune o provocare',
                'Voturile pentru provocarea din România vor începe pe 24 martie.'
            ]
        ],
        5 => [
            'title' => 'Votează provocările care să fie „rezolvate”',
            'content' => [
                ...
                'Votează ce contează cel mai mult pentru tine!',
                'Provocarea finală selectată va fi anunțată la începutul Hackathonului.'
            ]
        ],
        6 => [
            'title' => 'Provocarea',
        ...
        7 => [
            'title' => 'Centrul de resurse'
        ],
        8 => [
            'title' => 'Program',
            'content' => [
                [
                    'Hackathonul Săptămâna UE a programării are',
                    ' trei runde distincte'
                ],
                'Hackathonul online de 24 de ore. Dintre toate echipele participante, se vor alege doar 5 echipe care vor rămâne în competiție. Instruire online și mentorat gratuite pentru toate cele 5 echipe, pe durata verii 2021.',
                'Runda finală: hackathonul fizic. 5 echipe au primit instruire identică în runda a doua, dar o singură echipă va fi câștigătoare. Liceenii cu vârste între 15 și 19 ani vor concura în echipe pentru a soluționa o „provocare locală” selectată din cadrul propunerilor transmise înainte de prima rundă.',
                'Fiecare echipă câștigătoare pe plan național va concura în confruntarea europeană, în care fiecare echipă își va prezenta soluția în fața unui juriu european în timpul evenimentului oficial EU Code Week (Săptămâna UE a programării), derulat între 9 și 24 octombrie 2021.',
                'În 2021, EU Code Week (Săptămâna UE a programării) include șase hackathoane extraordinare în care sunt invitați liceeni cu vârste între 15 și 19 ani, care vor forma echipe și își vor utiliza aptitudinile de programare pentru a soluționa o provocare locală. După 24 de ore de programare, fiecare echipă își va prezenta ideile în fața unui panou de experți care va alege cele 5 echipe finaliste. Toate echipele vor avea la dispoziție o perioadă egală de timp, resurse identice și acces la mentori și expertiză pentru a finaliza provocarea, dar numai 5 echipe vor primi șansa de a trece în runda următoare, unde își vor dezvolta prototipul, vor beneficia de coaching din partea experților și vor lua parte la hackathonul final din toamnă. În finală, echipele se vor confrunta pentru a stabili cine câștigă accesorii IT și șansa de a primi mentorat și coaching pentru a-și dezvolta prototipul în continuare.',
                'Echipa ta nu va primi garantat un loc în runda a doua, chiar dacă ați soluționat cu succes provocarea. Nu uitați că sunteți în concurs cu celelalte echipe, iar juriul va lua în considerare metoda utilizată, felul în care ați utilizat timpul pus la dispoziție și calitatea prototipului pentru a selecta candidații care vor promova! ',
                'Dacă echipa ta se află printre cele 5 finaliste, puteți lucra la ideea voastră peste vară. Pentru a vă ajuta, vă oferim instruire gratuită pentru dezvoltare și design UX. Echipa ta poate primi și ajutorul unui mentor, care se va asigura că sunteți pe calea cea bună.',
                'Cele 5 echipe finaliste vor lua parte la un hackathon de 12 ore, online. Aici, echipele vor concura pentru a stabili care sunt cei mai buni tineri programatori la nivel național, putând câștiga premii constând în echipamente IT atractive, precum și coaching și mentorat pentru ideile lor în continuare.'
            ]
        ],
        'winners' => [
            'Felicitări tuturor participantilor primei editii european code week hackaton, a fost o placere sa va avem alaturi.  Speram sa v ati distrat la fel de bine ca noi! ',
            'Salutam echipele castigatoare cu laude speciale. Echipele selectate pentru finala, care si vor lua locul de la 25 - 26 septembrie, sunt urmatoarele : ',
            'Asteptam cu nerabdare sa va vedem acolo. Coaching si premii garantate.',
            'Fiecare echipă câștigătoare pe plan național va concura în confruntarea europeană, în care fiecare echipă își va prezenta soluția în fața unui juriu european în timpul evenimentului oficial EU Code Week (Săptămâna UE a programării), derulat între 9 și 24 octombrie 2021. Campioana europeană, în afară de glorie, va câștiga și echipamente IT suplimentare.'
        ],
        'focus' => [
            'Despre hackathon-ul online de 24 de ore:',
            'Introducere in European Code Week Hackaton România',
            'Descoperirea întreceri pentru săptămâna EU Code Week România',
            'Prezentarea soluțiilor pentru EU Code Week România',
            'Anuntarea castigatorilor la EU Code Week Hackaton România'
        ],
        9 => [
            'title' => 'Informații practice',
            'content' => [
                'Hackathon-ul va avea loc la fața locului în perioada 25-26 septembrie 2021.',
                'Participarea la hackathon este gratuită.'
            ]
        ],
        10 => [
            'title' => 'Juriu și mentori',
            'content' => [
                'Imaginează-ți că ești într-o cameră virtuală plină de designeri, dezvoltatori, creatori, programatori și mentori de afaceri, toți plini de curiozitate și motivație, la fel ca tine. EU Code Week Hackathon România reunește personalități marcante din lumea afacerilor, IT, investitorilor de capital de risc, educației, precum și lideri, influențatori și formatori locali, naționali și europeni, care vor îndruma și vor susține echipa ta în timpul acestui maraton intensiv.',
                'Înregistrează-te acum la',
                'EU Code Week Hackathon',
                'și transformă-ți ideile în realitate!'
            ]
        ],
        ...
        12 => [
            ...
            'content' => [
                ...
                'Comisia Europeană',
                'și ambasadorii locali',
                'EU Code Week (Săptămâna UE a programării)',
                'Inițiativa este finanțată de',
        ...
        'mentors' => [
            '1' => [
                "Diana Maria Ghitun este masterand, alumni al Computer Science (MSc.) la King's College Londra. De la absolvire, ea a avut oportunitatea sa lucreze in diverse tipuri de companii, de la fin tech startups la coporatii, cat si in research.",
                'In prezent, Diana lucreaza ca si Senior Software Engineer la Take Off Labs in Cluj Napoca, loc unde si-a gasit o noua pasiune pentru Ruby on Rails si React Native. '
            ],
            '2' => [
                'Sunt o persoana proactiva, curioasa si ambitioasa, care isi doreste se sa autodepaseasca si sa descopere noi viziuni si experiente intr-un mediu dinamic. ',
                'Imi place foarte mult sa lucrez cu generatii care gandesc si actioneaza diferit fata de mine. In felul acesta pot castiga perspective si idei noi.'
            ],
            '3' => [
                'George a fondat si conduce WiseUp, o agenție de prototipare. În activitatea lui, George folosește tehnici de Lean Startup, Design Thinking & Data Science pentru a ajuta antreprenori si directori ca sa ia decizii pe baza de date.',
                'În trecut a proiectat si condus multiple acceleratoare de startup-uri, a mentorat startupuri si corporații.'
            ],
            '4' => [
                'Numele meu este Ioana Alexandru. Lucrez la Google ca software engineer și în paralel urmez un program de master în grafică pe calculator - e o adevărată provocare, dar mă motivează să fiu mereu în priză. Am avut două internship-uri peste vară în 2018 și 2019, care m-au făcut să mă îndrăgostesc de cultura Google, iar acum sunt angajată din noiembrie 2020.',
                'În companie lucrez pe partea de infrastructură, iar în afara ei folosesc de principiu Unity și Flutter. În timpul liber, fac călărie și mă joc jocuri video (PC, Oculus, Switch).'
            ],
            '5' => [
                'Antreprenor, Program Manager si Software Quality Advocate.',
                '10+ ani experienta in diferite tipuri de proiecte, imi place sa invat lucruri noi si sa gasesc solutii inovative.'
            ],
            '6' => [
                'Data scientist, momentan intern la Google in Elvetia. Pasionată de antreprenoriat și inovație, activez ca Startup Manager la EPFL Entrepreneur Club și conduc o echipa de investiții formată din studenți la Wingman Campus Fund.',
                'Sustinatoare a diversității în technologie, conducând Girls Who Code Iași până anul trecut.'
            ],
            '7' => [
                'Sunt profesor de informatica si imi place foarte mult ceea ce fac. Ca proefsie de baza, sunt inginer automatist. Sunt profesor de 30 de ani. Predau informatica si TIC la liceu, la un colegiu tehnic si la scoala Postliceala Analist-Programator. Sunt instructor si formator national Cisco Academy. Predau C++, Java, Oracle SQL si robotica (in cadrul cercului de informatica) si imi place sa ma ocup si de hardware si de retelistica.',
                'Imi plac provocarile, imi place sa lucrez in proiecte cu elevii mei si vreau sa invat tot timpul lucruri noi.'
            ],
            '8' => [
                'Arhitect de solutii software cu peste 10 ani de experienta in dezvoltarea de aplicatii enterprise. La ora actuala proiecteaza solutii pe zona de cloud computing si robotic process automation pentru mai multe industrii.',
                'Leader al IBM Technical Expert Council in Romania si al programului de meetups IBM Developer.  Intraprenor pasionat si organizator de hackathoane.'
            ],
            '9' => [
