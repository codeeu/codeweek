...
return [
    ...
    "sections" => [
        ...
        8 => [
            "title" => "Program",
            "content" => [
                "Hackathonul Săptămâna UE a programării are trei runde distincte.",
                "Hackathonul online de 24 de ore. Dintre toate echipele participante, se vor alege doar 10 echipe care vor rămâne în competiție.",
                "Instruire online și mentorat gratuite pentru toate cele 10 echipe, pe durata verii 2021.",
                "Runda finală: hackathonul fizic. 10 echipe au primit instruire identică în runda a doua, dar o singură echipă va fi câștigătoare. Liceenii cu vârste între 15 și 19 ani vor concura în echipe pentru a soluționa o „provocare locală” selectată din cadrul propunerilor transmise înainte de prima rundă.",
                ...
                "Dacă echipa ta se află printre cele 10 finaliste, puteți lucra la ideea voastră peste vară. Pentru a vă ajuta, vă oferim instruire gratuită pentru dezvoltare și design UX. Echipa ta poate primi și ajutorul unui mentor, care se va asigura că sunteți pe calea cea bună.",
                "Cele 10 echipe finaliste vor lua parte la un hackathon de 12 ore față-în-față pe data de X (care va avea loc online dacă situația în materie de sănătate publică nu permite o întâlnire fizică). Aici, echipele vor concura pentru a stabili care sunt cei mai buni tineri programatori la nivel național, putând câștiga premii constând în echipamente IT atractive, precum și coaching și mentorat pentru ideile lor în continuare.",
        ...
        "mentors" => [
            ...
            "7" => ["Sunt profesor de informatica si imi place foarte mult ceea ce fac. Ca proefsie de baza, sunt inginer automatist. Sunt profesor de 30 de ani. Predau informatica si TIC la liceu, la un colegiu tehnic si la scoala Postliceala Analist-Programator. Sunt instructor si formator national Cisco Academy. Predau C++, Java, Oracle SQL si robotica (in cadrul cercului de informatica) si imi place sa ma ocup si de hardware si de retelistica.","Imi plac provocarile, imi place sa lucrez in proiecte cu elevii mei si vreau sa invat tot timpul lucruri noi."],
