...
return [
    'chatbot' => [
        ...
        'description' =>
            'Să programăm o conversație între chatbot și un utilizator care încearcă să rezolve o ghicitoare. Încercați să faceți un chatbot care să poată purta o discuție ca o persoană. În locul unei ghicitori, puteți crea un dialog între un chatbot și un utilizator.',
        'instructions' => [
    ...
    'dance' => [
        ...
        'description' =>
            'În această provocare veți crea un set de personaje care vor dansa împreună. Veți folosi biblioteca audiovizuală (Media Library) încorporată pentru a selecta personajele și clipurile muzicale sau puteți crea unele proprii. Veți anima personajele astfel încât să danseze și să discute între ele.',
        'instructions' => [
            'Conectați-vă la',
    ...
    'compose-song' => [
        ...
        'description' =>
            'În această provocare veți crea o compoziție muzicală folosind un limbaj de programare. Puteți folosi clipuri audio încorporate sau puteți să vă înregistrați propriile clipuri și să le mixați pentru a crea o compoziție muzicală. Executați codul în Digital Audio Workstation (programul de înregistrare și editare audio) și ascultați muzica pe care ați programat-o. Jucați-vă cu diferite sunete și efecte pentru a vă modifica piesa muzicală.',
        'instructions' => [
            'Conectați-vă la',
    ...
    'calming-leds' => [
        ...
        'description' =>
            'Elevii creează un dispozitiv digital folosind leduri care îi pot ajuta să își regleze respirația și să se liniștească. Li se va cere să scrie un cod simplu, explorând animații și secvențe de cod.',
        'instructions' => [
        ...
        'example' =>
            'Vizitați această pagină pentru instrucțiuni și videoclipuri ale provocării finalizate, precum și pentru instrucțiuni despre cum să programați',
        'purposes' => [
    ...
    'computational-thinking-and-computational-fluency' => [
        'title' =>
            'Gândire computațională și fluență computațională cu ScratchJr',
        ...
        'description' =>
            'În această provocare, copiii vor integra concepte ale gândirii computaționale în proiectele proprii, folosind aplicația ScratchJr pentru a-și face poveștile mai captivante, mai palpitante și mai pline de emoție.',
        'instructions' => [
    ...
    'create-a-dance' => [
        ...
        'purposes' =>
            'Exersarea distractivă a programării și integrarea în comunitatea Săptămânii UE a programării.',
        'description' => [
        ...
        'example' =>
            'Creațiile prezentate ale elevilor se pot găsi pe pagina următoare',
    ...
    'create-a-simulation' => [
        ...
        'description' =>
            'Scrieți codul de programare pentru a vă crea și a vă executa propria simulare a epidemiei virale în Monster Town (Orașul Monștrilor). Învățați să programați și faceți previziuni despre ce se va întâmpla cu vecinii Monster Town (Orașului Monștrilor).',
        'instructions' => [
            'Instrucțiunile sunt prezentate ca înregistrări video în',
            'tutorial',
            'și sunt și scrise la fiecare nivel, în partea de sus'
        ...
        'example' =>
            'Când sunteți gata, le puteți distribui și altora simularea pe care ați creat-o. Distribuiți mesajul vostru despre ce credeți că putem face pentru a-i ajuta pe alții să se însănătoșească atunci când pătrunde un virus în oraș.',
        'materials' => 'Tutorialul Code.org',
    ],
    'create-your-own-masterpiece' => [
        ...
        'purpose' =>
            'Prezentarea vizuală a conceptelor informatice și inspirarea creativității',
        'description' =>
            'Creați-vă propria capodoperă cu un artist! Folosiți blocuri de cod pentru a-l face pe artistul vostru să creeze o operă de artă unică.',
    ...
    'cs-first-unplugged-activities' => [
        ...
        'description' =>
            'CS First Unplugged reprezintă un set de activități care le prezintă elevilor concepte informatice fără să necesite un computer. Am conceput această lecție pentru a demonstra că informatica nu se reduce nici pe departe la codul de program.',
        'instructions' => [
