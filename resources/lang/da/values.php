...
return [
    ...
    'description' => [
        ...
        4 => 'Vi er stolte over at være en del af EU’s kodeuge. Dette er vores værdier. Værdier der til alle tider er styrende for vores arbejde og de beslutninger vi træffer.',
    ],
    '1' => [
        'title' => 'EU’s kodeuge er uafhængig',
        'content' => 'EU\'s kodeuge drives af frivillige. Vi handler ikke ud fra økonomiske interesser. Vi respekterer og værdsætter andre menneskers idéer, overbevisninger og kulturer. Vi tager del i EU\'s kodeuge, fordi vi tror på vigtigheden af det vi gør. Det er vores styrke. Vi ønsker at gøre datalogisk tænkning, kodning, programmering, computervidenskab, robotteknologi, hardwaretilpasning og generelle digitale færdigheder tilgængelig for alle.',
    ],
    '2' => [
        'title' => 'EU’s kodeuge er for alle',
        'content' => 'Alle kan tilrettelægge aktiviteter under EU\'s kodeuge. Vi erkender at det er essentielt at begivenhederne i EU’s kodeuge arrangeres for alle, uanset alder, farve, køn, kulturel baggrund eller intellektuelle evner. Aktiviteterne kan være en indgang til at skabe interesse og nysgerrighed eller en hjælp til at videreudvikle færdigheder.  Vores principper er ligestilling, respekt, frihed og inklusion. Vi ønsker at alle deltagerne skal have det sjovt med at opleve og konstruere med teknologi.',
    ],
    '3' => [
