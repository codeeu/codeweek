...
return [
    'simulate-dice-in-python' => [
        ...
        'durations' => [
            '30 til 45 minutter for den grundlæggende version',
            'Op til 60 minutter, hvis man udforsker avancerede muligheder (to terninger, hyppigste kast osv.)'
        ],
        ...
        'instructions' => [
            ...
            'For at komme i gang skal du have Python installeret på din computer.',
            'Hvis du ikke allerede har det, kan du downloade Python fra den officielle hjemmeside.',
            'Åbn Python IDLE eller en hvilken som helst teksteditor (f.eks. Visual Studio Code, PyCharm) for at skrive kode.',
            ...
            'import random',
            'Vi viser en velkomsthilsen til brugerenprint("Welcome to the roll-dice simulation!")',
            ...
            'result = random.randint(1, 6) # Vi genererer et tilfældigt tal mellem 1 og 6',
            ...
            'Importér random-modulet: random-modulet giver dig mulighed for at generere tilfældige tal. Funktionen random.randint(a, b) returnerer et tilfældigt heltal i intervallet fra a til b, inklusiv begge grænser.',
            'Indtast antal kast: Programmet beder brugeren om at indtaste, hvor mange gange de vil kaste terningen. Den indtastede værdi konverteres til et heltal ved hjælp af int().',
            'Simulering af kast: Programmet bruger en for-løkke til at udføre terningekastet så mange gange, som brugeren har angivet. For hvert kast genereres et tilfældigt tal mellem 1 og 6, som repræsenterer resultatet.',
        ...
        'quiz_title' => 'Quiz:',
        'quiz' => [
            'Hvilket modul i Python bruges til at generere tilfældige tal?',
            'random',
            'Math',
            'Time',
            'Hvad gør funktionen random.randint(1, 6)?',
            'Genererer et tilfældigt tal mellem 1 og 6',
            'Udskriver et tilfældigt tal på skærmen',
            'Udskriver et tal mellem 1 og 6',
            'Hvordan konverterer man brugerens input til et heltal i Python?',
            'float(s)',
            'int()',
            'p()',
    ...
    'train-it-like-fei-fei-li' => [
        ...
        'examples' => [
            '· Kunstig intelligens i detailhandel og shopping:',
            ...
            'Kunstig intelligens og hjælpemiddelteknologi',
    ...
    'gender-gap-gender-graph' => [
        ...
        'instructions' => [
            ...
            'Klik på det grønne flag og indsæt data (1-10), der hypotetisk repræsenterer antallet af kvinder i en tech-sektor. Prøv med nogle tal.',
            '',
            'Hvad bemærker du?',
    ...
    'dance-with-ally' => [
        ...
        'instructions' => [
            ...
            'Opret et program med blokke, der vil muliggøre en sprite dans til valgt musik (med start lyd blok)), der bevæger sig, når vi ryster micro: bit. Dansen består af kun to kommandoer: slide på x-aksen til venstre og højre. Gem projektet på computeren.',
        ...
        'examples_title' => 'Eksempler',
        'examples' => [
            'At forbinde en micro:bit med Scratch for at styre en dansende sprite er en fantastisk måde at udforske interaktiv programmering på. Dette koncept kan udvides til forskellige virkelige applikationer og kreative projekter, såsom:',
    ...
    'coding-for-the-ocean' => [
        ...
        'description' => 'Opret og træn en AI-bot for at beskytte havet! Lær at kode, løse miljøproblemer og udvikle logisk tænkning for at beskytte havmiljøet.',
        'educational_goals' => [
        ...
        'variations' => [
            'Udvidelse af udfordringen til andre miljøer: Du kan ændre udfordringen ved at involvere AI-robotter, der beskytter andre økosystemer som skove, floder eller endda byområder. Botterne vil skulle tage fat på udfordringer såsom skovrydning eller luftforurening.'
        ],
    ],
    'code-it-like-margaret-hamilton' => [
        ...
        'instructions' => [
            '1. Indledning:',
            'Læreren præsenterer rummissioner og sender mennesker til månen og introducerer Margaret Hamilton og hendes bidrag til Apollo planlægning. Dette efterfølges af en diskussion om, hvad programmering er, og hvordan vi kan give instruktioner til en computer.',
            '2. Programmering aktivitet: Margaret Hamilton koder og tæller ned og rumfartøjet forlader til Månen.',
    ...
    'careers-as-constellations' => [
        'title' => 'Karrierer som konstellationer',
        'authorcontent' => 'Denne udfordring og konkurrence er initiativ fra Linda Liukas, forfatter, illustrator og iværksætter i forbindelse med Code4Europe-partnerskabets Girls in Digital Campaign 2025 #Webinar 1, der livestreames på Youtube: <a href="https://www.youtube.com/live/52LaQA9342k" target="_blank">How Code, Creativity and Curiosity former a Career?</a>',
        'author' => 'Linda Liukas',
        'start-date' => 'Startdato',
        'activity-type' => 'Type aktivitet',
        'open-online-activity' => 'Åben onlineaktivitet',
        'name-of-org' => 'Organisationens navn',
        'language' => 'Sprog',
        'description' => 'Denne interaktive aktivitet hjælper eleverne med at kortlægge deres personlige interesser og hobbyer til potentielle karrierer inden for teknologi. Ved at visualisere deres færdigheder og interesser som konstellationer opdager eleverne, hvordan karrierer dannes ved at forbinde tilsyneladende ikke-relaterede prikker. Der kræves ingen forudgående erfaring med kodning, og aktiviteten fremmer kreativ tænkning om fremtidens arbejde inden for teknologi.',
        'teachers' => 'Lærere',
        'english' => 'Engelsk',
        'type-of-org' => 'Type organisation',
        ...
        'theme' => 'Hovedtemaer',
        'themes' => [
            'motivation-and-awareness-raising' => 'Motivation og bevidstgørelse',
            'promoting-diversity' => 'Fremme af mangfoldighed',
        ],
        'age-group' => 'Aldersgruppe',
        'age-groups' => [
            '12' => '12+ (kan tilpasses til mellemskole-, gymnasie- eller endda universitetsstuderende)',
            'under-6' => 'Under 6',
            '7-8' => '7-8',
            '9-11' => '9-11',
            '12-14' => '12-14',
        ...
        'subjects' => 'Fag',
        'time-required' => 'Tidsforbrug',
        '45–60' => '45–60 minutter',
        'group-size' => 'Gruppens størrelse',
        'group-sizes' => [
            'small' => 'Individuel eller i små grupper',
        ],
        'required-materials' => 'Nødvendige materialer',
        'step-by-step-instructions' => 'Trin for trin instruktioner',
        'materials' => [
            'one' => 'Arbejdsark med forskellige karrierer trykt på (A3 anbefales)',
            'two' => 'Papir <span class="font-sans">&</span> tuscher/kuglepenne til egne noter',
            'three' => 'Valgfrit: Digital version (eleverne kan oprette konstellationer ved hjælp af Miro, Canva eller Google Jamboard)',
        ],
        'titles' =>  [
            'one' => 'Opvarmningsdiskussion: Hvad er dine prikker? (5 min)',
            'two' => 'Kortlægning af konstellationer: At forbinde interesser med teknologi (20 min)',
            'three' => 'Eksempler på forbindelser',
            'four' => ' Refleksion <span class="font-sans">&</span> deling: Hvilke mønstre fandt du? (15 min)',
            'five' => 'Udvidelse af aktiviteten',
        ],
        'intro' => '<p>Start med at udfordre traditionelle karriereideer med et spørgsmål:</p>
         <p  class="my-8 italic">Synes du, at karrierer skal følge en lige vej?</p>
         <p> Introducer ideen om, at succesfulde karrierer ofte opbygges af uventede forbindelser.</p><p>Se sammen Linda Liukas\' foredrag, hvor hun deler sin egen karrierevej inden for teknologi</p>',
        'content' => [
            'one' => '<p>Hver elev udfylder arbejdsarket Karrierer som konstellationer og tilføjer:</p>',
            'two' => 'Personlige interesser (hobbyer, færdigheder, yndlingsaktiviteter)',
            'three' => 'Teknologirelaterede emner (AI, robotteknologi, spildesign, digital kunst, bæredygtighedsteknologi osv.)',
            'four' => '<strong>Tegn linjer</strong> for at vise sammenhænge mellem deres interesser og teknologi',
            'five' => 'Elsker du musik? → interesseret i AI? → AI-genererede musikværktøjer!',
            'six' => 'Elsker du at tegne? → Interesseret i spildesign? → 2D/3D-animation <span class="font-sans">&</span> kodning',
            'seven' => 'Brænder du for klimaforandringer? → Interesseret i data? → Miljøteknologi',
            'eight' => 'Bed eleverne om at fortælle om overraskende sammenhænge, de har opdaget.',
            'nine' => 'Spørg: Hvilke prikker føltes urelaterede i starten? Hvordan fik de forbindelse?',
            'ten' => '<p>Diskussion:</p>',
            'eleven' => 'Hvad overraskede dig ved din konstellation?',
            'twelve' => 'Opdagede du nogle karriereveje, du ikke havde overvejet før?',
            'thirteen' => 'Hvordan kan teknologi forme din fremtid på uventede måder?',
            'fourteen' => 'Digital udfordring 1: Få eleverne til at oprette en digital version af deres konstellation ved hjælp af Miro, Canva eller Google Jamboard og præsentere deres resultater.',
            'fifteen' => 'Digital udfordring 2: Studerende undersøger en person indenfor teknologi, hvis karriere fulgte en overraskende vej, kortlægger deres konstellation og deler deres historie.',
            '16' => 'Download skabelonen  til aktiviteten',
            '17' => 'OBS! HUSK AT TILFØJE DIN AKTIVITET OG UPLOADE DEN <a href="/add">HER!</a>',
        ],
    ],
];
