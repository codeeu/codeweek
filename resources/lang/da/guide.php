...
return [
    ...
    'what_you_need_organise' => [
        ...
        'items' => [
            '1' => '<strong>En gruppe, der gerne vil lære.</strong> Det kan for eksempel være venner, børn, unge, voksne, kolleger, forældre eller bedsteforældre. Husk, at der kun skal to til at danne en gruppe!',
            '2' => '<strong>Lærere eller undervisere</strong>, som kan kode og ved, hvordan man lærer fra sig og inspirerer andre. Antallet afhænger af arrangementets type og størrelse.',
            '3' => '<strong>Et sted at lære.</strong> Klasseværelser, biblioteker, mødelokaler og forskellige offentlige rum er alle egnede steder.',
            '4' => '<strong>Computere og forbindelse til internettet.</strong> Afhængigt af målgruppen kan du eventuelt bede deltagerne om selv at medbringe en bærbar computer.',
            '5' => '<strong>Kodning uden computer.</strong> Man behøver faktisk ikke en computer og en internetforbindelse for at lære at tænke som en computer. Du kan finde inspiration i vores <a href="/training/coding-without-computers">sektion om læring uden computer</a> for at komme i gang.',
            '6' => '<strong>Undervisningsmaterialer.</strong> Vis deltagerne, hvor sjovt det kan være at kreere sine egne værker. Se vores <a
                        href="/resources">ressourceside</a> og <a href="/training">undervisningsbidder</a>, hvor der er videovejledninger og læreplaner, som du kan tilpasse efter gruppens behov.',
