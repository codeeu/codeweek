...
return [
    ...
    'questions' => 'Spørgsmål',
    'material' => [
        'required' => 'Nødvendige materialer',
        'chequered' => 'skakternet spilleplade',
        'footprint' => 'brikker med billede af et fodaftryk'
    ],
    'intro' => [
        'title' => 'Introduktion til Coding@Home'
    ],
    'explorer' => [
        'title' => 'The Explorer',
        'text' =>
        ...
        'questions' => [
            'content' => [
                1 => 'Sp. 1 Med de start- og slutpositioner der vises i videoen, er det da muligt for exploreren at besøge alle felterne på spillepladen?',
                2 => 'Sp. 2 Hvilke og start- og slutpositioner forhindrer exploreren i at besøge det størst mulige antal felter på spillepladen?'
            ]
        ]
    ],

    'right-and-left' => [
        'title' => 'Højre og venstre (Right and Left)',
        'text' =>
        ...
        'questions' => [
            'content' => [
                1 => 'Sp. 1 Med en start- og slutopstilling som i det første spil i denne video, er det da muligt for et af de to hold at vinde?',
                2 => 'Sp. 2 Med en start- og slutopstilling som i det spil, som Anna vandt, kunne der da være uafgjort?',
                3 => 'Sp. 3 Er der nogen start- og slutopstillinger, der tilgodeser det ene af de to hold?',
                4 => 'Sp. 4 I betragtning af placeringen af start- og slutpositioner, er det da muligt at forudsige forskellen mellem det vindende og det tabende hold?'
            ]
        ]
    ],
    ...
    'ada-charles-roby' => [
        ...
        'text' =>
            'Historien om Ada Lovelace og Charles Babbage er interessant. De udtænkte og programmerede computere, hundrede år før computere faktisk blev opfundet',
    ...
    'cody-and-roby' => [
        ...
        'material' =>
            'skakternet spilleplade med betegnelser, kommandokort (venstre, højre, ligeud) samt eventuelle tællere, der skal placeres på spillepladen',
    ...
    'the-tourist' => [
        ...
        'material' =>
            'Store kort kan være nyttige, hvis der skal spilles på gulvet',
        'questions' => [
            'content' => [
    ...
    'two-snakes' => [
        ...
        'material' =>
            'CodyRoby-kort, en 5 × 5 spilleplade, to brikker samt papirstykker, der skal bruges til at markere de felter, en slange allerede har været på.',
        'questions' => [
            'content' => [
    ...
    'follow-the-music' => [
        ...
        'material' =>
            'Ud over CodyRoby-kortene, spillepladen og en brik skal vi lave tre forskellige lyde. Jeg brugte tre glas, der indeholdt forskellige mængder vand. Hvad vil du bruge?',
        'questions' => [
            'content' => [
    ...
    'material2' => [
        'chequered-with-labels' =>
            'Bræt med felter og etiketter 24 "gå fremad"-kort',
        'cards' => '8 "drej til venstre"-kort og 8 "drej til højre"-kort',
        'larger-cards' => 'Vi anbefaler større kort til gulvudgaven',
        'video' =>
            'Denne video forklarer også, hvordan du spiller uden kortbunken',
        'pieces-of-paper' =>
            'Du skal bruge 24 stykker papir til at lægge på de felter, der allerede er besøgt',
        'card-alternative' =>
            'Som alternativ til bunken af CodyRoby-kort kan du bruge de kort, der er tilgængelige her',
        'small-drawings' =>
            'En tilføjelse kunne være små tegninger, der hjælper med at fortælle historien. Du finder dem, der bruges i videoen, her',
        'rest-of-cards' =>
            'Til resten bruger vi kortene til CodyRoby, CodyFeet eller CodyColour.'
    ],
    ...
    'colour-everything' => [
        ...
        'material' =>
            'CodyRoby-kort, et ternet bræt og en brik. Anbring papirstykker på felterne, eller farvelæg dem med tuscher.',
        'questions' => [
            'content' => [
    ...
    'codyplotter-and-codyprinter' => [
        ...
        'material' =>
            'ud over CodyRoby-sættet brugte jeg en grøn tusch og en ny robot i modellervoks, men det er valgfrit.',
        'questions' => [
            'content' => [
    ...
    'boring-pixels' => [
        ...
        'material' =>
            'en notesblok med ternet papir eller et 5 x 5 ternet bræt på et stykke papir og en filtpen. Du kan bruge pen og papir til at gengive koden bag tegningen.',
        'questions' => [
            'content' => [
    ...
    'texts' => [
        ...
        3 => 'Hvis du er interesseret i flere offline-aktiviteter eller aktiviteter på forskellige programmeringssprog, robotteknologi, micro :bit osv, er du velkommen til at tjekke <a href="/training">“Undervisningsbidder til EU\'s kodeuge”</a>, hvor du kan finde video-tutorials og undervisningsplaner for alle undervisningstrin fra grundskole til og med gymnasieniveau. Du kan også tjekke ressource-siden for henholdsvis <a href="/resources/learn">elever/studerende</a> og <a href="/resources/teach">lærere</a>. '
    ]
];
