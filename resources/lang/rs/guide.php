...
return [
    ...
    'what_you_need_organise' => [
        ...
        'items' => [
            '1' => '<strong>Grupa ljudi koji su željni da uče.</strong> Na primer, vaši prijatelji, deca, tinejdžeri, saradnici, roditelji ili bake i deke. Zapamtite, dvoje su već grupa!',
            '2' => '<strong>Nastavnici ili instruktori</strong> koji su upoznati sa aktivnostima programiranja i znaju kako da uče i inspirišu druge. Broj zavisi od vrste i veličine događaja.',
            '3' => '<strong>Mesto gde se uči.</strong> Učionice, biblioteke, konferencijske sale i različiti javni prostori – sve su to sjajna mesta za organizovanje uspešnog događaja.',
            '4' => '<strong>Kompjuteri i internet veza.</strong> U zavisnosti od ciljne grupe, možete da zamolite učesnike da donesu svoje laptop računare.',
            '5' => '<strong>Programiranje bez računara.</strong> Zapravo vam nisu potrebni ni računari niti internet veza da biste naučili računarsko razmišljanje. Pogledajte naš <a href="/training/coding-without-computers">Modul za učenje programiranja bez računara</a> za početne korake.',
            '6' => '<strong>Materijali za učenje</strong> Pokažite učesnicima koliko može da bude zabavno kada sami nešto naprave. Pogledajte našu <a
                        href="/resources">stranicu sa resursima</a> i <a href="/training">module za učenje</a> sa video vodičima i planovima lekcija i prilagodite ih potrebama vaše grupe.',
