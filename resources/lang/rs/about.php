...
return [
    ...
    'run_by_volunteers-text' => '<p>EU nedelju programiranja vode volonteri. Jedan ili vi&scaron;e <a href="/ambassadors">ambasadora Nedelje programiranja</a> koordinira aktivnostima inicijative u svojoj zemlji, ali svako može da organizuje sopstveni događaj i da ga doda na <a href="/">codeweek.eu</a> mapu.</p>',
    ...
    'schools-title' => '&Scaron;kole',
    'schools-text' => '<p>Posebno su pozvane sve &scaron;kole iz celokupnog obrazovnog sistema i svi predmetni nastavnici da učestvuju u EU nedelji programiranja kako bi pružili mogućnost svojim učenicima da istraže digitalnu kreativnost i programiranje. Saznajte vi&scaron;e o inicijativi i kako da organizujete aktivnost putem veb stranice posvećene nastavnicima: <a href="/schools">CodeWeek.eu/Schools</a></p>',
    'why_coding-title' => 'Za&scaron;to programiranje?',
    'why_coding-text' => '<p>Zbog Pie, koja je osećala da mora da studira pravo, iako je oduvek uživala u matematici i igranju sa kompjuterima. Zbog Marka, koji ima ideju za bolju dru&scaron;tvenu mrežu, ali ne može sam da je napravi. Zbog Alise koja ma&scaron;ta da pravi robote jer joj roditelji ne dozvoljavaju da ima mačku.</p>
    ...
    'join_codeweek-text' => '<p>Pridružite se EU nedelji programiranja <a href="/guide">organizovanjem aktivnosti u vezi sa programiranjem</a> u svom gradu, učestvovanjem u <a href="/codeweek4all">izazovu Nedelja programiranja za sve</a> i povezivanjem aktivnosti sa zajednicama u zemlji i van nje, ili nam pomozite da ra&scaron;irimo viziju Nedelje programiranja kao <a href="/ambassadors">Ambasador EU nedelje programiranja</a> za va&scaron;u zemlju!</p>'
];
