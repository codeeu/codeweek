...
return [
    ...
    'texts' => [
        ...
        3 => 'Jei jus domintų daugiau užsiėmimų, kuriuos būtų galima atlikti neprisijungus, taip pat įvairių programavimo sričių, pavyzdžiui, kalbų, robotikos, „micro:bit“ užsiėmimai, apsilankykite ES programavimo savaitės <a href="/training">mokymosi svetainėje,</a> kurioje rasite vaizdo pamokas ir pamokų planus pradinėms, pagrindinėms ir vidurinėms mokykloms. Taip pat peržiūrėkite ES programavimo savaitės mokymosi išteklius, kuriuose rasite nemokamų aukštos kokybės išteklių iš viso pasaulio mokytojams ir mokiniams.',
    ],
