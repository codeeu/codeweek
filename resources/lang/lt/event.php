...
return [
    ...
    |
    */
    'main_title'=>'Pridėkite savo #codeEU renginį',
    ...
    'theme' => [
        ...
        'Web development' => 'Tinklalapio kūrimas',
        'Mobile app development' => 'Mobiliosios programėlės kūrimas',
        'Software development' => 'Programinės įrangos kūrimas',
        'Data manipulation and visualisation' => 'Manipuliavimas duomenimis ir duomenų vizualizacija',
        'Robotics' => 'Robotika',
        'Hardware' => 'Aparatinė įranga',
        'Other' => 'Kita',
        'Unplugged activities' => 'Veiklos be kompiuterio',
        'Playful coding activities' => 'Žaidybinis programavimas',
        'Art and creativity' => 'Menas ir kūryba',
        'Visual/Block programming' => 'Vaizdinis ir (arba) blokinis programavimas',
        'Game design' => 'Žaidimų kūrimas',
        'Internet of things and wearable computing' => 'Daiktų internetas ir dėvimieji kompiuteriai',
        '3D printing' => 'Trimatis spausdinimas',
