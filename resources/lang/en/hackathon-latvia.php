    ...
    'sections' => [
        ...
        8 => [
            ...
            'content' => [
                ...
                'The 24-hour online hackathon. Out of all those competing, only 10 teams will be chosen to remain in the competition. Free online training and mentoring for all 10 teams, during summer 2021.',
                'The final hackathon. 10 teams will have all received equal training in the second round, but only one will win.  Secondary school students aged 15-19 will compete in teams to solve a ‘local challenge’ selected from proposals submitted ahead of the first round.',
        ...
        'focus' => [
            'About the 24h online Hackathon:',
            'Introduction to the EU Code Week Hackathon Latvia',
            'Reveal of the challenge for EU Code Week Hackathon Latvia',
            'Pitch of solutions for the EU Code Week Hackathon Latvia',
            'Announcement of winners of EU Code Week Hackathon Latvia'
        ],
        9 => [
