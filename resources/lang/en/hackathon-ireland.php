...
return [
    ...
    'sections' => [
        ...
        3 => [
            'content' => [
                'Sign up now to',
                'EU Code Week Hackathon Ireland',
        ...
        4 => [
            ...
            'content' => [
                ...
                'Propose a challenge',
                'Votes for the Irish challenge will start on the 24 of March.'
            ]
        ],
        5 => [
        ...
        6 => [
            ...
            'content' => [
                ...
                'Based on public voting, the challenge for the Irish Hackathon is:',
                'Based on public voting, the challenge for the Irish Hackathon was:'
            ]
        ],
        7 => [
        ...
        //                "The 24-hour online hackathon. Out of all those competing, only 5 teams will be chosen to remain in the competition.",
        //                "Free online training and mentoring for all 5 teams, during summer 2021.",
        //                "The final round: the physical hackathon. 5 teams will have all received equal training in the second round, but only one will win.  Secondary school students aged 15-19 will compete in teams to solve a ‘local challenge’ selected from proposals submitted ahead of the first round.",
        //                "In 2021, EU Code Week brings six extraordinary hackathons and invites upper secondary school classes to form teams and use their coding skills to solve a local challenge. After 24 hours of hacking, each team will pitch their ideas to a panel of experts who will choose the 5 final teams. All teams will have the same amount of time, resources, and access to mentors and expertise in order to complete the challenge, but only 5 will get the chance to continue to the next round, develop their prototype, get expert coaching and take part in the final hackathon in the autumn. In the final, the teams will battle it out to decide who wins IT accessories and the chance of mentoring and coaching to further develop their prototype.",
        ...
        'voting' => [
            'title' =>
                'Vote now for your preferred challenge for EU Code Week Hackathon Ireland on 26-27 April 2021!',
            'challenges' =>
                'Challenges have been collected from all over the country to allow the students to solve a challenge for their local community. After careful deliberation, the top 3 challenges have been selected, and we leave it up to you to decide which challenge that may be solved through coding, developing, and design at the hackathon.',
            'deadline' =>
                'You can vote for your preferred challenge until 20 April 2021, where the final challenge is selected.',
            ...
            'reveal-date' =>
                'The challenge is revealed after the opening of the online hackathon on 26 April.',
            'thanks' => [
                'Thanks for voting!',
