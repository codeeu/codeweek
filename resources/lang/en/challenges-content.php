...
'simulate-dice-in-python' => [
    ...
    'duration_title' => 'Duration',
    'duration' => '30 to 45 minutes for a basic version. Up to 60 minutes if exploring advanced options (two dice, most frequent roll, etc.).',
    'materials_title' => 'Recommended tool',
    'materials' => [
    ...
    'instructions' => [
        ...
        'Import random module : The random module allows you to generate random numbers.',
        'The random.randint(a, b) function returns a random integer in the range from a to b, including both ends.',
        'Enter the number of throws : The programme asks the user to enter the number of times he wants to roll the dice.',
        'We convert the entered number to an integer using int().',
        'Toss simulation : The programme uses a loop to perform a dice simulation as many times as the user has entered.',
        'For each throw, a random number between 1 and 6 is generated, representing the result of the throw.',
        'Print results : For each throw, the result is printed (the number that has "fallen" on the dice).',
        'At the end of the programme, a message of gratitude is printed.',
...
'gender-gap-gender-graph' => [
    ...
    'advanced_experience' => 'Advanced - Designed for participants with strong coding skills and prior experience in programming.',
    'duration_title' => 'Duration',
    'duration' => '2 hours',
    'materials_title' => 'Recommended tool',
    'materials' => [
    ...
    'instructions' => [
        ...
        'Click on the green flag and insert data (1-10) that hypothetically represent the number of women in a tech sector.',
...
'coding-for-the-ocean' => [
    ...
    'instructions' => [
        'Access Code.org',
        'Open your web browser and go to Code.org. If you don\'t have an account, you can create one or log in with an existing one.',
        'Start a new project',
        'On the main screen, select the course or tutorial related to ocean protection. Click "Start" to begin your project.',
        'Follow the step-by-step tutorial',
        'Code.org will guide you through an interactive tutorial. Read each instruction carefully and complete each step. Make sure to follow the instructions to learn how to program your AI bot.',
        'Program your bot',
        'Use the visual coding blocks to teach your bot how to respond to environmental situations, such as collecting plastic or avoiding obstacles. Modify the blocks to suit different situations and test the bot\'s behavior.',
        'Test your bot',
        'After writing the code, test your bot to see how it handles the challenges. If the bot doesn\'t work as expected, go back and modify it, then retest it until it\'s effective.',
        'Share your bot with the class',
        'Once your bot is ready, copy the project link and share it with your classmates. Join the competition to see which bot is the most effective at protecting the sea.',
        'Review and improve',
        'After completing the challenge, review your code and look for ways to improve it. You can add more features to the bot to tackle new environmental challenges.',
