...
return [
    ...
    "volunteer" => [
        "Liikumises osalemiseks ei ole vaja end ELi programmeerimisnädala Code Week kogukonnas ametlikult registreerida. Igaüks võib korraldada tegevusi, mille eesmärk on õpetada ja inspireerida inimesi tegelema programmeerimise, robootika, riistvara arendamise, 3D-printimise või muu taolisega, ja need kaardile kanda. Kui soovite siiski pühendada oma aega programmeerimise edendamisele ja usute ELi programmeerimisnädala Code Week visiooni ja väärtustesse, võite saada mentorõpetajaks või saadikuks.",
        "Kui olete õpetaja, kes suhtub programmeerimise õpetamisse ja õppimisse sama suure kirega nagu meie, lugege lisateavet mentorõpetaja rolli ja sellest saadava kasu kohta siit. Mentorõpetajaks kandideerimiseks tuleb täita veebipõhine kandideerimisvorm. Pange tähele, et igal riigil on kindel arv mentorõpetajaid ja seega on kandideerimine avatud vaid mõnes riigis korraga. Kui soovite oma riigis programmeerimise populaarsust edendada, tutvuge saadikute kohustustega ja vaadake ka ELi programmeerimisnädala Code Week saadikute nimekirja.",
