...
return [
    ...
    */
    ...
    'after_or_equal'       => ':attribute peab olema :date vői hilisem kuupäev.',
    ...
    'boolean'              => ':attribute väli peab olema őige vői väär.',
    'confirmed'            => ':attribute ei vasta kinnitusele.',
    'date'                 => ':attribute ei ole őige kuupäev.',
    ...
    'dimensions'           => ':attribute on valede pildimőőtuega.',
    ...
    'required'             => 'Väli :attribute on nőutav.',
    'required_if'          => 'Väli :attribute on nőutav, kui :other on :value.',
    'required_unless'      => 'Väli :attribute on nőutav, v.a juhul kui :other on :value.',
    'required_with'        => 'Väli :attribute on nőutav, kui :values on olemas.',
    'required_with_all'    => 'Väli :attribute on nőutav, kui :values on olemas.',
    'required_without'     => 'Väli :attribute on nőutav, kui :values ei ole olemas.',
    'required_without_all' => 'Väli :attribute on nőutav, kui ühtegi :values väärtust ei ole.',
    ...
    'unique'               => ':attribute on juba vőetud.',
    'uploaded'             => 'Üksuse :attribute üleslaadimine ei őnnestunud.',
