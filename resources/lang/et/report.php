...
return [
    ...
    */
    ...
    'average_participant_age' => [
        'label'=>'Osalejate keskmine vanus',
    ],
    'percentage_of_females' => [
        'label' => 'Naiste osakaal',
    ],
    'codeweek_for_all_participation_code' => [
        'label' => 'Code Week 4 All osalemiskood',
        'help' => 'Siia saad sisestada oma Code Week 4 All väljakutse koodi, kui sul see on. Kui sa ei osale, jäta see väli vahele.'
    ],
