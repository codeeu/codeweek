...
return [
    'chatbot' => [
        ...
        'description' => 'Programmeerige vestlus vestlusroboti ja kasutaja vahel, kes püüab mõistatust lahendada. Püüdke luua vestlusrobot, kes suudab inimese moodi vestelda. Mõistatuse asemel võite koostada dialoogi vestlusroboti ja kasutaja vahel.',
        'instructions' => [
    ...
    'dance' => [
        ...
        'description' => 'Selles väljakutses loote tegelased, kes hakkavad koos tantsima. Tegelasi ja muusikalõike saate valida sisseehitatud meediateegist või luua need ise. Animeerides panete need tegelased tantsima ja omavahel rääkima.',
        'instructions' => [
            'Logige sisse',
    ...
    'calming-leds' => [
        ...
        'description' => 'Õpilased loovad LEDide abil digiseadme, mis võib aidata neil oma hingamist reguleerida ja end rahulikumalt tunda. Neil palutakse kirjutada lihtne programm, mis käsitleb animatsioone ja jadasid. ',
        'instructions' => [
        ...
        'example' => 'Sellelt lehelt leiate juhendid ja videod väljakutse lahendatud ülesandest ning programmeerimisjuhendi',
        'purposes' => [
    ...
    'computational-thinking -and-computational-fluency' => [
        'title' => 'Algoritmiline mõtlemine ja algoritmiline sujuvus ScratchJr’iga',
        ...
        'description' => 'Selles väljakutses lõimivad lapsed algoritmilise mõtlemise põhimõtteid oma projektidesse rakendusega ScratchJr, et muuta oma lood haaravamaks, põnevamaks ja emotsionaalsemaks. ',
        'instructions' => [
    ...
    'create-a-dance' => [
        ...
        'purposes' => 'Programmeerimise lõbus harjutamine ja ELi programmeerimisnädala Code Week kogukonda kuulumise tunne',
        'description' => [
    ...
    'create-a-simulation' => [
        ...
        'description' => 'Kirjutage programm, et luua simulatsioon viirusepuhangust Koletiselinnas ja see tööle panna. Õppige programmeerima ja prognoosima seda, mis juhtub Koletiselinna naabritega. ',
        'instructions' => [
            'Juhtnööre kuvatakse videotena',
            'juhendi sees',
            'ja need on kirjas ka iga taseme ülaservas',
        ],
        'example' => 'Kui olete lõpetanud, saate oma simulatsiooni teistega jagada. Jagage sõnumi teel ideid, mida te saaksite teha, et aidata teistel terveks jääda, kui viirus linna jõuab. ',
        'materials' => 'Code. org’i juhend',
    ],
    'create-your-own-masterpiece' => [
        'title' => 'Looge omaenda meistriteos!',
        'audience' => 'Sobib igas vanuses',
        'purpose' => 'Informaatika põhimõtete tutvustamine visuaalsel kujul ja loovuse ergutamine',
        'description' => 'Looge kunstnikuga omaenda meistriteos!Koodiplokkide abil saate panna oma kunstniku ainulaadset kunstiteost looma. ',
    ...
    'cs-first-unplugged-activities' => [
        ...
        'description' => 'CSi esimesed veebiühenduseta tegevused on rida tegevusi, mis tutvustavad õpilastele CSi põhimõtteid ilma arvutita. Selle õppetunni koostamise eesmärk oli näidata, et informaatika ei tähenda ainult programmeerimist.',
        'instructions' => [
    ...
    'virtual-flower-field' => [
        ...
        'author' => 'Jadga Huegle – projekti Meet and Code juhendaja ja SAP Snap!-i tiimi liige',
        ...
        'description' => 'Koostage Snap!-is programm, mis kasvatab virtuaalse lilleaasa erinevat liiki lilledega, millel on erinev arv õielehti. ',
        'instructions' => [
    ...
    'haunted-house' => [
        ...
        'author' => 'Felienne Hermans, Leideni Ülikool; Ramon Moorlag, I&I – CodeWeek NL',
        ...
        'description' => 'Koostage Hedys interaktiivsete elementidega kummitusmaja lugu. Programmi käivitamisel luuakse iga kord uus lugu. Teie arvuti võib selle loo ka ette lugeda ja seda saab veebis jagada.',
        'instructions' => [
    ...
    'inclusive-app-design' => [
        ...
        'description' => 'Suurepäraste rakenduste aluseks on suurepärased ideed. Selles tegevuses leiavad õpilased rakenduse idee neile südamelähedasel teemal ning seejärel õpivad kujundama rakendusi, milles pööratakse tähelepanu kaasamisele ja ligipääsetavusele.',
        'instructions' => [
    ...
    'silly-eyes' => [
        ...
        'description' => 'Selles projektis kujundate ja loote naljakate silmadega tegelase. Tegelane ärkab ellu, kui ta suured naljakad silmad jälgivad hiire kursorit. ',
    ...
    'train-ai-bot' => [
        ...
        'purposes' => 'Teadmiste omandamine tehisintellekti, masinõppe, koolitusandmete ja eelarvamuste kohta, tutvudes eetiliste küsimustega ning võimalustega kasutada tehisintellekti maailma probleemide lahendamiseks. ',
        'description' => 'Õpetage tehisintellektiga robotit ookeanide jaoks. Selles tegevuses programmeerite või õpetate tehisintellekti kalu või prügi ära tundma. Teeme ookeani puhtaks!',
        'instructions' => [
    ...
    'build-calliope' => [
        ...
        'description' => 'Osalejad loovad digitaalselt kontrollitava prototüübi, mis kasutab värvilisi põlevaid LED-tulesid, et taasluua eelnevalt koostatud 10 üksusest koosneva treeningharjutuse.',
        'materials' => [
    ...
    'code-a-dice' => [
        ...
        'description' => 'Selles ülesandes programmeerite täringu juhuslikku veeremist teie käsu peale. Võite valida mis tahes liiki ja külgede arvuga täringu (näiteks sellise, mida kasutatakse rollimängudes) ning lisada ka helisid.',
        'instructions' => [
    ...
    'personal-trainer' => [
        ...
        'description' => 'See ülesanne võimaldab programmeerida oma micro:bit-i nii, et see loendaks harjutuste kordusi koos puhkepausiga. Saate jälgida oma liikuvust koolis, kodus või pargis.',
        'instructions' => [
    ...
    'coding-escape-room' => [
        ...
        'duration' => '90 minutit',
        'instructions' => 'Võite jagada õpilased väikestesse rühmadesse, et nad saaksid mängida, ja seejärel luua malli põhjal uue väljakutse: ',
