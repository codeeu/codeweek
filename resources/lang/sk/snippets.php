...
return [
    ...
    "guide" => [
        "tutorials" => [
            "1" => "Prejdite si naše",
            "2" => "návody a kurzy,",
            "3" => "ktoré sú dostupné v 29 jazykoch, a naučte sa organizovať činnosti, pri ktorých sa mladí ľudia naučia programovať a počítačovo myslieť.",
        ]
    ],
    "dance" => [
        "menu" => "Výzva do tanca",
    ...
    "treasure-hunt" => [
        ...
        "subtitle" => "Táto hra sa hrá v aplikácii Telegram",
    ],


    "videos" => [
        1 => "Pozrite si videá ambasádorov Európskeho týždňa programovania o našich hodnotách",
        2 => "Pozrite si video slovinskej ambasádorky Katji Osljakovej o tom, prečo je týždeň programovania nezávislý",
        3 => "Pozrite si video francúzskeho ambasádora Laurenta Touchého o tom, prečo je týždeň programovania pre každého",
        4 => "Pozrite si video tuniskej ambasádorky Fatmy Bouazizovej o tom, prečo je týždeň programovania glokálny",
        5 => "Pozrite si video lotyšskej ambasádorky Lindy Sinkovej o tom, prečo je týždeň programovania o spolupráci",
        6 => "Pozrite si video talianskeho ambasádora Alessandra Bogliola o tom, prečo je týždeň programovania neziskový",
        7 => "Pozrite si video albánskej ambasádorky Marjany Priftiovej o tom, prečo týždeň programovania podporuje inovácie a kreativitu",
