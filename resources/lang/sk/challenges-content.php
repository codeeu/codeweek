...
return [
    'chatbot' => [
        ...
        'description' =>
            'Naprogramujte konverzáciu medzi četbotom a používateľom, ktorý sa pokúša rozlúštiť hádanku. Skúste vytvoriť četbota, ktorý četuje ako človek. Namiesto hádanky môžete vytvoriť dialóg medzi četbotom a používateľom.',
        'instructions' => [
            'Vymyslite hádanku',
            'Prihláste sa na',
    ...
    'dance' => [
        ...
        'description' =>
            'V tejto výzve vytvoríte súbor postáv, ktoré budú spolu tancovať. Postavy a hudobné klipy si vyberiete zo zabudovanej mediálnej knižnice alebo si môžete vytvoriť vlastné. Vašou úlohou bude animovať postavy, aby spolu tancovali a rozprávali sa medzi sebou.',
        'instructions' => [
            'Prihláste sa na',
    ...
    'microbit.org s materiálmi na aktivity'
        ...
        'description' =>
            'Žiaci vytvoria digitálne zariadenie využívajúce svetlá LED, pomocou ktorého si môžu ovládať dýchanie, aby sa upokojili. Ich úlohou je napísať jednoduchý kód, pohrať sa s animáciami a sekvenciami.',
        'instructions' => [
    ...
    'tomto odkaze'
        ...
        'example' =>
            'Navštívte túto stránku, na ktorej nájdete pokyny a videá vypracovanej výzvy plus návod na programovanie',
        'purposes' => [
    ...
    'computational-thinking-and-computational-fluency' => [
        'title' =>
            'Výpočtové myslenie a výpočtová gramotnosť pomocou ScratchJr',
        ...
        'description' =>
            'V tejto výzve deti vo svojich projektoch uplatnia výpočtové myslenie, pričom použijú aplikáciu ScratchJr, aby vytvorili pútavejšie, zaujímavejšie a expresívnejšie príbehy.',
        'instructions' => [
    ...
    'create-a-dance' => [
        ...
        'purposes' =>
            'Precvičiť si programovanie zábavným spôsobom a spojiť sa s komunitou Európskeho týždňa programovania',
        'description' => [
        ...
        'example' =>
            'Vybrané výtvory žiakov možno nájsť na tejto stránke',
    ...
    'create-a-simulation' => [
        ...
        'description' =>
            'Napíšte kód a spustite vlastnú simuláciu vírusovej nákazy v mestečku Monster Town. Naučte sa programovať a predpovedať, čo sa stane so susedmi v mestečku Monster Town.',
        'instructions' => [
            'Pokyny sa zobrazujú vo forme videí v rámci',
            'návodu',
            'a sú tiež napísané navrchu každej úrovne'
        ...
        'example' =>
            'Keď skončíte, môžete sa o svoju simuláciu podeliť s ostatnými. Vyjadrite, čo môžeme podľa vás spraviť, aby sme ochránili zdravie ostatných, keď do mestečka prenikne vírus.',
        'materials' => 'Návod na Code.org',
    ],
    'create-your-own-masterpiece' => [
        ...
        'purpose' =>
            'Vizuálne predstaviť koncepcie výpočtovej vedy a vzbudiť tvorivosť',
        'description' =>
            'Vytvorte s umelcom originálne umelecké dielo!, Pomocou programovacích blokov zadaj svojmu umelcovi, ako má vytvoriť jedinečné umelecké dielo.',
    ...
    'description' =>
        'Prvé aktivity výpočtového myslenia bez počítača predstavujú súbor aktivít, prostredníctvom ktorých sa žiaci zoznamujú s koncepciami výpočtového myslenia mimo počítača. Cieľom tejto vyučovacej hodiny je preukázať, že výpočtová veda zďaleka nie je len o programovaní.',
    'instructions' => [
    ...
    'author' =>
        'Jadga Huegle – koučka Meet and Code a členka tímu SAP Snap!',
    ...
    'description' =>
        'Vytvoriť program v nástroji Snap!, v ktorom vyrastie virtuálny kvetinový záhon s rozličnými typmi kvetov a rôznym počtom lupienkov.',
    'instructions' => [
    ...
    'author' =>
        'Felienne Hermans, Univerzita v Leidene – Ramon Moorlag, I&I – CodeWeek NL',
    ...
    'description' =>
        'Pomocou Hedy vytvoríte príbeh o strašidelnom dome s interaktívnymi prvkami. Po každom spustení kódu sa vytvorí nový príbeh. Príbeh tiež môže nahlas prečítať váš počítač a môže sa zverejniť online.',
    'instructions' => [
    ...
    'description' =>
        'Skvelé aplikácie sú postavené na skvelých nápadoch. V tejto aktivite žiaci a študenti vymyslia nápad na aplikáciu k téme, ktorá im je blízka, potom skúmajú ako pri navrhovaní aplikácií zohľadňovať začleňovanie všetkých ľudí a prístupnosť.',
    'instructions' => [
    ...
    'description' =>
        'V tomto projekte navrhnete a vytvoríte postavu so srandovnými očami. Veľké, srandovné oči postavy budú sledovať kurzor myši a oživia vašu postavu.',
    ...
    'purposes' =>
        'Naučiť sa, čo je to umelá inteligencia (AI), strojové učenie, trénovacie údaje, a predsudky, a zároveň skúmať etické otázky, a ako možno využiť umelú inteligenciu pri riešení svetových problémov.',
    'description' =>
        'Vytrénujte robota s umelou inteligenciou pre oceány (AI for Oceans). V tejto aktivite naprogramujete alebo vytrénujte umelú inteligenciu (AI) tak, aby vedela rozlišovať ryby od odpadu. Poďme spolu vyčistiť oceán!',
    'instructions' => [
