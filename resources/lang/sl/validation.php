...
return [
    ...
    */
    ...
    'alpha'                => ':attribute lahko vsebuje samo èrke.',
    'alpha_dash'           => ':attribute lahko vsebuje samo èrke, številke in poševnice.',
    'alpha_num'            => ':attribute lahko vsebuje samo èrke in številke.',
    ...
    'boolean'              => 'Polje :attribute mora biti pravilno ali napaèno.',
    'confirmed'            => 'Potrdilo :attribute ni ustrezno.',
    'date'                 => ':attribute ni veljaven datum.',
    'date_format'          => ':attribute ne ustreza formatu :format.',
    'different'            => ':attribute in :other morata biti razlièna.',
    ...
    'max'                  => [
        'numeric' => ':attribute ne sme biti veèji od :max.',
        'file'    => ':attribute ne sme biti veèji od :max kilobajtov.',
        'string'  => ':attribute ne sme biti veèji od :max znakov.',
        'array'   => ':attribute ne sme biti veèji od :max postavk.',
    ],
    ...
    'required_unless'      => 'Polje :attribute je obvezno, razen èe je :other v :values.',
    ...
    'timezone'             => ':attribute mora biti veljavno obmoèje.',
    ...
    */
    ...
    'custom' => [
        'attribute-name' => [
            'rule-name' => 'prilagojeno-sporoèilo',
        ],
    ],
