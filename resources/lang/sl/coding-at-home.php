...
return [
    ...
    'explorer' => [
        'title' => 'Raziskovalec',
        'text' =>
            'Raziskovalec je prva aktivnost Coding@Home. Raziskovalca po plošči premikajte do cilja tako, da obiščete kar največ kvadratov.',
        'questions' => [
            'content' => [
    ...
    'right-and-left' => [
        'title' => 'Desno in levo',
        'text' =>
            'Desno in levo je igra tekmovanja in sodelovanja. Dve ekipi sodelujeta, da ustvarita pot proti cilju, hkrati pa med seboj tekmujeta, da uporabita kar največ dodeljenih ploščic: rumena ekipa poskuša vstaviti kar največ zavojev v levo, rdeča pa v desno.',
        'questions' => [
            'content' => [
    ...
    'keep-off-my-path' => [
        ...
        'text' =>
            'Ne hodi po moji poti je tekmovalna igra z dvema ekipama. Ekipi začneta igro na nasprotni strani plošče in gradita poti, ki ovirata druga drugo. Zmaga ekipa, ki drugi preprečiti gradnjo poti.',
        'questions' => [
            'content' => [
    ...
    'tug-of-war' => [
        'title' => 'Vlečenje vrvi',
        'text' =>
            'Vlečenje vrvi je sodelovalna in tekmovalna igra. Začne se na sredini spodnjega dela plošče, ekipi (rumena in rdeča) pa sodelujeta, da skupaj dosežeta vrh. Rumena ekipa poskuša doseči polja na levi, rdeča ekipa pa polja na desni.',
        'questions' => [
            'content' => [
    ...
    'explorer-without-footprints' => [
        ...
        'text' =>
            'Raziskovalec hodi po plošči od začetne točke do cilja in poskuša obiskati vsa polja. Med hojo raziskovalec pušča raznobarvne stopinje, ki omogočajo robotu, da sledi korakom z interpretiranjem barv. Igra postane še bolj zanimiva, ko raziskovalec umakne stopinje in pusti samo barve.',
    ...
    'walk-as-long-as-you-can' => [
        'title' => 'Hodi čim dlje',
        'text' =>
            'Cilj te igre je, da čim dlje ostaneš na igralni plošči, tako da namesto stopinj uporabljaš barve. Z več svobode gibanja se težavnost igre stopnjuje.',
        'coloured-cards' =>
            'barvni kartončki ali rdeči, rumeni in sivi flomaster',
        'questions' => [
            'content' => [
    ...
    'ada-charles-roby' => [
        ...
        'text' =>
            'Zgodba Ade Lovelace in Charlesa Babbagea je zelo zanimiva. Računalnike sta zasnovala in programirala že sto let, preden so bili izumljeni',
    ...
    'cody-and-roby' => [
        'title' => 'Cody in Roby',
        'text' =>
            'To je igra vlog, v kateri sodelujeta programer Cody in robot Roby. V videoposnetku so predstavljeni kartončki CodyRoby, ki jih bomo odslej uporabljali za določanje premikov po igralni plošči. Cody z uporabo kartončkov Robyju daje ukaze za premikanje po igralni plošči',
        'material' =>
            'igralna plošča z oznakami, kartončki z ukazi (levo, desno, naravnost) in žetoni, ki jih postavimo na igralno ploščo',
    ...
    'the-tourist' => [
        'title' => 'Turist',
        'text' =>
            'Od dveh ekip, ki tekmujeta med seboj, zmaga tista, ki s pomočjo kartončkov CodyRoby v najkrajšem možnem času oblikuje zaporedje ukazov, ki bo turista pripeljalo do želenih znamenitosti na igralni plošči',
    ...
    'material2' => [
        ...
        'cards' =>
            '24  kart „pojdi naravnost“, 8  kart „obrni se v levo“ in 8  kart „obrni se v desno“',
        'larger-cards' =>
            'Pri talni različici igre se priporoča uporaba večjih kart',
        'video' => 'V videu je prikazano tudi, kako igrati brez igralnih kart',
        'pieces-of-paper' =>
            'Potrebujete tudi 24  koščkov papirja, ki jih položite na že obiskana polja',
        'card-alternative' =>
            'Namesto igralnih kart CodyRoby lahko uporabite ikone kart, ki so na voljo tukaj',
        'small-drawings' =>
            'Lahko uporabite sličice kot dodatek pri pripovedovanju zgodbe. Te, ki smo jih uporabili v videu, so na voljo tukaj',
        'rest-of-cards' =>
            'Za ostalo smo uporabili karte CodyRoby, CodyFeet ali CodyColour.'
    ],

    'catch-the-robot' => [
        'title' => 'Ujemi robota',
        'text' =>
            'Ujemi robota je tekmovalna namizna ali talna igra. Zmaga tisti igralec, ki ujame robota nasprotne ekipe tako, da doseže njegovo polje. Zaradi naključne porazdelitve igralnih kart morata obe ekipi ves čas prilagajati svojo strategijo.',
        'questions' => [
            'content' => [
    ...
    'the-snake' => [
        'title' => 'Kača',
        'text' =>
            'Kača je vrsta igre za enega igralca, ki se igra s kartami CodyRoby. Cilj igre je voditi kačo prek vseh polj na igralni plošči, ne da bi se kača pri tem ugriznila v rep.',
        'questions' => [
            'content' => [
    ...
    'storytelling' => [
        ...
        'text' =>
            'Današnja tema je pripovedovanje zgodb! Uporabite navodila CodyRoby, sledi CodyFeet ali barve CodyColour in vodite figure po igralni plošči, da pripovedujete zgodbo. Naključno razvrstite dele zgodbe po igralni plošči.',
        'questions' => [
            'content' => [
    ...
    'two-snakes' => [
        'title' => 'Kači',
        'text' =>
            'Z uporabo kart CodyRoby se kači premikata po igralni plošči in, pri tem poskušata ovirati druga drugo. Osnovno pravilo je zelo preprosto: ne morete se vrniti na polje, ki ga je kača že obiskala. Zmaga kača, ki se lahko najdlje prosto premika naokrog.',
        'material' =>
            'Karte CodyRoby, igralna plošča 5 × 5, figurici in koščki papirja za označevanje že obiskanih polj.',
        'questions' => [
            'content' => [
    ...
    'round-trip' => [
        'title' => 'Tja in nazaj',
        'text' =>
            'Ekipi se izmenjujeta. Prva začrta odhodno potovanje, druga pa mora Robyja pripeljati nazaj na začetni položaj. Zdi se preprosto, vendar ni, zlasti če poteze načrtujete samo v glavi, ne da bi dejansko premikali Robyja...',
        'material' =>
            'Karte CodyRoby, igralna plošča 5 × 5, figurici in koščki papirja za označevanje že obiskanih polj.',
        'questions' => [
            'content' => [
    ...
    'meeting-point' => [
        ...
        'text' =>
            'Tokrat svoje poteze načrtujemo, še preden začnemo. Ekipi razporedita karte po mizi, da ustvarita niz ukazov, s katerimi bosta premikali svojega robota, vendar ga začneta premikati šele, ko eden od igralcev reče „Start!“ V tem trenutku se programiranje konča in začne se akcija. Igralec, ki je rekel „Start!“, zmaga samo, če robota, ki izvajata ukaze svojih ekip, končata na istem polju.',
    ...
    'colour-everything' => [
        'title' => 'Pobarvaj vse',
        'text' =>
            'Lahko robote vodimo po plošči tako, da bodo s svojimi sledmi ustvarili risbo? Pri tej dejavnosti se igramo s programiranjem in umetnostjo slikovnih pik, pri čemer se ustvarjajo slike z obarvanjem polj na kvadratni mreži, kot so slikovne pike na zaslonu.',
        'material' =>
            'Karte CodyRoby, kvadratna mreža in figura. Za barvanje polj uporabite koščke papirja, ki jih boste položili na polja, ali pobarvajte polja z markerji',
        'questions' => [
            'content' => [
    ...
    'codyplotter-and-codyprinter' => [
        ...
        'text' =>
            'Kakšna je razlika med risalnikom in tiskalnikom? To boste izvedeli pri tej dejavnosti programiranja brez računalnika.',
        'material' =>
            'poleg kompleta CodyRoby sem uporabil zeleni marker in novega robota iz modelirne mase, ampak to ni nujno.',
        'questions' => [
            'content' => [
    ...
    'boring-pixels' => [
        ...
        'text' =>
            'Ko dajemo Robyju navodila za oblikovanje slike kvadrat za kvadratom, slikovno piko za slikovno piko, opazimo, da lahko, kadar je več kvadratov v vrsti iste barve, uporabimo številke, da je bolj zanimivo. Računalniki počnejo isto...',
        'material' =>
            'karirast zvezek ali kvadratna mreža 5 X 5, narisana na papirju, flomaster. Za prikaz kode risbe lahko uporabite pisalo in papir.',
        'questions' => [
            'content' => [
