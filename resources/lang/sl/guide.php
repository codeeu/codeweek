...
return [
    ...
    'what_you_need_organise' => [
        ...
        'items' => [
            '1' => '<strong>Skupino ljudi, ki se želijo učiti.</strong> Na primer prijatelje, otroke, najstnike, odrasle sodelavce, starše ali stare starše. Ne pozabite: dva sta že skupina!',
            '2' => '<strong>Učitelje ali izvajalce usposabljanj</strong>, ki poznajo programersko dejavnost in znajo učiti ter navdihovati druge. Število je odvisno od vrste in velikosti dogodka.',
            '3' => '<strong>Prostor za učenje.</strong> Učilnice, knjižnice, konferenčne dvorane in različni javni prostori so odlično prizorišče za dogodek.',
            '4' => '<strong>Računalnike in internetno povezavo.</strong> Glede na vašo ciljno skupino lahko udeležence prosite, da prinesejo s seboj svoje prenosne računalnike.',
            '5' => '<strong>Programiranje brez povezave.</strong> Da bi se naučili algoritmičnega razmišljanja, v resnici sploh ne potrebujete računalnikov in internetne povezave. Oglejte si naše <a href="/training/coding-without-computers">učne drobce</a> in začnite.',
            '6' => '<strong>Učno gradivo.</strong> Pokažite udeležencem, kako zabavno je, ko sami nekaj ustvarijo. Oglejte si <a
                        href="/resources">stran z viri</a> in <a href="/training">učne drobce</a> z avdiovizualnimi učnimi pripomočki in učnimi načrti ter jih prilagodite potrebam svoje skupine.',
