...
return [
    ...
    'what_you_need_organise' => [
        ...
        'items' => [
            '1' => '<strong>Grupp ta’ persuni li għandhom rieda li jitgħallmu.</strong> Pereżempju, sħabek, tfal, adolexxenti, kollegi adulti, ħbieb, ġenituri jew nanniet. Ftakar, żewġ persuni diġà huma grupp!',
            '2' => '<strong>Għalliema jew min ħarreġ</strong> li huma familjari mal-attività tal-ikkowdjar, u dwar kif għandhom jgħallmu u jispiraw lil oħrajn. In-numru jiddependi fuq it-tip u d-daqs tal-avveniment.',
            '3' => '<strong>Post fejn titgħallem.</strong> Klassijiet, libreriji, kmamar tal-konferenzi u diversi spazji pubbliċi kollha jistgħu jitqiesu bħala post mill-aqwa biex isir avveniment.',
            '4' => '<strong>Kompjuters u konnessjoni tal-internet.</strong> Skont il-grupp fil-mira tiegħek, tista’ titlob lill-parteċipanti jġibu magħhom il-laptops tagħhom stess.',
            '5' => '<strong>Ikkowdjar offline.</strong> Effettivament ma għandekx bżonn kompjuters u konnessjoni tal-internet biex titgħallem il-ħsieb komputazzjonali. Agħti ħarsa lejn is-<a href="/training/coding-without-computers">Sezzjoni tat-tagħlim offline</a> tagħna biex tibda.',
            '6' => '<strong>Materjal ta’ tagħlim.</strong> Uri lill-parteċipanti kemm jistgħu jieħdu gost meta joħolqu xi ħaġa waħedhom. Iċċekkja l-<a
                        href="/resources">paġna tar-riżorsi</a> u s-<a href="/training">sezzjoni tat-tagħlim</a> tagħna b’lezzjonijiet b’vidjows u pjanijiet ta’ lezzjonijiet, u aġġustahom skont il-ħtiġijiet tal-grupp tiegħek.',
