...
return [
    ...
    'title' => 'Politika dwar il-Cookies',
    'what' => [
        'title' => 'X’inhuma cookies?',
        'text' => '<p>Cookie huwa fajl b’test żgħir li sit web jaħżen fuq il-kompjuter jew l-apparat mobbli tiegħek meta żżur is-sit.</p>',
        'first_party' => '<strong>Cookies tal-ewwel parti</strong> huma cookies stabbiliti mis-sit web li tkun qed iżżur. Dak is-sit web biss jista’ jaqrahom. Barra minn hekk, sit web jista’ potenzjalment juża servizzi esterni, li jistabbilixxu wkoll il-cookies tagħhom stess, magħrufa bħala <strong>cookies ta’ partijiet terzi</strong>.',
        'persistent_cookies' => 'Cookies persistenti huma cookies issejvjati fuq il-kompjuter tiegħek u li ma jiġux imħassra awtomatikament meta tagħlaq il-brawżer tiegħek, b’differenza għal cookie tas-sessjoni, li titħassar meta tagħlaq il-brawżer tiegħek.',
        'items' => '<p>L-ewwel darba li żżur is-sit web ta’ Codeweek, int tkun mitlub <strong>taċċetta jew tirrifjuta l-cookies</strong>.</p>

            <p>L-iskop huwa li tippermetti lis-sit jiftakar il-preferenzi tiegħek (bħal isem l-utent, il-lingwa, eċċ.) għal ċertu perjodu ta’ żmien.</p>
    ...
    'how' => [
        ...
        'text1' => '<p> L-aktar li juża Codeweek huma “cookies tal-ewwel parti”. Dawn huma cookies stabbiliti u kkontrollati minna, mhux minn xi organizzazzjoni esterna.</p>',
        'text2' => '<p>Madankollu, biex tara xi wħud mill-paġni tagħna, inti jkollok taċċetta cookies minn organizzazzjonijiet esterni.</p>',
        '3types' => [
        ...
        'technical_cookies' => [
            ...
            'table' => [
                '1' => [
                    'purpose' => 'Żomm sessjoni sigura għalik, waqt iż-żjara tiegħek.',
                    'type_duration' => 'Cookie tas-sessjoni tal-ewwel parti, imħassar wara li tagħlaq il-brawżer tiegħek',
                ],
                '2' => [
                    'purpose' => 'Żomm sessjoni sigura għalik għal żmien itwal sabiex tevita li titlef is-sessjoni meta tagħlaq il-brawżer.',
                    'type_duration' => 'Cookie persistenti tal-ewwel parti, 60 xahar',
                ],
                '3' => [
        ...
        'analytics_cookies' => [
            ...
            'items' => '<p>Dawn nużawhom purament għal riċerka interna dwar kif nistgħu ntejbu s-servizz li nipprovdu lill-utenti kollha tagħna.</p>

            <p>Il-cookies sempliċement jevalwaw kif tinteraġixxi mas-sit web tagħna – bħala utent anonimu (id-data miġbura ma tidentifikax lilek personalment).</p>

            <p>Barra minn hekk, din id-data ma hijiex kondiviża ma’ partijiet terzi jew tintuża għal kwalunkwe skop ieħor. L-istatistika anonimizzata tista’ tinqasam ma’ kuntratturi li jaħdmu fuq proġetti ta’ komunikazzjoni skont ftehim kuntrattwali mal-Kummissjoni.</p>

            <p>Madankollu, inti liberu li tirrifjuta dawn it-tipi ta’ cookies – jew permezz tal-banner tal-cookies li tara fl-ewwel paġna li żżur jew billi żżur din il-<a href="https://www.cnect-stats.com/index.php?module=CoreAdminHome&action=optOut&language=en&backgroundColor=&fontColor=&fontSize=&fontFamily=">paġna ddedikata</a>.</p>',
            'table' => [
                '1' => [
                    'service' => 'Servizz tal-analitika fuq il-web, ibbażat fuq softwer ta’ sors miftuħ Matomo',
                    'purpose' => 'Jirrikonoxxi l-viżitaturi tas-sit web (b’mod anonimu – l-ebda informazzjoni personali ma tinġabar dwar l-utent).',
                    'type_duration' => 'Cookie persistenti tal-ewwel parti, 20 jum',
                ],
                '2' => [
                    'service' => 'Servizz tal-analitika fuq il-web, ibbażat fuq softwer ta’ sors miftuħ Matomo',
    ...
    'third-party' => [
        'title' => 'Cookies ta’ partijiet terzi',
        'items' => [
            '1' => '<p>Uħud mill-paġni tagħna juru kontenut minn fornituri esterni, eż. YouTube, Facebook u Twitter.</p>
    ...
    'how-manage' => [
        ...
        'items' => '<p>Tista’ <strong>timmaniġġja/tħassar</strong> il-cookies kif tixtieq - għal dettalji, ara <a
                        href="https://aboutcookies.org">aboutcookies.org</a>.<p><strong>It-tneħħija tal-cookies mit-tagħmir tiegħek</strong></p>
