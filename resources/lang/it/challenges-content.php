...
'train-it-like-fei-fei-li' => [
    ...
    'instructions' => [
        ...
        'I computer possono imparare a riconoscere le immagini, proprio come gli esseri umani.',
        'L\'apprendimento automatico aiuta i computer a "vedere" gli oggetti analizzando gli esempi.',
        'Vi presentiamo Fei-Fei Li:',
        'Fei-Fei Li è una scienziata di spicco nel campo dell\'intelligenza artificiale e della Computer Vision.',
        'Ha sviluppato ImageNet, un enorme set di dati che ha insegnato ai computer a riconoscere le immagini.',
        'Proprio come Fei-Fei Li ha aiutato i computer a “vedere”, anche i ragazzi e le ragazze possono insegnare a un computer a riconoscere gli oggetti!',
        ...
        'Una volta addestrato il modello, fai clic su "Test Model" per vedere quanto bene riconosce nuove Immagini.',
        'Metti alla prova l\'IA mostrando al computer nuovi oggetti che non facevano parte delle immagini di allenamento (ad esempio, mostrano un giocattolo che non è stato utilizzato per l\'allenamento).',
        'Guarda quanto funziona il modello se lo riconosce e lo categorizza correttamente.',
        ...
        'Una volta che sei soddisfatto della precisione del modello, fai clic su "Esporta modello" per salvare il tuo progetto.',
        'È possibile condividere il modello con altre classi o sul sito web di Teachable Machine cliccando su "Condividi".',
    ...
    'examples' => [
        'AI nel Retail & nello Shopping: Alcuni negozi utilizzano telecamere basate sull\'intelligenza artificiale per riconoscere i prodotti e tenere traccia dell\'inventario.',
...
'simulate-dice-in-python' => [
    ...
    'target_audience_title' => 'Destinatari',
    'target_audience' => [
        'Studenti della scuola primaria e secondaria, principianti in Python, chiunque stia imparando i numeri casuali, i giochi o la logica di programmazione di base.'
    ],
    'experience_title' => 'Esperienza',
    'experience' => [
        'Non è richiesta alcuna esperienza di programmazione precedente.',
        'È sufficiente una familiarità di base con la digitazione e l\'uso del computer.'
    ],
    'duration_title' => 'Durata',
    'duration' => '30–45 minuti per la versione base. Fino a 60 minuti se si esplorano opzioni avanzate (due dadi, risultato uscito più di frequente, ecc.).',
    'materials_title' => 'Strumento consigliato',
    'materials' => [
    ...
    'instructions_title' => 'Istruzioni',
    'instructions' => [
        'Fase 1: Preparare l\'ambiente Per iniziare, è necessario avere Python installato sul proprio computer.',
        ...
        'import random',
        '# Stampiamo un messaggio di benvenuto all\'utente',
        ...
        '# Generiamo un numero casuale tra 1 e 6',
        ...
        'Importazione del modulo “ random ”: il modulo random consente di generare numeri casuali.',
        'La funzione random.randint(a, b) restituisce un numero intero casuale compreso tra a e b (inclusi).',
        'Inserire il numero di lanci: il programma chiede all’utente quante volte vuole lanciare il dado.',
        'Convertiamo il valore inserito in un intero usando int().',
        'Simulazione dei lanci: il programma utilizza un ciclo for per simulare i lanci del dado tante volte quanto specificato dall’utente.',
        'Ad ogni iterazione, viene generato un numero casuale tra 1 e 6.',
        'Stampare i risultati: per ogni lancio, il risultato viene stampato.',
        'Alla fine del programma, viene mostrato un messaggio di ringraziamento.',
    ...
    'quiz_title' => 'Quiz:',
    'quiz' => [
        'Quale modulo in Python consente di generare numeri casuali? a) random b) Math c) Time',
        'Cosa fa la funzione random.randint(1, 6)? a) Genera un numero casuale tra 1 e 6 b) Stampa un numero casuale sullo schermo c) Stampa un numero tra 1 e 6',
        'Come si converte un input dell’utente in un numero intero in Python? a) float(s) b) int() c) p()',
        'Risposte corrette: 1.b, 2.b, 3.a'
    ],
    'mini_simulation_title' => 'Mini simulazione:',
    'mini_simulation' => [
...
'gender-gap-gender-graph' => [
    ...
    'instructions' => [
        ...
        'Clicca sulla bandiera verde e inserisci i dati (1-10) che ipoteticamente rappresentano il numero di donne in un settore tecnologico.',
        'Prova con dei numeri.',
        'Che cosa noti?',
        ...
        'E se il numero di donne in un settore fosse ben stimato ma non equilibrato in termini di divario di genere?',
...
'dance-with-ally' => [
    ...
    'target_audience' => [
        ...
        'Studenti/esse del biennio delle scuole secondarie di secondo grado (da 14 a 16 anni)'
    ],
    'experience_title' => 'Esperienza',
    ...
    'instructions' => [
        '1. Avvia Scratch',
        '2. crea un account in Scratch (se non ne hai già uno)',
        '3. inizia a creare un nuovo progetto, aggiungi uno Sprite, uno sfondo, determina la posizione iniziale dello Sprite all\'avvio del programma',
        '4. aggiungi il gruppo di script micro:bit dalle estensioni di Scratch',
        '5. collega il micro:bit al computer, attiva il Bluetooth sul computer (se non è attivato)',
        '6. installa ed eseguiri il link di Scratch https://scratch.mit.edu/download/scratch-link, scarica il file HEX micro:bit e salvalo (copialo) nel file micro:bit https://scratch.mit.edu/microbit',
        '7. L\'estensione micro:bit: trova un dispositivo vicino al computer facendo clic sul pulsante arancione nell\'estensione micro:bit',
        '8. Dispositivi cercati e trovati',
        '9. Crea un programma con blocchi che facciano danzare lo Sprite sulla musica selezionata (con il blocco audio iniziale), lo sprite si sposta quando scuotiamo il micro:bit.',
        'La danza consiste di due soli comandi: scorrere sull\'asse x a sinistra e a destra. Salvare il progetto nel computer.',
    ...
    'examples_title' => 'Esempi:',
    'examples' => [
        'Collegare un micro:bit con Scratch per controllare uno sprite danzante è un ottimo modo per esplorare la programmazione interattiva.',
        'Questo concetto può essere esteso a varie applicazioni reali e progetti creativi, quali:',
...
'coding-for-the-ocean' => [
    ...
    'description_title' => 'Descrizione della sfida',
    'description' => [
        'Crea e addestra un robot AI per proteggere il mare! Imparare a programmare, risolvere i problemi ambientali e sviluppare il pensiero logico per salvaguardare l\'ambiente marino.'
    ],
    'educational_goals_title' => 'Obiettivi educativi:',
    'educational_goals' => [
    ...
    'target_audience_title' => 'Destinatari',
    'target_audience' => 'Studenti della primaria e secondaria di primo grado (da 6 a 12 anni)',
    'experience_title' => 'Esperienza',
    ...
    'variations' => [
        'Espandere la sfida ad altri ambienti: si potrebbe modificare la sfida per coinvolgere i robot di intelligenza artificiale che proteggono altri ecosistemi come foreste, fiumi o anche aree urbane.',
        'I robot potrebbero affrontare sfide come la deforestazione o l\'inquinamento atmosferico.'
    ],
],
