...
<h2 class="subtitle">1.	Pillole di apprendimento</h2>
    ...
    'lessons' => [
        '1' => [
            ...
            'author' => 'di Alessandro Bogliolo',
            'text' => '<p>La programmazione è il linguaggio delle cose, che ci consente di scrivere programmi per concedere nuove funzionalità alle decine di miliardi di oggetti programmabili che ci circondano. La programmazione è il modo più veloce per realizzare le nostre idee nonché il modo più efficace per sviluppare capacità di pensiero computazionale. Tuttavia, la tecnologia non è strettamente necessaria per sviluppare il pensiero computazionale, ma è piuttosto quest\'ultimo a essere una capacità essenziale per far funzionare la tecnologia.</p>

                    <p>In questo video, Alessandro Bogliolo, professore di Sistemi informatici in Italia e coordinatore della Settimana europea della programmazione, presenterà attività di programmazione unplugged che possono essere svolte senza alcun dispositivo elettronico. Lo scopo principale delle attività unplugged è abbassare le barriere di accesso per portare la programmazione in ogni scuola, indipendentemente dai finanziamenti e dalle apparecchiature.</p>

                    <p>Le attività di programmazione unplugged svelano gli aspetti computazionali del mondo fisico che ci circonda.</p>',
            'activities' => [
        ...
        '2' => [
            ...
            'author' => 'di Miles Berry',
            'text' => '<p>Il pensiero computazionale descrive un modo di considerare i problemi e i sistemi in maniera che si possa utilizzare un computer per favorirne la risoluzione o la comprensione. Il pensiero computazionale non è solo essenziale per lo sviluppo di programmi per computer, ma può anche essere usato per supportare la risoluzione di problemi in tutte le discipline.</p>

                    <p>Puoi insegnare il pensiero computazionale ai tuoi studenti facendo scomporre loro problemi complessi in problemi più piccoli (decomposizione), riconoscere i modelli (riconoscimento dei modelli), identificare i dettagli rilevanti per risolvere un problema (astrazione), oppure stabilire le regole o le istruzioni da seguire per ottenere un risultato desiderato (progettazione dell’algoritmo). Il pensiero computazionale può essere insegnato attraverso diverse discipline, per esempio in matematica (capire le regole per fattorizzare polinomi di secondo grado), letteratura (scomporre l’analisi di una poesia in analisi di metro, rima e struttura), lingue (trovare modelli nelle lettere finali di un verbo che ne influenzano l\'ortografia quando il tempo verbale cambia) e molte altre.</p>

                    <p>In questo video, Miles Berry, primo lettore presso la School of Education dell’Università di Roehampton a Guildford (Regno Unito), presenterà il concetto di pensiero computazionale e i diversi modi in cui un insegnante può integrarlo in classe con giochi semplici.</p>',
            'activities' => [
        ...
        '3' => [
            ...
            'author' => 'di Margo Tinawi',
            'text' => '<p>La programmazione visuale permette agli uomini di descrivere i processi utilizzando illustrazioni o la grafica. Generalmente si parla di programmazione visuale in contrapposizione alla programmazione testuale. I linguaggi di programmazione visuale (VPL) sono particolarmente adatti per far conoscere il pensiero algoritmico ai bambini (e persino agli adulti). Con i VPL, c’è meno da leggere e nessuna sintassi da mettere in pratica.</p>

                    <p>In questo video, Margo Tinawi, insegnante di sviluppo web presso Le Wagon e co-fondatrice di Techies Lab asbl (Belgio), ti aiuterà a scoprire Scratch, uno dei VPL più popolari utilizzati in tutto il mondo. Scratch è stato sviluppato dal MIT nel 2002 e da allora intorno a questo linguaggio si è creata una grande comunità, dove puoi trovare milioni di progetti da replicare con i tuoi studenti e innumerevoli tutorial in più lingue.</p>

                    <p>Non è necessario avere esperienza di programmazione per usare Scratch e puoi usarlo in tutte le materie! Per esempio, utilizzando Scratch come strumento di storytelling digitale, gli studenti possono creare storie, illustrare un problema di matematica o partecipare a un concorso artistico per conoscere il patrimonio culturale, imparando al contempo la programmazione e il pensiero computazionale e, cosa più importante, divertendosi.</p>

                    <p>Scratch è uno strumento gratuito, molto intuitivo e motivante per i tuoi studenti. Dai un’occhiata al video di Margo per imparare come iniziare.</p>',
            'activities' => [
        ...
        '4' => [
            ...
            'author' => 'di Jesús Moreno León',
            'text' => '<p>Pensiero critico, perseveranza, risoluzione dei problemi, pensiero computazionale e creatività sono solo alcune delle competenze fondamentali di cui i tuoi studenti hanno bisogno per avere successo nel 21° secolo e la programmazione può aiutarti a ottenerle in modo divertente e motivante.</p>

                    <p>Le nozioni algoritmiche di controllo del flusso che utilizzano sequenze e cicli di istruzioni, la rappresentazione di dati mediante variabili e liste o la sincronizzazione di processi potrebbero sembrare concetti complicati, ma in questo video scoprirai che sono più facili da imparare di quanto pensi.</p>

                    <p>In questo video, Jesús Moreno León, insegnante e ricercatore di informatica spagnolo, spiegherà in che modo puoi sviluppare queste e altre competenze nei tuoi studenti mentre si divertono. Come si può fare? Creando un gioco di domande e risposte su Scratch, il linguaggio di programmazione più popolare utilizzato nelle scuole di tutto il mondo. Scratch non solo migliora il pensiero computazionale, ma consente anche di introdurre elementi di ludicizzazione in classe per mantenere gli studenti motivati mentre imparano e si divertono.</p>

                    <p>Dai un’occhiata al video per imparare come iniziare:</p>',
            'activities' => [
        ...
        '5' => [
            ...
            'author' => 'di Tullia Urschitz',
            'text' => '<p>Integrare programmazione, tinkering, robotica e microelettronica quali strumenti di insegnamento e apprendimento nel programma scolastico è fondamentale per l’istruzione del 21° secolo.</p>

                    <p>Usare il tinkering e la robotica nelle scuole presenta molti vantaggi per gli studenti, poiché li aiuta a sviluppare competenze fondamentali quali risoluzione dei problemi, lavoro di squadra e collaborazione. Aumenta anche la creatività e la fiducia degli studenti in se stessi e può aiutarli a sviluppare perseveranza e determinazione di fronte alle sfide. Inoltre, la robotica è un campo che promuove l’inclusività, in quanto è facilmente accessibile a una vasta gamma di studenti (sia maschi che femmine) con diversi talenti e abilità e ha influenze positive sugli studenti con disturbi dello spettro autistico.</p>

                    <p>Dai un’occhiata a questo video in cui Tullia Urschitz, ambasciatrice italiana Scientix e insegnante di materie STEM a Sant’Ambrogio di Valpolicella (Verona), fornirà alcuni esempi pratici sul modo in cui gli insegnanti possono integrare tinkering e robotica in classe, trasformando così gli studenti passivi in creatori entusiasti.</p>',
            'activities' => [
...
Con Python gli studenti possono creare quiz su eventi storici, risolvere problemi di matematica e realizzare simulazioni di fisica, creare giochi, costruire siti web, condurre analisi di dati per progetti scientifici e tanto altro ancora. Python dispone di una ricca ed estesa libreria standard, una vasta community e un gran numero di tutorial e progetti disponibili online utilizzabili per insegnare, apprendere ed esercitarsi. Programmando in Python, analizzando i programmi e aggiustando i bug, gli studenti sviluppano la creatività e imparano a diventare costanti, persistenti e pazienti. Acquisiscono abilità di pensiero analitico e di risoluzione dei problemi scomponendo dei problemi complessi in parti più piccole. Queste capacità li aiuteranno ad affrontare i problemi in ogni aspetto della loro vita.
    ...
    'choose_lessons' => 'Scegli uno dei piani di lezione qui sotto e organizza un’attività con i tuoi studenti.',
    'footer' => [
