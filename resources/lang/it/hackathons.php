...
return [
    ...
    'sections' => [
        ...
        2 => [
            'title' => 'Come faccio a partecipare?',
            'content' => [
                1 => 'Seleziona l’hackathon del tuo paese e iscriviti, con pochi semplici passaggi. Puoi partecipare come persona singola o come una squadra di sei persone. Se partecipi con amici o compagni di classe, non dimenticare di inserire il nome della squadra al momento dell’iscrizione. I tempi di iscrizione saranno diversi per ogni hackathon, quindi continua a seguire le info sull’evento del tuo paese!'
            ]
        ],
        3 => [
            'title' => 'Chi sono gli organizzatori?',
            'content' => [
                1 => 'Gli hackathon della settimana europea della programmazione sono co-organizzati dalla Commissione europea e dagli ',
                2 => 'ambasciatori locali della settimana europea della programmazione',
                3 => '  e sono finanziati dal Parlamento europeo. L\'obiettivo è mostrare come si realizzano soluzioni concrete con l’aiuto della creatività, dell’entusiasmo, delle nuove idee e delle abilità di programmazione dei giovani.'
            ]
        ],
        4 => [
    ...
    'cities' => [
        ...
        4 => [
            'city' => "TBA",
            'country' => "Grecia",
            'date' => "8-9 maggio 2021"
        ],
        5 => [
            'city' => "TBA",
            'country' => "Slovenia",
            'date' => "15-16 maggio 2021"
        ],
        6 => [
            'city' => "TBA",
            'country' => "Lettonia",
