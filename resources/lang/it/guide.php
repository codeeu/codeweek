...
return [
    ...
    'what_you_need_organise' => [
        ...
        'items' => [
            '1' => '<strong>Un gruppo di persone disposte a imparare.</strong> Per esempio, i tuoi amici, bambini, adolescenti, colleghi adulti, genitori o nonni. Ricorda, due persone formano già un gruppo!',
            '2' => '<strong>Insegnanti o formatori</strong> che conoscono la programmazione e sanno come insegnare e ispirare gli altri. Il numero dipende dal tipo e dalla dimensione dell’evento.',
            '3' => '<strong>Un posto dove imparare.</strong> Aule, biblioteche, sale conferenze e vari spazi pubblici sono tutti luoghi ideali per organizzare eventi.',
            '4' => '<strong>Computer e connessione a Internet.</strong> A seconda del gruppo di riferimento, puoi chiedere ai partecipanti di portare il proprio computer portatile.',
            '5' => '<strong>Programmazione unplugged.</strong> In realtà non hai bisogno di computer e connessione a Internet per imparare il pensiero computazionale. Dai un’occhiata alla nostra <a href="/training/coding-without-computers">Pillola di apprendimento unplugged</a> per iniziare.',
            '6' => '<strong>Materiali didattici.</strong> Mostra ai partecipanti quanto può essere divertente creare qualcosa per conto proprio. Consulta la nostra <a
                        href="/resources">pagina risorse</a> e le <a href="/training">pillole di apprendimento</a> con video tutorial e piani di studio, quindi adattali alle esigenze del tuo gruppo.',
    ...
    'material' => [
        ...
        'items' => [
            '1' => '<a href="https://ec.europa.eu/digital-single-market/en/news/gearing-celebrate-eu-code-week-2019">Preparazione per le celebrazioni della settimana europea della programmazione 2019</a> (disponibile in 29 lingue)'
        ]
    ],
    'toolkits' => [
