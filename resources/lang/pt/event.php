...
return [
    ...
    */
    ...
    'theme' => [
        ...
        'Mobile app development' => 'Desenvolvimento de aplicações para dispositivos móveis',
        'Software development' => 'Desenvolvimento de software',
        'Data manipulation and visualisation' => 'Manipulação e visualização de dados',
        'Robotics' => 'Robótica',
        'Hardware' => 'Hardware',
        'Other' => 'Outro',
        'Unplugged activities' => 'Atividades sem recurso a computador',
        'Playful coding activities' => 'Atividades de programação lúdicas',
        'Art and creativity' => 'Arte e criatividade',
        'Visual/Block programming' => 'Programação Visual/Blocos',
        'Game design' => 'Conceção de jogos',
        'Internet of things and wearable computing' => 'Internet das coisas e computadores vestíveis (wearable)',
