...
return [
    ...
    'subtitle' => 'Dá vida às tuas ideias!',
    'sections' => [
        1 => [
        ...
        3 => [
            'title' => 'Quem são os organizadores?',
            'content' => [
                1 => 'As maratonas de programação da Semana Europeia da Programação são coorganizadas pela Comissão Europeia com os ',
                2 => 'Embaixadores da Semana Europeia da Programação',
                3 => ' a nível local e são financiadas pelo Parlamento Europeu. O objetivo é demonstrar de que modo a criatividade, o entusiasmo, as ideias frescas e as competências de programação dos jovens podem contribuir para dar vida a soluções concretas.'
            ]
        ],
        4 => [
        ...
        5 => [
            'title' => 'Não sei programar – o que posso fazer?',
            'content' => [
                1 => 'Paralelamente à maratona de programação, haverá ateliês de programação, hardware, robótica e outros temas para iniciantes, permitindo aos participantes adquirir algumas noções básicas de pensamento computacional e programação. Na tua página local, podes obter mais informações sobre as inscrições.'
            ]
        ],
    ...
    'cities' => [
        1 => [
            'city' => 'TBA',
            'country' => 'Roménia',
            'date' => '25-26 setembro 2021'
        ],
        2 => [
            'city' => 'TBA',
            'country' => 'Irlanda',
            'date' => '23-24 setembro 2021'
        ],
        3 => [
            'city' => 'TBA',
            'country' => 'Itália',
            'date' => '24-25 setembro 2021'
        ],
        4 => [
            'city' => 'TBA',
            'country' => 'Grécia',
