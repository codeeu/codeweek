...
return [
    ...
    'ada-charles-roby' => [
        ...
        'text' =>
            'Priča Ade Lovelace i Charlesa Babbagea uistinu je zanimljiva. Osmislili su i programirali računala stotinu godina prije nego što su zapravo izumljena',
    ...
    'cody-and-roby' => [
        ...
        'material' =>
            'šahovnica s oznakama, karte s uputama (lijevo, desno, naprijed) i bilo koje blokade koje se stavljaju na ploču',
    ...
    'material2' => [
        ...
        'cards' =>
            '24 karte "idi naprijed", 8 karata "skreni ulijevo" i 8 karata "skreni udesno"',
        ...
        'pieces-of-paper' =>
            'Potrebna su i 24 papirića za pokrivanje već posjećenih polja',
        'card-alternative' =>
            'Umjesto snopa karata CodyRoby možete se i poslužiti sličicama karata koje su dostupne ovdje',
        'small-drawings' =>
            'Možete dodati i male crteže koji će vam pomoći ispričati priču. Crteže koji su korišteni u videozapisu možete pronaći ovdje',
        'rest-of-cards' =>
            'Za ostalo koristit ćemo karte CodyRoby, CodyFeet ili CodyColour.'
    ],
    ...
    'two-snakes' => [
        ...
        'material' =>
            'Karte CodyRoby, šahovska ploča 5 × 5, dvije figurice i komadići papira za označivanje već posjećenih polja.',
        'questions' => [
            'content' => [
    ...
    'follow-the-music' => [
        ...
        'material' =>
            'Osim karata CodyRoby, šahovske ploče i figurica, trebamo proizvesti i tri različita zvuka. Upotrijebio sam tri čaše napunjene različitim količinama vode. Što ćete vi upotrijebiti ? ',
        'questions' => [
            'content' => [
    ...
    'colour-everything' => [
        ...
        'material' =>
            'Karte CodyRoby, šahovska ploča i figurica. Polja obojite polaganjem papirića ili markerima.',
        'questions' => [
            'content' => [
    ...
    'codyplotter-and-codyprinter' => [
        ...
        'material' =>
            'osim pribora CodyRoby, koristio sam zeleni marker i novog robota od gline, ali to nije nužno.',
        'questions' => [
            'content' => [
    ...
    'boring-pixels' => [
        ...
        'material' =>
            'bilježnica na kvadratiće ili šahovska ploča 5 × 5 nacrtana na listu papira, flomaster. Kȏd crteža možete prikazati koristeći se olovkom i papirom.',
        'questions' => [
            'content' => [
