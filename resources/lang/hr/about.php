...
return [
    'when-title' => 'U 2024. Europski tjedan programiranja održavat će se između 14. i 27. listopada.',
    ...
    'why_coding-text' => '<p>Zbog Pije, koja je mislila da ima obavezu studirati pravo, iako je oduvijek uživala u matematici i igranju s računalima. Zbog Marka, koji ima ideju za bolju društvenu mrežu, ali je ne može sam izraditi. Zbog Alice, koja sanja o izradi robota jer joj roditelji ne dopuštaju da ima mačku.</p>
                    ...
                    <p>Zapravo, zbog svih nas. Zbog naše budućnosti. Tehnologija oblikuje naše živote, ali dopuštamo manjini da odlučuje kako se njome koristimo i za što. Možemo bolje od toga da samo dijelimo stvari ili označavamo da nam se nešto sviđa. Možemo realizirati svoje lude ideje, izraditi stvari koje će i druge razveseliti.</p>

                    <p>Nikad nije bilo jednostavnije izraditi vlastitu aplikaciju, sastaviti vlastitog robota ili, zašto ne, izumiti leteće automobile! To putovanje nije lako, ali je ono prepuno kreativnih izazova, zajednice koja pruža podršku i gomile zabave. Jeste li spremni prihvatiti izazov i postati stvaratelj?</p>

                    <p>Programiranje također pomaže u razvoju kompetencija kao što su računalno razmišljanje, rješavanje problema, kreativnost i timski rad, a sve su to zaista dobre vještine za bilo koje zanimanje.</p>',
    'why_coding-quote' => '<p>Alessandro Bogliolo, koordinator tima volontera ambasadora na Europskom tjednu programiranja kazao je:<blockquote>
                            <p>„Od pamtivijeka smo brojne stvari stvarali s pomoću kamena, željeza, papira i olovke. Sve to preoblikovalo je naše živote. Sada živimo u drukčijem vremenu u kojemu se naš svijet oblikuje programiranjem. Različita vremena traže drukčije poslove i vještine. Tijekom Europskog tjedna programiranja svakom Europljaninu želimo pružiti priliku da otkrije programiranje i zabavi se s njime. Hajde da naučimo programirati kako bismo oblikovali svoju budućnost.”</p>
                        </blockquote>
                    </p>',
