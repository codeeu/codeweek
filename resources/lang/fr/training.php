    ...
    'lessons' => [
        '1' => [
            ...
            'text' => '<p>Le code, c’est le langage des objets qui nous permet d’écrire des programmes pour donner de nouvelles fonctionnalités aux dizaines de milliards d’objets programmables qui nous entourent. Le code, c’est la façon la plus rapide de donner vie à ses idées et le moyen le plus efficace de perfectionner ses compétences en raisonnement informatique. Cela dit, la technologie n’est pas vraiment nécessaire pour développer un raisonnement informatique. C’est même plutôt l’inverse: ce sont les compétences en raisonnement informatique qui sont essentielles pour faire fonctionner la technologie.</p>
                    ...
                    <p>Les activités de codage hors ligne lèvent le voile sur les aspects informatiques du monde physique qui nous entoure.</p>',
            'activities' => [
                '1' => 'Activité 1 – CodyRoby pour le primaire',
                '2' => 'Activité 2 – CodyRoby pour le premier cycle du secondaire',
                '3' => 'Activité 3 – CodyRoby pour le secondaire',
            ],
        ],
        '2' => [
            'title' => 'Raisonnement informatique et résolution des problèmes',
            'author' => 'Par Miles Berry',
            'text' => '<p>Le raisonnement informatique (CT – computational thinking) correspond à une façon de résoudre et de comprendre les problèmes et les systèmes avec l’aide de la technologie informatique. Le raisonnement informatique est non seulement essentiel au développement de programmes informatiques, mais il peut également être utilisé pour contribuer à la résolution de problèmes dans toutes les disciplines.</p>
                    ...
                    <p>Dans cette vidéo, Miles Berry, maître de conférences à l’École normale de l’Université de Roehampton à Guildford (Royaume-Uni), présente le concept du raisonnement informatique et les différentes façons dont un enseignant peut l’intégrer en classe à l’aide de jeux simples.</p>',
            'activities' => [
                '1' => 'Activité 1 – Développer le raisonnement mathématique pour le primaire',
                '2' => 'Activité 2 – Se familiariser avec les algorithmes pour le premier cycle du secondaire',
                '3' => 'Activité 3 – Les algorithmes pour le secondaire supérieur',
            ],
        ],
        '3' => [
            'title' => 'Programmation visuelle – présentation de Scratch',
            'author' => 'Par Margo Tinawi',
            'text' => '<p>La programmation visuelle permet de décrire les processus à l’aide d’illustrations ou de graphiques. On parle habituellement de programmation visuelle par opposition à la  programmation textuelle. Les langages de programmation visuels (VPL) sont particulièrement bien adaptés pour initier les enfants (et même les adultes) à la pensée algorithmique. Avec les VPL, il y a moins à lire et rien à écrire.</p>
                    ...
                    <p>Scratch est un outil gratuit, très intuitif et motivant pour vos élèves. Jetez un coup d’œil à la vidéo de Margo pour savoir comment démarrer.</p>',
            'activities' => [
                '1' => 'Activité 1 – Scratch Basic pour le primaire',
                '2' => 'Activité 2 – Scratch Basic pour le premier cycle du secondaire',
                '3' => 'Activité 3 – Scratch Basic pour le secondaire',
            ],
        ],
        '4' => [
            ...
            'text' => '<p>La pensée critique, la persévérance, la résolution de problèmes, le raisonnement informatique et la créativité ne sont que quelques-unes des compétences clés dont vos élèves ont besoin pour réussir au XXIesiècle, et le codage peut les aider à les acquérir de manière ludique et motivante.</p>
                    ...
                    <p>Jetez un coup d’œil à la vidéo pour savoir comment démarrer:</p>',
            'activities' => [
                '1' => 'Activité 1 - Jeu de questions-réponses avec Scratch pour le primaire',
                '2' => 'Activité 2 - Jeu de questions-réponses avec Scratch pour le premier cycle du secondaire',
                '3' => 'Activité 3 - Jeu de questions-réponses avec Scratch pour le secondaire',
            ],
        ],
        '5' => [
            ...
            'text' => '<p>L’intégration dans les programmes scolaires du codage, du bricolage, de la robotique et de la microélectronique comme outils d’enseignement et d’apprentissage est essentielle à l’enseignement du XXIesiècle.</p>
                    ...
                    <p>La vidéo de Tullia Urschitz, ambassadrice italienne de Scientix et enseignante STEM à Sant’Ambrogio Di Valpolicella, en Italie, donne des exemples pratiques sur la façon d’intégrer le bricolage et la robotique en classe, transformant ainsi des élèves passifs en créateurs enthousiastes.</p>',
            'activities' => [
                '1' => 'Activité 1 - Comment fabriquer une main mécanique en panneaux durs pour le primaire',
...
Dans cette vidéo, l’équipe de la Semaine du code vous présentera quelques activités de codage pratiques, faciles et ludiques, particulièrement adaptées aux élèves malvoyants, atteints de trisomie 21 ou de troubles du spectre autistique, que les enseignants peuvent facilement mettre en place dans leur classe.                   
    ...
    'choose_lessons' => 'Choisissez un des plans de cours ci-dessous et organisez une activité avec vos élèves.',
    'footer' => [
