...
return [
    ...
    'texts' => [
        ...
        'Au bout du compte, la programmation est une compétence recherchée dans presque tous les secteurs (non seulement dans le domaine des technologies, mais aussi dans la finance, les soins de santé, la recherche scientifique, et même la création de dessins et de modèles ou encore l’agriculture), et la demande ne fait qu’augmenter. Les enfants qui savent coder et qui comprennent le fonctionnement des technologies auront toujours un certain avantage, quelle que soit l’orientation professionnelle qu’ils choisissent à terme.',
        'Envie de passer à l’action?',
        'Participez à la Semaine européenne du code!',
        'Vous souhaitez en savoir plus?',
        'Rendez-vous sur notre blog pour plus d’informations.',
    ],
];
