...
return [
    ...
    */
    ...
    'placeholder' => 'Αναζήτηση για όνομα εκδήλωσης ή ετικέτα',
    'submit' => 'ΑΝΑΖΗΤΗΣΗ',
    'label_country' => 'ΕΠΙΛΟΓΗ ΧΩΡΑΣ',
    'last_year_events' => [
        'label' => 'ΣΥΜΠΕΡΙΛΗΨΗ ΕΚΔΗΛΩΣΕΩΝ ΠΕΡΑΣΜΕΝΩΝ ΕΤΩΝ',
        'yes' => 'ΝΑΙ',
        'no' => 'ΟΧΙ',
    ],
    'search_counter' => 'αντιστοιχούν στα κριτήρια της αναζήτησής σου',
    'event' => 'εκδήλωση',
    'events' => 'εκδηλώσεις',
    'year' => 'έτος',
    'audiences' => 'Κοινό', 'themes' => 'Θέματα', 'countries' => 'Χώρες', 'search_placeholder' => 'Εύρεση με βάση τον τίτλο ή την περιγραφή',
    'search_banner_title' => 'Βρες τι σε εμπνέει',
