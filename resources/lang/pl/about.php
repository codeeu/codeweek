...
return [
    'when-title' =>
        'W 2024 roku Europejski Tydzień Kodowania odbędzie się w dniach od 14 do 27 października.',
    'when-text' =>
    ...
    'supported_by_commission-text' =>
        '<p>Inicjatywa Europejskiego Tygodnia Kodowania została zapoczątkowana w 2013 roku przez Młodych Doradców na rzecz Europejskiej Agendy Cyfrowej. Komisja Europejska wspiera Europejski Tydzień Kodowania w ramach strategii tworzenia <a href="http://ec.europa.eu/priorities/digital-single-market/">jednolitego rynku cyfrowego</a>. Opracowany przez Komisję <a href="https://education.ec.europa.eu/focus-topics/digital-education/action-plan">plan działania w dziedzinie edukacji cyfrowej</a> zachęca do uczestnictwa w inicjatywie przede wszystkim szkoły.</p>',
    ...
    'why_coding-text' => '<p>Dla ludzi takich jak Pia, która czuła się zmuszona do pójścia na studia prawnicze, mimo że zawsze lubiła matematykę i zabawę z komputerami. Dla ludzi takich jak Mark, który ma pomysł na lepsze media społecznościowe, ale nie umie go samodzielnie zrealizować. Dla ludzi takich jak Alice, która marzy o budowaniu robotów, ponieważ jej rodzice nie pozwalają jej przygarnąć kotka.</p>
                    ...
                    <p>To wydarzenie dla wszystkich tych osób, które już teraz robią wszystko, aby zrealizować swoje marzenia.</p>

                    <p>Tak naprawdę to wydarzenie dla nas wszystkich. Dla naszej przyszłości. Technologia kształtuje nasze życia, ale pozwalamy, aby mniejszość decydowała o tym, w jaki sposób ją wykorzystujemy. Możemy zrobić coś więcej niż tylko udostępniać treści i klikać „lubię to!”. Możemy realizować nasze szalone pomysły i tworzyć rzeczy, które sprawią radość innym osobom.</p>

                    <p>Jeszcze nigdy w historii opracowanie własnej aplikacji, zbudowanie robota czy wynalezienie latających samochodów nie było takie proste. Droga do osiągnięcia takiego celu nie jest prosta, jednak jest to droga wypełniona kreatywnymi wyzwaniami, na której spotkasz pomocnych członków społeczności i będziesz się doskonale bawić na każdym kroku. Przygotuj się na wyzwanie i zostań twórcą.</p>

                    <p>Programowanie pozwala także rozwijać kompetencje takie jak myślenie obliczeniowe, rozwiązywanie problemów, kreatywność oraz pracę zespołową, które zdecydowanie przydadzą się każdemu, niezależnie od obranej ścieżki kariery.</p>',
    'why_coding-quote' => '<p>Alessandro Bogliolo, koordynator zespołu ambasadorów – wolontariuszy działających na rzecz Europejskiego Tygodnia Kodowania, powiedział:<blockquote>
                            <p>„Od zarania dziejów robiliśmy wiele rzeczy przy pomocy kamieni, żelaza, papieru czy ołówka – wszystkie te rzeczy odmieniły nasze życia. Obecnie żyjemy w innej epoce, w której to kod kształtuje świat. Różne epoki mają różne zawody i wymagania dotyczące umiejętności. W ramach Europejskiego Tygodnia Kodowania chcemy dać każdemu Europejczykowi i każdej Europejce możliwość odkrycia programowania i dobrej zabawy, z którą się wiąże ta umiejętność. Nauczmy się programowania, aby kształtować naszą przyszłość”.</p>
                        </blockquote>
                    </p>',
