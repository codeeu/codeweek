...
return [
    'chatbot' => [
        ...
        'instructions' => [
            ...
            'lub utwórz na niej konto. (Jeśli musisz utworzyć nowe konto, pamiętaj, że ze względu na ochronę prywatności na platformie Pencil Code nie można używać prawdziwych imion i nazwisk).',
            'Kliknij opcję „Imagine” (Kreatywność), a następnie „Make your own” (Własny pomysł)',
    ...
    'paper-circuit' => [
        'title' => 'Kodowanie bez komputera: kartka z obwodem elektrycznym',
        'author' => 'Zespół Europejskiego Tygodnia Kodowania',
        'purposes' => ['Pobudzanie kreatywności', 'Ćwiczenie umiejętności rozwiązywania problemów'],
        'description' => [
        ...
        'instructions' => [
            ...
            'Przedziuraw kartkę ołówkiem i umieść naklejaną diodę LED w każdej podświetlanej części.  ',
            'Narysuj okrąg, w którym umieścisz baterię guzikową.',
    ...
    'dance' => [
        'title' => 'Przygotowanie układu tanecznego',
        'author' => 'Zespół Europejskiego Tygodnia Kodowania',
        'purposes' => [
        ...
        'instructions' => [
            ...
            'Kliknij opcję',
            '(Utwórz projekt – pusty projekt z kodowania blokowego) i nadaj projektowi tytuł',
            'Przejdź do zakładki',
            '(Scena) i kliknij ikonę zębatki, by dodać tło. Możesz wybrać tło z obszaru Media Library (Biblioteka multimediów), przesłać swój obraz lub zrobić i wczytać własne zdjęcie. Wybierz klip audio i dodaj go do sceny:',
            'Kliknij przycisk',
            '(Dodaj artystę) i dodaj postaci lub obiekty, które chcesz animować, by mogły się poruszać, rozmawiać i wchodzić ze sobą w interakcje. Wybierz dwie lub trzy dowolne postaci. Możesz zmodyfikować dostępnych bohaterów lub narysować własnych. Strój postaci zmienisz, klikając ikonę ołówka.',
    ...
    'compose-song' => [
        ...
        'instructions' => [
            ...
            'Nazwij swój skrypt i wybierz',
            'jako język programowania',
            'Zacznij pisać kod miedzy wierszami',
            'i',
            '',
            'Przejrzyj klipy muzyczne w obszarze',
            '„Sound Library”',
            '(Biblioteka dźwięków) i wybierz ulubione gatunki muzyczne, artystów i instrumenty',
            'By dodać do swojej piosenki klip dźwiękowy, wpisz polecenie',
            'Między nawiasami powinny znaleźć się cztery następujące parametry oddzielone od siebie przecinkami',
            'Klip dźwiękowy',
            'Umieść kursor między nawiasami, przejdź do obszaru „Sound Library” (Biblioteka dźwięków), wybierz klip i wklej go, klikając niebieską ikonę wklejania',
            'Numer ścieżki',
            'oznaczenie ścieżek pomaga uporządkować dźwięki według rodzaju instrumentu (głos, gitara basowa, perkusja, keyboard itd.). Możesz dodać dowolną liczbę ścieżek (instrumentów). Ścieżki są wyświetlane jako wiersze w cyfrowej stacji roboczej',
            'Początek metrum',
            'wskazuje, kiedy ma rozpocząć się odtwarzanie danego dźwięku. Metra to muzyczne jednostki czasu. Jedno metrum składa się z czterech pulsów',
            'Koniec metrum',
            'wskazuje, kiedy ma zakończyć się odtwarzanie danego dźwięku.',
            'Taki wiersz kodu będzie wyglądał następująco',
            'Możesz dodać do kompozycji różne efekty, na przykład określone natężenie dźwięku, by poprawić jej brzmienie. Natężenie dźwięku może wynosić od -60 decybeli do 12 decybeli, gdzie 0 odpowiada oryginalnej głośności utworu.',
            'Wprowadź polecenie',
    ...
    'sensing-game' => [
        ...
        'instructions' => [
            ...
            'i wybierz opcję',
            'Czujniki wideo',
            'Pozwoli to określać, jak szybko porusza się obiekt. Im mniejsza liczba, tym wrażliwszy na ruch jest czujnik.',
            'Dodaj duszka. Wybierz dźwięk dla swojego duszka. Jeśli chcesz, możesz też wybrać opcję',
            'Utwórz klona',
            '(create a clone), by powielić duszka.',
            'Utwórz dwie zmienne: jedną dla parametru',
            'Score',
            '(Wynik), a drugą dla parametru',
            'Stoper',
            'i dodaj je do duszka. Ustaw wartość parametru Stoper jako 30 i dodaj opcję',
            'Zmień Stoper o -1',
    ...
    'create-a-dance' => [
        ...
        'example' =>
            'Wybrane prace uczniów można znaleźć na stronie',
    ...
    'family-care' => [
        ...
        'experience' => 'Dla wszystkich',
        'duration' => '5–10 godzin',
        'author' => '',
        'purposes' => [
            'Analiza problemu „opieki nad bliskimi”, z którym mierzymy się codziennie;',
        ...
        'instructions' => [
            ...
            'Spisz wszystkie problemy',
            'Wymyśl możliwe rozwiązania',
            'Wybierz rozwiązanie',
        ...
        'materials' => [
            ...
            'mBlock jest językiem programowania opartym na języku Scratch',
            'To wyzwanie jest również zadaniem z konkursu MakeX Global Spark Competition – zawodów w kreatywnym projektowaniu adresowanych do dzieci w wieku od 6 do 13 lat.',
    ...
    'haunted-house' => [
        ...
        'instructions' => [
            ...
            'Korzystając z tych poziomów, napiszemy interaktywną historię Nawiedzonego domu . ',
    ...
    'inclusive-app-design' => [
        ...
        'instructions' => [
            ...
            'Poznać zasady tworzenia inkluzywnych aplikacji',
