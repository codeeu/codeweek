...
return [
    ...
    'questions' => 'Pytania',
    'material' => [
        'required' => 'Wymagany materiał',
        'chequered' => 'szachownica',
        'footprint' => 'karty z obrazkami śladów stóp'
    ],
    'intro' => [
        'title' => 'Wprowadzenie do Coding@Home'
    ],
    'explorer' => [
        'title' => 'Odkrywca',
        'text' =>
        ...
        'questions' => [
            'content' => [
                1 => 'Q1. Czy dzięki przedstawionym na filmie punktom startowym i docelowym, odkrywca może odwiedzić wszystkie pola na szachownicy?',
                2 => 'Q2. Które punkty startowe i docelowe uniemożliwiają odkrywcy odwiedzenie jak największej ilości pól na szachownicy?'
            ]
        ]
    ],
    ...
    'right-and-left' => [
        ...
        'questions' => [
            'content' => [
                1 => 'Q1. Czy przy ustalonym punkcie startowym i docelowym, jak w pierwszej rozgrywce w tym filmie, możliwe jest, aby jedna z dwóch drużyn wygrała?',
                2 => 'Q2. Czy osiągnięcie remisu jest możliwe dla ustalonego punktu startowego i docelowego, jak w przypadku rozgrywki wygranej przez Annę?',
                3 => 'Q3. Czy istnieją jakieś ustalenia dotyczące rozpoczęcia i zakończenia rozgrywki, które faworyzują jedną z dwóch drużyn?',
                4 => 'Q4. Biorąc pod uwagę dyspozycję między punktem startowym a docelowym, czy można przewidzieć, jaka będzie różnica punktów między zwycięską i przegraną drużyną?'
            ]
        ]
    ],

    'keep-off-my-path' => [
        'title' => 'Zejdź z mojej ścieżki',
        'text' =>
        ...
        'questions' => [
            'content' => [
                1 => 'Q1. Czy istnieją punkty startowe, które faworyzują jedną z dwóch drużyn?',
                2 => 'Q2. Czy gra może zakończyć się remisem?',
                3 => 'Q3. Czy gracz rozpoczynający grę ma przewagę nad innymi graczami?',
                4 => 'Q4. Czy istnieje niepodważalna strategia gry, którą gracz poruszający się jako pierwszy, może zastosować, aby upewnić się, że nigdy nie przegra?'
            ]
        ]
    ],

    'tug-of-war' => [
        'title' => 'Przeciąganie liny',
        'text' =>
        ...
        'questions' => [
            'content' => [
                1 => 'Q1. Czy istnieje strategia, która zawsze będzie prowadzić do zwycięstwa?',
                2 => 'Q2. Czy gracz rozpoczynający rozgrywkę ma przewagę nad innymi graczami?',
                3 => 'Q3. Jeśli obaj gracze są równie uważni, czy gra zawsze kończy się remisem, tzn. w środku?'
            ]
        ]
    ],
    ...
    'explorer-without-footprints' => [
        ...
        'questions' => [
            'content' => [
                1 => 'Q1. Jaka jest różnica między planszą pełną kolorowych odcisków stóp a tą z kolorami, ale bez śladów stóp?',
                2 => 'Q2. Która plansza oferuje większą swobodę ruchu, zachowując te same zasady dla skręcania, jak te określone przez kolor?',
                3 => 'Q3. Czy na planszy z kolorami istnieją ścieżki, które nie są możliwe na planszy z kolorowymi odciskami stóp?',
                4 => 'Q4. Czy na planszy z kolorowymi odciskami stóp istnieją ścieżki, które nie są możliwe na planszy zawierającej wyłącznie kolory?'
            ]
        ]
    ],
...
kolorowe karty lub czerwony, żółty i szary pisak",
    ...
    'ada-charles-roby' => [
        ...
        'text' =>
            "Historia Ady Lovelace i Charlesa Baggage'a jest bardzo interesująca. Wymyślili oni i zaprogramowali komputery sto lat przed ich wynalezieniem.",
    ...
    'cody-and-roby' => [
        ...
        'material' =>
            'plansza z oznaczonymi polami, karty z instrukcjami(skręt w lewo, skręt w prawo, ruch do przodu) i dowolne pionki, które zostaną umieszczone na planszy',
    ...
    'the-tourist' => [
        ...
        'material' =>
            'Większe karty mogą być praktyczne, jeżeli chcesz grać na podłodze.',
        'questions' => [
            'content' => [
    ...
    'material2' => [
        'chequered-with-labels' =>
            'plansza na wzór szachownicy z oznaczonymi polami',
        'cards' =>
            '24 karty „Idź naprzód”, 8 kart „Skręć w lewo” oraz 8 kart „Skręć w prawo” do wyznaczania kierunku',
        'larger-cards' => 'Do gry na podłodze zalecane są większe karty',
        'video' =>
            'W filmie wideo wyjaśniono również, jak wygląda gra bez talii kart',
        'pieces-of-paper' =>
            'Potrzeba również 24 kawałków papieru, aby oznaczyć już odwiedzone pola',
        'card-alternative' =>
            'Jako alternatywę dla talii kart CodyRoby można wykorzystać ikony kart dostępne tutaj',
        'small-drawings' =>
            'Dodatkiem mogą być małe rysunki jako pomoc w opowiedzeniu historii. Te wykorzystane w filmie wideo można znaleźć tutaj',
        'rest-of-cards' =>
            'Oprócz tego potrzebujemy kart z CodyRoby, CodyFeet lub CodyColour.'
    ],
    ...
    'two-snakes' => [
        ...
        'material' =>
            'Talia kart CodyRoby, plansza na wzór szachownicy o rozmiarach 5 × 5 pól, dwa pionki i kawałki papieru, aby oznaczać już odwiedzone pola.',
        'questions' => [
            'content' => [
    ...
    'meeting-point' => [
        ...
        'material' =>
            'Talia kart CodyRoby, plansza na wzór szachownicy o rozmiarach 5 × 5 pól, dwa pionki.',
        'questions' => [
            'content' => [
    ...
    'follow-the-music' => [
        ...
        'material' =>
            'Poza talią kart CodyRoby, planszą na wzór szachownicy i pionkiem potrzebujemy czegoś, co umożliwi wytworzenie trzech różnych dźwięków. Ja użyłem trzech szklanek w różnym stopniu napełnionych wodą, a co wy wykorzystacie?',
        'questions' => [
            'content' => [
    ...
    'colour-everything' => [
        ...
        'material' =>
            'Talia kart CodyRoby, plansza w kratki i pionek. Do kolorowania pól użyj kawałków papieru, umieszczając je na odpowiednich polach, lub pokoloruj pola markerami.',
        'questions' => [
            'content' => [
    ...
    'codyplotter-and-codyprinter' => [
        ...
        'material' =>
            'oprócz zestawu CodyRoby korzystałem z zielonego markera i nowego robota z modeliny, ale nie są to niezbędne akcesoria.',
        'questions' => [
            'content' => [
    ...
    'boring-pixels' => [
        ...
        'material' =>
            'zeszyt w kratkę lub plansza w kratkę 5×5 narysowana na kartce papieru, długopis. Kod rysunku możesz zapisać długopisem na kartce papieru.',
        'questions' => [
            'content' => [
    ...
    'texts' => [
        ...
        3 => 'Jeśli jesteś zainteresowany większą ilością zajęć, które można wykonać bez elektryczności i bez wykorzystywania jakichkolwiek urządzeń elektronicznych lub zajęciami w różnych językach programowania, robotyką, oprogramowaniem sprzętowym mikro:bit itp. sprawdź <a href="/training">„Materiały szkoleniowe” Europejskiego Tygodnia Kodowania</a> obejmujące filmy instruktażowe i plany lekcji dla szkół podstawowych, gimnazjalnych i ponadgimnazjalnych. Zajrzyj również na stronę z zasobami Europejskiego Tygodnia Kodowania dla <a href="/resources/learn">uczniów</a> oraz <a href="/resources/teach">nauczycieli.</a>'
    ]
];
