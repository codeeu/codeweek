...
return [
    ...
    'walk-as-long-as-you-can' => [
        ...
        'coloured-cards' =>
            'barevné kartičky nebo červené, žluté a zelené zvýrazňovače',
        'questions' => [
            'content' => [
    ...
    'ada-charles-roby' => [
        ...
        'text' =>
            'Příběh Ady Lovelaceové a Charlese Babbageho je zajímavý. Vymysleli a programovali počítače sto let předtím, než byly ve skutečnosti vynalezeny.',
    ...
    'cody-and-roby' => [
        ...
        'material' =>
            'šachovnice se štítky, karty s instrukcemi (vlevo, vpravo, rovně) a dílky, které se umístí na desku',
    ...
    'material2' => [
        ...
        'cards' =>
            '24  karet pro pohyb vpřed, 8  karet pro otočení vlevo a 8  karet pro otočení vpravo',
        'larger-cards' => 'Pro verzi hry na podlaze se doporučují větší karty',
        'video' => 'Video také ukazuje, jak hrát bez karet',
        'pieces-of-paper' =>
            'Také je potřeba 24  kousků papíru, které se umístí na již navštívená pole',
        'card-alternative' =>
            'Jako alternativu k balíčku karet CodyRoby můžete použít ikony karet, které jsou dostupné zde',
        'small-drawings' =>
            'Jako doplněk můžete použít malé kresby, které pomohou s vyprávěním příběhu. Ty, které jsme použili ve videu, najdete zde',
        'rest-of-cards' =>
            'Pro zbytek používáme karty CodyRoby, CodyFeet nebo CodyColour.'
    ],
    ...
    'two-snakes' => [
        ...
        'material' =>
            'Karty CodyRoby, hrací deska s 5 × 5 políčky, dvě figurky, a kousky papíru, kterými označíme již navštívená políčka.',
        'questions' => [
            'content' => [
    ...
    'meeting-point' => [
        ...
        'material' =>
            'Karty CodyRoby, hrací deska s 5 × 5 políčky, dvě figurky.',
        'questions' => [
            'content' => [
    ...
    'follow-the-music' => [
        ...
        'material' =>
            'Kromě karet CodyRoby, hrací desky a figurky potřebujeme ještě vytvořit tři různé tóny. Já jsem použil tři sklenice naplněné do různé výšky vodou. Co použiješ ty?',
        'questions' => [
            'content' => [
    ...
    'colour-everything' => [
        ...
        'material' =>
            'Karty CodyRoby, čtverečkovaná hrací deska a figurka. K vybarvování políček budeme používat čtverečky papíru, které budeme na políčka pokládat. Nebo je můžete vybarvovat fixem.',
        'questions' => [
            'content' => [
    ...
    'codyplotter-and-codyprinter' => [
        ...
        'material' =>
            'Kromě setu CodyRoby budeme používat zelený fix a nového robota z modelíny, ale nemusí být.',
        'questions' => [
            'content' => [
    ...
    'boring-pixels' => [
        ...
        'material' =>
            'čtverečkovaný blok nebo hrací deska 5×5 políček nakreslená na listu papíru, fix. Ke znázornění můžete použít fix a papír.',
        'questions' => [
            'content' => [
