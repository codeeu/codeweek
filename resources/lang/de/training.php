...
<h2 class="subtitle">1. Lernhäppchen</h2>
    ...
    'lessons' => [
        ...
        '2' => [
            ...
            'author' => 'von Miles Berry',
            'text' => '<p>Rechnergestütztes Denken bezeichnet eine Methode zur Betrachtung von Problemen und Systemen, für deren Lösung oder Verständnis ein Computer verwendet werden kann. Rechnergestütztes Denken ist nicht nur für die Entwicklung von Computerprogrammen essenziell, sondern kann auch disziplinenübergreifend zur Unterstützung der Problemlösung genutzt werden.</p>

                    <p>Sie können Ihren Schülerinnen und Schülern rechnergestütztes Denken beibringen, indem Sie sie komplexe Probleme in kleinere Probleme zerlegen lassen (Dekomposition), um Muster zu erkennen (Mustererkennung), um die relevanten Details für die Problemlösung zu identifizieren (Abstraktion); oder indem Sie Regeln oder Befehle vorgeben, die zum Erreichen eines bestimmten Wunschergebnisses (Algorithmusdesign) befolgt werden sollen. Rechnergestütztes Denken kann in verschiedenen Disziplinen gelehrt werden, z. B. in der Mathematik (zur Erkennung der Regeln für die Faktorisierung von Polynomen zweiter Ordnung), in der Literatur (zur Aufschlüsselung von Gedichten für die Analyse von Metrik, Reim und Struktur), in der Linguistik (zur Erkennung von Mustern in den Endungen eines Verbs, die sich auf dessen Buchstabierung aufgrund einer Änderung der Zeitform auswirken) und in vielen anderen Bereichen.</p>

                    <p>In diesem Video stellt Miles Berry, Studienleiter an der University of Roehampton School of Education in Guildford (Vereinigtes Königreich) das Konzept des rechnergestützten Denkens und die unterschiedlichen Möglichkeiten für Lehrkräfte zur Einbindung des Konzepts in das Klassenzimmer über einfache Spiele vor.</p>',
            'activities' => [
        ...
        '3' => [
            ...
            'author' => 'von Margo Tinawi',
            'text' => '<p>Durch die visuelle Programmierung können Prozesse mithilfe von Illustrationen oder Grafiken beschrieben werden. Die visuelle Programmierung ist üblicherweise als Gegenstück zur textbasierten Programmierung zu betrachten. Visuelle Programmiersprachen sind besonders gut dafür geeignet, Kinder (und auch Erwachsene) in das algorithmische Denken einzuführen. Mit visuellen Programmiersprachen muss weniger gelesen und weniger Syntax implementiert werden.</p>

                    <p>In diesem Video hilft Ihnen Margo Tinawi, Web Development Teacher bei Le Wagon und Mitbegründerin von Techies Lab asbl (Belgien) bei der Entdeckung von Scratch, eine der beliebtesten Programmiersprachen, die auf der ganzen Welt Verwendung findet. Scratch wurde im Jahr 2002 vom MIT entwickelt und seitdem ist eine große Community um die Programmiersprache entstanden, die zahlreiche Tutorials in mehreren Sprachen und Millionen von Projekten bietet, die Sie mit Ihren Schülerinnen und Schülern nachbilden können.</p>

                    <p>Zur Verwendung von Scratch ist keine Programmiererfahrung erforderlich und Sie können die Programmiersprache für viele verschiedene Fächer verwenden. Durch die Verwendung von Scratch als digitales Storytelling-Tool können Schülerinnen und Schüler Geschichten entwerfen, ein Matheproblem veranschaulichen oder an einem Kunstwettbewerb teilnehmen, um etwas über das kulturelle Erbe zu erfahren und währenddessen Programmieren und rechnergestütztes Denken zu erlernen, und – was am wichtigsten ist – dabei auch noch Spaß zu haben.</p>

                    <p>Scratch ist ein kostenloses Tool, sehr intuitiv und motivierend für Ihre Schüler. Schauen Sie sich das Video von Margo an, um zu erfahren, wie Sie loslegen können:</p>',
            'activities' => [
        ...
        '4' => [
            ...
            'author' => 'von Jesús Moreno León',
            'text' => '<p>Kritisches Denken, Durchhaltevermögen, rechnergestütztes Denken und Kreativität sind nur ein paar der wichtigen Fähigkeiten, die Ihre Schülerinnen und Schüler brauchen, um im 21. Jahrhundert erfolgreich zu sein. Die Programmierung kann Ihnen dabei helfen, dies auf spielerische und motivierende Weise zu erreichen.</p>

                    <p>Algorithmische Vorstellungen einer Durchflusssteuerung unter Verwendung von Befehlen und Schleifen, Datendarstellungen unter Verwendung von Variablen und Listen oder die Synchronisierung von Prozessen mögen sich wie komplizierte Konzepte anhören, doch in diesem Video erfahren Sie, dass diese leichter erlernt werden können, als Sie denken.</p>

                    <p>In diesem Video erklärt Ihnen der spanische Informatiklehrer und Forscher Jesús Moreno León wie Sie Ihren Schülerinnen und Schülern diese und weitere Kompetenzen auf unterhaltsame Weise beibringen können. Wie geht das? Durch die Erstellung eines Frage- und Antwortspiels in Scratch, der beliebtesten Programmiersprache, die an Schulen weltweit verwendet wird. Scratch verbessert nicht nur das rechnergestützte Denken, sondern ermöglicht auch die Einführung spielerischer Elemente (Gamification) in das Klassenzimmer, damit Ihre Schüler motiviert bleiben, während sie etwas auf unterhaltsame Weise lernen.</p>

                    <p>Schauen Sie sich das Video an, um zu erfahren, wie Sie loslegen können:</p>',
            'activities' => [
        ...
        '5' => [
            ...
            'author' => 'von Tullia Urschitz',
            'text' => '<p>Die Einbindung von Programmierung, technischen Tüfteleien, Robotik und Mikroelektronik als Instrumente für die Lehre und das Lernen in die Unterrichtspläne ist für die Bildung des 21. Jahrhunderts von entscheidender Bedeutung.</p>

                    <p>Die Verwendung von technischen Tüfteleien und Robotik an Schulen hat zahlreiche Vorteile für Schülerinnen und Schüler, da dies die Entwicklung von Kompetenzen wie z. B. Problemlösung, Teamarbeit und Zusammenarbeit fördert. Dies steigert zudem die Kreativität und das Selbstvertrauen von Schülern und kann diese bei der Entwicklung von Durchhaltevermögen und Entschiedenheit unterstützen, wenn sie mit Herausforderungen konfrontiert sind. Die Robotik ist auch ein Gebiet, das Inklusivität fördert, da es ohne Weiteres einer Vielzahl von Schülern mit verschiedenen Fähigkeiten (sowohl Jungen als auch Mädchen) zugänglich ist und einen positiven Einfluss auf Schüler des autistischen Spektrums hat.</p>

                    <p>Werfen Sie einen Blick auf dieses Video, in dem Ihnen Tullia Urschitz, italienische Scientix-Botschafterin und MINT-Lehrerin in Sant’Ambrogio Di Valpolicella, Italien, verschiedene praktische Beispiel gibt, wie Lehrkräfte technische Tüfteleien und Robotik in das Klassenzimmer integrieren können, um passive Schülerinnen und Schüler in begeisterte Macher zu verwandeln.</p>',
            'activities' => [
...
Mit Python können Ihre Schülerinnen und Schüler u. a. Ratespiele zu historischen Ereignissen erstellen, mathematische Probleme lösen und Physik-Simulationen erstellen, Spiele entwickeln, Websites erstellen, Datenanalysen für wissenschaftliche Projekte durchführen. Python verfügt über eine große und umfassende Standardbibliothek, eine große Gemeinschaft sowie zahlreiche online verfügbare Tutorials und Projekte, die zum Unterrichten, Lernen und Üben verwendet werden können. Durch das Programmieren in Python, das Analysieren von Programmen und die Behebung von Fehlern entwickeln die Schülerinnen und Schüler ihre Kreativität und lernen, wie man seine Arbeit mit Konstanz, Durchhaltevermögen und Geduld erledigt. Sie lernen analytisches Denken und erwerben Problemlösungsfähigkeiten, da sie komplexe Probleme in kleinere Teile zerlegen müssen. Diese Kompetenzen werden ihnen auch in allen anderen Bereichen ihres Lebens beim Umgang mit Problemen nützlich sein.
    ...
    'choose_lessons' => 'Wählen Sie einen der Unterrichtspläne unten aus und organisieren Sie mit Ihren Schülerinnen und Schülern eine Aktivität.',
    'footer' => [
