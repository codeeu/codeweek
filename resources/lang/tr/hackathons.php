...
return [
    ...
    'sections' => [
        ...
        3 => [
            'title' => 'Organizatörler kimler?',
            'content' => [
                1 => 'EU Code Week hackathon’ları, Avrupa Komisyonu ve yerel AB ',
                2 => 'Code Week Elçileri',
                3 => ' tarafından ortak bir şekilde organize edilerek Avrupa Parlamentosu tarafından finanse edilmektedir. Burada amaç, genç insanların yaratıcılığı, heyecanı, taze fikirleri ve kodlama becerileri yardımıyla somut fikirlerin nasıl hayata geçirileceğini göstermektir.'
            ]
        ],
        4 => [
        ...
        5 => [
            'title' => 'Kodlama bilmiyorum, ne yapabilirim?',
            'content' => [
                1 => 'Hackathon’un yanında, katılımcıların sayısal düşünme ve kodlamaya ilişkin bazı temelleri öğrenmeleri amacıyla, başlangıç seviyesindekiler için kodlama, donanımla deneme uygulaması, robot teknolojisi ve benzeri konularda çalıştaylar yapılacaktır. Kayıtla ilgili daha fazla bilgi için yerel sayfanıza bakın.'
            ]
        ],
