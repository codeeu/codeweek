...
return [
    ...
    '3-legal_process' => [
        'İşleme faaliyetinin kanuniliği: G.2. Birimi kişisel verilerinizi toplar, saklar ve yayınlar, bunun nedeni, <a href="https://codeweek.eu/register">Avrupa Kod Haftası</a> üzerinden Kod Haftası Büyükelçisi, Lider Öğretmen olmak için kayıt olduğunuzda ya da bir etkinliğe kaydolmak için başvuruda bulunduğunuzda, açıkça rızanızı belirtmiş olmanızdır.',

    ],
    '4-collect_data' => [
        '<strong>Büyükelçiler ve Lider Öğretmenler</strong> için toplanan <strong>zorunlu</strong> kişisel bilgiler aşağıdaki gibidir:',
        'İsim',
        'E-posta adresi',
        'Şifre',
        'Fotoğraf',
        'Özgeçmiş',
        'Unvan',
        'Lider Öğretmenler için uzmanlık alanı.',
        'Bir <strong>etkinliğe kaydolduğunuzda, zorunlu</strong> olarak toplanan kişisel bilgiler aşağıdaki gibidir:',
        'Kuruluşun adı',
        'Kuruluşun türü',
        'İrtibat E-posta adresi',
        'Bir Kod Haftası Büyükelçisi, Lider Öğretmen olmak ya da Kod Haftası İnternet üzerinden bir etkinliğe kaydolmak için bu verilerin sağlanması zorunludur.',
        'Ayrıca, <strong>Büyükelçiler ve Lider Öğretmenler</strong> aşağıdaki kişisel verileri <strong>gönüllü olarak</strong> temin edebilirler:',
        'Sosyal medya hesapları',
        '<strong>Etkinlik organizatörleri</strong> aşağıdaki verileri <strong>gönüllü olarak</strong> temin edebilirler:',
        'Gizli olmayan irtibat E-posta adresi',
        'Organizatörün İnternet sitesi',
        'Herkes İçin Kod Haftası',
        'Etkinlik organizatörlerinin dikkatine: lütfen ülkenizin Büyükelçisinin veya G.2. Biriminin, kaydolurken sağlanan kişisel verileri, anılan etkinlikle ilgili olarak sizinle irtibat kurmak üzere kullanabileceğini unutmayın.',
        'Kişisel verilerinizi aşağıdaki sayfalarda sağlamış bulunuyorsunuz',
        'Kod Haftası İnternet Sitesi giriş sayfası',
        've',
