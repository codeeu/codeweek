...
return [
    ...
    "title" => "Kod Haftası Dansı",
        ...
        "subtitle" => "Programlayıcıların dans edemediğini de kim söylemiş? Kod Haftası 2020’yi kutlamak için yeni bir etkinlik başlatıyoruz: #CodeWeekDance (Kod Haftası Dansı) meydan okuması",
        "section1" => [
    ...
    "Bağlantısız Dans Partini düzenleyebilmek için bu code.org rehberini kullan",
        ...
        "activity2" => [
            ...
            "subtitle" => "Kod Haftası dansını Scratch’te kodla. Kod Haftası karakterlerini kullan veya Scratch’te kendi karakterini yarat ve #CodeWeekDance’ı (Kod Haftası Dansını) yapmaya programla.",
            "resources" => [
            ...
            "subtitle" => "EarSketch veya Sonic Pi gibi kod tabanlı bir müzik yapma platformu kullanarak Python veya JavaScript yardımıyla #CodeWeekDance (Kod Haftası Dansı) müziğini yap.",
            "resources" => [
    ...
    "subtitle" => "Robotunu komutlarını izleyip Kod Haftası Dansını sergileyecek şekilde programla.",
            "resources" => [
    "Robot programlama ile ilgili bir eğitim",
            ]
        ], "activity5" => [
    "title" => "Canlı Dans Meydan Okuması",
            "subtitle" => "Sen, takımın veya robotun #CodeWeekDance’ını (Kod Haftası Dansını) yaparken video çek ve Instagram’da paylaş. Böylece viral olma ve Kod haftasına özgü hediyeler kazanma şansını elde et! İlgini çekti mi? Şu adımları takip et:",
            "resources" => [
