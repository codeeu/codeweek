...
return [
    ...
    'intro' =>
        'Bu sene kodlama kutlamalarımızı 9-24 Ekim 2020 günlerinde düzenliyoruz! Yaşadığımız salgından dolayı, bu sene daha fazla sayıda Kod Haftası etkinliği internetten yapılacak. Evde veya okulda uzaktan katılabileceğiniz eğlenceli ve öğretici yeni aktiviteler sunacağız.',
    'online-activities' => [
        ...
        'section1' => [
            ...
            'content' =>
                'Çevrim içi aktiviteler, Kod Haftası websitesine ekleyeceğin veya kaydedeceğin tüm aktivitelerdir; tek farkı aktivitenin internette yapılmasıdır. Amacımız, insanların sağlığını riske atmadan kodlama oturumlarına ve atölyelerine tamamen çevrim içi katılmalarını sağlamak.'
        ],
        'section2' => [
            'title' => 'Öne çıkan açık aktiviteler',
            'content' =>
                'İsterseniz, çevrim içi aktivitelerini herkesin kullanımına açabilirsin. Dünyanın her yerinden insanlar, İngilizce veya ülkelerinin yerli dilinde açık çevrim içi aktivitelere katılabilecekler. Herkese açık olan aktiviteler arasından en heyecan verici olanları web sitemizde yer alan etkinlik takviminde öne çıkaracağız.'
        ],
        'section3' => [
    ...
    'dance' => [
        ...
        'section2' => [
            ...
            'content' =>
                '5 farklı aktivite türünden birini seç veya kendin bir aktivite türet. Seçtiğin aktivite ne olursa olsun, aktiviteni haritana eklemeyi unutma.'
        ],
        'activity1' => [
            'title' =>
        ...
        'activity4' => [
            'title' => 'Robotik',
            'subtitle' =>
                'Robotunu komutlarını izleyip Kod Haftası Dansını sergileyecek şekilde programla.',
    ...
    'get-involved' => [
        'title' => 'Nasıl katılabilirsin?',
        'subtitle' =>
            'Kodlamaya başlamaya can mı atıyorsun? AB Kod Haftası topluluğuna katılmak istiyor, fakat nereden başlayacağını bilemiyorsan, Ekim’deki yıllık kutlamalarımızdan önce başlamana yardımcı olacak şu kaynaklara bir göz at.',
        'content' => [
