...
return [
    ...
    "guide" => [
        "tutorials" => [
            "1" => "Gençlerin kodlama ve bilişimsel düşünmeyi öğrendikleri aktiviteler düzenlemek için 29 dilde mevcut",
            "2" => "kurs ve eğitimlerimize",
            "3" => "bir göz atın.",
        ]
    ],
    "dance" => [
    ...
    "treasure-hunt" => [
        "menu" => "Hazine Avı",
        "subtitle" => "Telegram’da oynanan bir oyundur.",
    ],


    "videos" => [
        1 => "AB Kod Haftası elçilerimizin değerlerimizle ilgili videolarını izleyin",
        2 => "Kod Haftası’nın neden bağımsız olduğunu Slovenya elçisi Katja Osljak’tan dinleyin",
        3 => "Kod Haftası’nın neden herkese hitap ettiğini Fransa elçisi Laurent Touché’den dinleyin",
        4 => "Kod Haftası’nın neden hem global hem de yerel (glokal) olduğunu Tunus elçisi Fatma Bouaziz’den dinleyin",
        5 => "Kod Haftası’nın neden işbirliği temelli olduğunu Letonya elçisi Linda Sinka’dan dinleyin",
        6 => "Kod Haftası’nın neden kâr amacı gütmediğini İtalya elçisi Alessandro Bogliolo’dan dinleyin",
        7 => "Kod Haftası’nın neden yenilikçilik ve yaratıcılığı teşvik ettiğini Arnavutluk elçisi Marjana Prifti’den dinleyin",
