...
return [
    "remote-teaching" => "La enseñanza a distancia",
    "intro" => [
        "title" => "La semana de la programación y la enseñanza a distancia",
        "text" => "La enseñanza a distancia puede ser todo un reto para profesores y alumnos, y requiere superar muchos obstáculos. Sin embargo, la enseñanza de la programación, el pensamiento computacional –incluso la robótica– no tiene por qué detenerse porque sus alumnos estén en casa. A continuación te ofrecemos algunos consejos y recursos que esperamos puedan ayudarte.",
        "points" => [
            1 => "se trata de una colección de vídeos cortos, materiales de bricolaje, rompecabezas, juegos y retos de programación para el uso diario en la familia y en la escuela.",
            2 => ["Coding Unplugged","aquí encontrarás diferentes actividades que puedes realizar fácilmente en casa para aprender o enseñar programación con materiales cotidianos."],
            3 => [
                "Minicursos",
                "aquí encontrarás «minicursos» o tutoriales sobre desarrollo sostenible e inteligencia artificial que incluyen secciones de enseñanza a distancia para incorporar en tus programas docentes."
            ],
            4 => [
                "Repositorio de recursos",
                "muchos de los recursos del repositorio pueden utilizarse también en situaciones de enseñanza a distancia. Podrás encontrar recursos para enseñar a programar o para aprender a programar."
            ],
            5 => [
                "Webinarios de programación desde casa",
                "¿Sabías que la Semana de la Programación ha organizado varios seminarios web sobre cómo aprender y enseñar a programar desde casa? ¡No te los pierdas!"
            ]
    ...
    "tips" => [
        "title" => "7 consejos para enseñar a codificar a distancia",
        "points" => [
            1 => [
                "Familiarizarse con los conceptos, el lenguaje de programación y el software",
                "aunque los alumnos pueden aprender a codificar y programar de forma casi autónoma mediante el método de ensayo y error, tendrás que guiarles y ayudarles a encontrar errores en su sintaxis. Estate preparado para cambiar y adaptarte si una herramienta digital o un lenguaje de programación no dan los resultados de aprendizaje que esperabas."
            ],
            2 =>
                [
                    "Capacita a los alumnos",
                    "ayuda a tus alumnos a alcanzar su máximo potencial mediante clases alentadoras y repletas de significado. Deja que exploren sus habilidades y su creatividad permitiéndoles elegir sus propios proyectos y resultados. Además, te recomendamos que seas realista y establezcas objetivos alcanzables por tus alumnos."
                ],
            3 => [
