...
return [
    ...
    'explorer-without-footprints' => [
        ...
        'material' =>
            'Así como marcadores (o lapiceros) rojo, amarillo y gris.',
        'questions' => [
            'content' => [
    ...
    'walk-as-long-as-you-can' => [
        ...
        'coloured-cards' =>
            'tarjetas de colores o marcadores de color rojo, amarillo y gris',
        'questions' => [
            'content' => [
    ...
    'ada-charles-roby' => [
        ...
        'text' =>
            'La historia de Ada Lovelace y Charles Babbage es interesante. Concibieron y programaron ordenadores cien años antes de que se inventasen realmente',
    ...
    'cody-and-roby' => [
        ...
        'material' =>
            'tablero cuadriculado con marcas, tarjetas de instrucciones (izquierda, derecha, adelante) y cualquier contador que deba colocarse sobre el tablero',
    ...
    'the-tourist' => [
        ...
        'material' =>
            'Tarjetas más grandes pueden ser útiles para jugar en el suelo',
        'questions' => [
            'content' => [
    ...
    'two-snakes' => [
        ...
        'material' =>
            'Cartas CodyRoby, un tablero de 5 × 5 casillas, dos piezas y fichas de papel para marcar las casillas ya visitadas.',
        'questions' => [
            'content' => [
    ...
    'follow-the-music' => [
        ...
        'material' =>
            'Además de las cartas CodyRoby, el tablero y las piezas, hay que hacer tres sonidos diferentes. Yo he utilizado tres vasos con distintas cantidades de agua. ¿Qué utilizaréis vosotros?',
        'questions' => [
            'content' => [
    ...
    'material2' => [
        ...
        'cards' =>
            'veinticuatro tarjetas de «avanzar», ocho de «girar a la izquierda» y ocho de «girar a la derecha»',
        'larger-cards' =>
            'Para la versión en el suelo se recomienda utilizar tarjetas más grandes',
        'video' => 'El vídeo también explica cómo jugar sin el mazo de cartas',
        'pieces-of-paper' =>
            'Asimismo, se requieren veinticuatro pedazos de papel para colocarlos en las casillas ya visitadas',
        'card-alternative' =>
            'Como alternativa al mazo de tarjetas de CodyRoby, se pueden utilizar los iconos disponibles aquí',
        'small-drawings' =>
            'Un suplemento pueden ser pequeños dibujos para ayudar a contar la historia. Los utilizados en el vídeo pueden encontrarse aquí',
        'rest-of-cards' =>
            'Para el resto utilizamos las tarjetas de CodyRoby, CodyFeet o CodyColour.'
    ],
    ...
    'colour-everything' => [
        ...
        'material' =>
            'Tarjetas CodyRoby, tablero y peón. Para colorear las casillas, colócales trozos de papel encima o márcalas con rotulador.',
        'questions' => [
            'content' => [
    ...
    'codyplotter-and-codyprinter' => [
        ...
        'material' =>
            'Además del kit CodyRoby, utilicé un rotulador verde y un nuevo robot de plastilina, pero esto es facultativo.',
        'questions' => [
            'content' => [
    ...
    'boring-pixels' => [
        ...
        'material' =>
            'cuaderno de cuadrícula o tablero de 5 × 5 en papel, rotulador. Para representar el código del dibujo, puedes utilizar papel y bolígrafo.',
        'questions' => [
            'content' => [
