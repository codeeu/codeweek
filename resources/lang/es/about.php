...
return [
    'when-title' =>
        'La edición de 2024 de la Semana de la Programación de la Unión Europea (UE) se celebrará entre el 14 y el 27 de octubre.',
    'when-text' =>
    ...
    'why_coding-text' => '<p>Se trata de Pia, que pensaba que tenía que estudiar Derecho aunque siempre le habían gustado las matemáticas y jugar con ordenadores. Se trata de Mark, que tiene una idea para una red social mejor pero que no puede crearla por sí mismo. Se trata de Alice, que sueña con fabricar robots porque sus padres no le dejaron tener un gato.</p>
                    ...
                    <p>Se trata de todos aquellos que ya estáis ayudando a hacer realidad estos sueños.</p>

                    <p>De hecho, se trata de todos nosotros. Nuestro futuro. La tecnología está dando forma a nuestras vidas, pero estamos permitiendo que una minoría decida qué usamos y para qué lo hacemos. Podemos ir más allá de limitarnos a compartir cosas y darles un me gusta. Podemos dar vida a nuestras ideas más alocadas y crear cosas nuevas que hagan felices a otras personas.</p>
