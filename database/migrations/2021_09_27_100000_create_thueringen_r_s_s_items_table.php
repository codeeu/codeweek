...
class CreateThueringenRSSItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('thueringen_r_s_s_items', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('thueringen_r_s_s_items');
    }
}
