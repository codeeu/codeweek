...
class LuxembourgEventsImport extends DefaultValueBinder implements WithCustomValueBinder, ToModel, WithHeadingRow
{
    ...
    public function model(array $row)
    {
        ...
        $event = new Event([
            ...
            "created" => now(),
            "updated" => now(),
            "codeweek_for_all_participation_code" => "cw20-luxembourg",
