...
class Niedersachsen extends Command
{
     ...
     * @var string
     */
    protected $signature = 'api:niedersachsen {--force}';
     ...
     * @var string
     */
    protected $description = 'Import Niedersachsen Events';
    ...
    public function handle()
    {
        ...
        Artisan::call('import:niedersachsen');
