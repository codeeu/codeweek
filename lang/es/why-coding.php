...
return [
    'titles' => [
        ...
        'Se trata de dar vida a las ideas',
        'También se trata de desarrollar las competencias clave',
        'Por último, se trata de dar forma a nuestro futuro',
    ],
    'texts' => [
        'Se trata de Pia, que pensaba que tenía que estudiar Derecho, aunque siempre le habían gustado las matemáticas y jugar con ordenadores. Se trata de Mark, que tiene una idea para una red social mejor pero que no puede crearla por sí mismo. Se trata de Alice, que sueña con fabricar robots porque sus padres no le dejaron tener un gato. Y se trata de todos aquellos que ya estáis ayudando a hacer realidad estos sueños.',
        'De hecho, se trata de todos nosotros y de cómo damos forma a nuestras vidas y a nuestro futuro. Podemos ir más allá de limitarnos a compartir publicaciones y darles un me gusta. Podemos dar vida a nuestras ideas, construir cosas que hagan felices a otras personas.',
        'Nunca ha sido tan fácil crear una aplicación, construirte tu propio robot o, quién sabe, incluso inventar el coche volador. No se trata de un camino cómodo, pero sí de un camino lleno de retos creativos, toneladas de diversión y una comunidad encantada de ayudar. ¿Estás preparado/a para aceptar el reto y convertirte en un creador digital?',
        'Los lenguajes de programación son como cualquier otro lenguaje. Solo que en este caso, los niños no aprenden a expresarse y a comunicarse con otras personas. En cambio, consiguen entender cómo comunicarse con la tecnología. Tecnología que nos rodea: en nuestros teléfonos inteligentes, ordenadores, vehículos, ¡en todas partes!',
        'Pero entender y comunicarse con los ordenadores es solo una parte. La programación también ayuda a desarrollar competencias multidisciplinares como el pensamiento computacional, la resolución de problemas, la creatividad y el trabajo en equipo, excelentes habilidades para todos los ámbitos de la vida. La capacidad de resolver problemas, de afrontar el fracaso y volver a intentarlo, o de colaborar con otros, son rasgos que se buscan en muchos campos.',
        'Hace un siglo, los lenguajes de programación ni siquiera existían. Hoy en día, el código nos rodea y casi todo se puede programar, incluso los zapatos o las cajas de cereales. ¿Por qué dejar que otros den forma a nuestro futuro cuando nosotros podemos convertirnos en los creadores y hacer realidad nuestras visiones e ideas? Al fin y al cabo, el único límite es nuestra imaginación.',
        'Alessandro Bogliolo, director del equipo de embajadores voluntarios de la Semana de la Programación de la UE, ha manifestado:',
