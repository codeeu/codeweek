...
return [
    ...
    'what' => [
        ...
        'text' => '<p>Sīkfails ir sīks teksta fails, ko tīmekļa vietne saglabā jūsu datorā vai mobilajā ierīcē, kad jūs apmeklējat attiecīgo vietni.</p>',
        'first_party' => '<strong>Pirmās puses sīkfaili</strong> ir sīkfaili, kurus iestata tīmekļa vietne, kuru jūs apmeklējat. Tos var lasīt tikai attiecīgā tīmekļa vietne. Papildus tam tīmekļa vietne var izmantot arī ārējus pakalpojumus, kas arī iestata paši savus sīkfailus, kas pazīstami kā <strong>trešo pušu sīkfaili</strong>.',
        'persistent_cookies' => 'Pastāvīgie sīkfaili ir sīkfaili, kurus saglabā jūsu datorā un kurus automātiski neizdzēš, kad jūs aizverat pārlūkprogrammu, pretstatā sesijas sīkfailiem, kurus izdzēš, kad jūs aizverat pārlūkprogrammu.',
        'items' => '<p>Pirmoreiz apmeklējot Programmēšanas nedēļas tīmekļa vietni, jums tiks prasīts <strong>akceptēt vai noraidīt sīkfailus</strong>.</p>
    ...
    'how' => [
        ...
        'text1' => '<p>Programmēšanas nedēļas vietne lielākoties izmanto “pirmās puses sīkfailus”. Šos sīkfailus iestatām un pārvaldām mēs, nevis kāda ārēja organizācija.</p>',
        'text2' => '<p>Tomēr, lai varētu aplūkot dažas mūsu lapas, jums būs jāakceptē sīkfaili no ārējām organizācijām.</p>',
        '3types' => [
        ...
        'technical_cookies' => [
            ...
            'table' => [
                '1' => [
                    'purpose' => 'Nodrošināt drošu sesiju jums jūsu apmeklējuma laikā.',
                    'type_duration' => 'Pirmās puses sesijas sīkfaili, kurus izdzēš, kad jūs aizverat pārlūkprogrammu',
                ],
                '2' => [
                    'purpose' => 'Nodrošināt drošu sesiju jums ilgāku laiku, lai nepieļautu sesijas zaudēšanu, kad tiek aizvērta pārlūkprogramma.',
                    'type_duration' => 'Pirmās puses pastāvīgi sīkfaili, 60 mēneši',
                ],
                '3' => [
        ...
        'analytics_cookies' => [
            ...
            'items' => '<p>Mēs šos sīkfailus izmantojam vienīgi iekšējā izpētē, lai noskaidrotu, kā uzlabot pakalpojumu, ko mēs sniedzam visiem mūsu lietotājiem.</p>
            ...
            'table' => [
                '1' => [
                    ...
                    'purpose' => 'Atpazīst tīmekļa vietnes apmeklētājus (anonīmi — netiek vākta personas informācija par lietotāju).',
                    'type_duration' => 'Pirmās puses pastāvīgi sīkfaili, 20 dienas',
                ],
                '2' => [
                    'service' => 'Tīmekļa analītikas pakalpojums, kura pamatā izmantota <i>Matomo</i> atklātā pirmkoda programmatūra',
    ...
    'third-party' => [
        'title' => 'Trešās puses sīkfaili',
        'items' => [
            '1' => '<p>Dažās mūsu lapās tiek parādīts saturs no ārējiem pakalpojumu sniedzējiem, piemēram, <i>YouTube</i>, <i>Facebook</i> un <i>Twitter</i>.</p>
    ...
    'how-manage' => [
        ...
        'items' => '<p>Jūs varat <strong>pārvaldīt/dzēst</strong> sīkfailus pēc saviem ieskatiem — sīkāku informāciju sk. <a
