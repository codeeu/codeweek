...
<h2 class="subtitle">1. Kod Haftası Öğrenim Parçaları</h2>
    ...
    'lessons' => [
        '1' => [
            ...
            'text' => '<p>Kodlama, etrafımızdaki on milyarlarca programlanabilir nesneye yeni işlevler kazandıracak programlar yazmamıza izin veren şeylerin dilidir. Kodlama, fikirlerimizi gerçeğe dönüştürmenin en hızlı yolu olup, sayısal düşünme becerilerini geliştirmenin de en etkili yoludur. Ancak, sayısal düşünme becerilerini geliştirmek için teknoloji illa ki gerekli değildir. Aksine, sayısal düşünme becerilerimiz, teknolojinin işe yaraması için gereklidir.</p>

                    <p>Bu videoda, İtalya\'da Bilgisayar Sistemleri Profesörü olarak görev yapan ve Avrupa Kod Haftası Koordinatörü olan Alessandro Bogliolo, herhangi bir elektronik cihaz olmadan uygulanabilecek bağlantısı kodlama faaliyetlerini tanıtacak. Bağlantısız faaliyetlerin temel amacı, finansman ve ekipmandan bağımsız olarak, kodlamayı tüm okullara taşıyabilmek için buna erişimin önündeki engelleri azaltmaktır.</p>

                    <p>Bağlantısız kodlama faaliyetleri, çevremizdeki fiziksel dünyanın sayısal yönlerini gözler önüne serer.</p>',
            'activities' => [
        ...
        '2' => [
            ...
            'author' => 'Miles Berry',
            'text' => '<p>Sayısal düşünme (SD), problemleri ve sistemleri bilgisayar yoluyla çözüp anlayabilmek için bunlara nasıl bakacağımızı tanımlar. Sayısal düşünme, yalnızca bilgisayar programlarının geliştirilmesi açısından önem teşkil etmekle kalmaz, aynı zamanda tüm disiplinlerde problem çözmeyi desteklemede de kullanılabilir.</p>

                    <p>Karmaşık problemleri daha küçük parçalara ayırmalarını (ayrıştırma), kalıpları tanımalarını (örüntü tanıma), problem çözme ile ilgili ayrıntıları tanımlamalarını (soyutlama) sağlayarak ya da istenen bir sonuca ulaşmak için takip edilecek kural ya da talimatları belirleyerek (algoritma tasarımı) öğrencilerinize sayısal düşünmeyi öğretebilirsiniz. SD, Matematik (2. derece polinomları çarpanlara ayırmanın kurallarını anlama), Edebiyat (bir şiir çözümlemesini, ölçü, kafiye ve yapı çözümlemesine indirgeme), Dil (zaman değiştikçe bir fiilin yazılışını etkileyen son harflerindeki örüntüyü bulma) gibi farklı disiplinlerde öğretilebilir.</p>

                    <p>Bu videoda, Guildford\'daki (Birleşik Krallık) Roehampton Üniversitesi Eğitim Fakültesi\'nde Öğretim Görevlisi olarak görev yapan Miles Berry, sayısal düşünme kavramını ve öğretmenin bunu basit oyunlarla sınıfa entegre etmesini sağlayacak farklı yolları tanıtacak.</p>',
            'activities' => [
        ...
        '3' => [
            ...
            'author' => 'Margo Tinawi',
            'text' => '<p>Görsel programlama, insanların işlemleri illüstrasyon ya da grafik kullanarak tanımlamasını sağlar. Metin tabanlı programlamanın aksine genellikle görsel bir programlama mevcuttur. Görsel programlama dilleri (GPDler), çocuklara (ve hatta yetişkinlere) algoritmik düşünmeyi tanıtacak şekilde uyarlanmıştır. GPDlerde okunacak daha az şey olup, uygulanacak sözdizimleri yoktur.</p>

                    <p>Bu videoda, Le Wagon\'da Web Geliştirme Öğretmeni olarak görev yapan ve Techies Lab asbl\'ın (Belçika) Kurucu Ortağı olan Margo Tinawi, tüm dünyada kullanılan en popüler GPD\'lerden biri olan Scratch\'i keşfetmenize yardımcı olacak. Scratch MIT tarafından 2002 yılında geliştirilmiş olup, o zamandan beri, öğrencilerinizle gerçekleştirebileceğiniz milyonlarca projeye ve çeşitli dillerde sayısız derse ulaşabileceğiniz büyük bir topluluğa sahiptir.</p>

                    <p>Scratch\'i kullanmak için herhangi bir kodlama deneyimine sahip olmanıza gerek yoktur ve bunu her türlü farklı konuda kullanabilirsiniz! Örneğin, öğrenciler, Scratch\'i dijital bir hikaye anlatımı aracı olarak kullanarak, bir yandan kodlamayı ve sayısal düşünmeyi öğrenirken ve en önemlisi de eğlenirken, bir yandan da hikâyeler oluşturabilir, bir matematik problemini resmedebilir ya da kültürel miras hakkında bilgi edinmek üzere bir resim yarışmasına katılabilirler.</p>

                    <p>Scratch, son derece sezgisel ve öğrencileriniz açısından motive edici olan ücretsiz bir araçtır. Nasıl başlayacağınızı öğrenmek için Margo nun videosunu inceleyin.</p>',
            'activities' => [
        ...
        '4' => [
            ...
            'text' => '<p>Eleştirel düşünme, sebat etme, problem çözme, sayısal düşünme ve yaratıcılık, öğrencilerinizin 21. yüzyılda başarılı olabilmeleri için gereken temel becerilerden bazıları olup, kodlama, bunları eğlenceli ve motive edici bir şekilde gerçekleştirmenize yardımcı olabilir.</p>

                    <p>Talimat ve döngü dizilerini kullanan akış kontrolü algoritmik kavramları ile değişkenlerden ve listelerden ya da süreç senkronizasyonundan faydalanan veri gösterimleri, kulağa karmaşık kavramlar gibi gelebilir, ancak bu videoda bunların düşündüğünüzden çok daha kolay bir şekilde öğrenilebileceğini göreceksiniz.</p>

                    <p>Bu videoda, İspanya’da Bilgisayar Bilimi öğretmeni ve araştırmacı olarak görev yapan Jesús Moreno León, öğrencilerinizin bu ve diğer becerilerini nasıl eğlenceli bir biçimde geliştirebileceğinizi açıklayacak. Peki, bu nasıl yapılabilir? Dünya çapındaki okullarda kullanılan en popüler programlama dili olan Scratch üzerinde bir soru ve cevap oyunu hazırlayarak. Scratch sadece sayısal düşünmeyi geliştirmekle kalmaz, aynı zamanda öğrencilerinizin öğrenirken ve eğlenirken motive olmasını sağlamak için sınıfta oyun ögelerinin kullanılmasına da olanak tanır.</p>

                    <p>Nasıl başlayacağınızı öğrenmek için videoyu inceleyin:</p>',
            'activities' => [
        ...
        '5' => [
            ...
            'text' => '<p>Kodlama, deneme uygulamaları, robot teknolojisi ve mikroelektroniğin öğretim ve öğrenim araçları olarak okul müfredatına entegre edilmesi, 21. yüzyıl eğitiminin temelidir.</p>

                    <p>Okullarda robot teknolojisi ve deneme uygulamalarının, problem çözme, ekip çalışması ve iş birliği gibi temel yetkinliklerin geliştirilmesine yardımcı olması açısından öğrenciler için pek çok faydası vardır. Ayrıca öğrencilerin yaratıcılıklarını ve öz güvenlerini artırıp, zorluklarla karşılaştıklarında azim ve kararlılık göstermelerine de yardımcı olabilir. Robot teknolojisi aynı zamanda, çeşitli yetenek ve becerilere sahip (hem erkek hem de kız çocuklar) öğrencilere kolayca erişilebildiği ve otizmli öğrencileri olumlu yönde etkilediği için kapsayıcılığı destekleyen bir alandır.</p>

                    <p>İtalya\'nın Santâ’Ambrogio Di Valpolicella kentindeki İtalyan Scientix büyükelçisi ve STEM öğretmeni olan Tullia Urschitz\'in, öğretmenlere deneme uygulaması ve robot teknolojisinin sınıfa nasıl entegre edilebileceğine dair uygulamalı örnekler verdiği ve bu sayede pasif öğrencileri hevesli üreticilere dönüştürdüğü bu videoya bir göz atın.</p>',
            'activities' => [
        ...
        '6' => [
            ...
            'text' => '<p>Rosanna Kurrer\'ın (CyberWayFinder Kurucusu) Uygulama Kâşifinin (App Inventor) ne olduğunu açıkladığı, sınıfta Uygulama geliştirmeyi kullanmanın avantajlarından saydığı ve öğretmenlerin Uygulama Kâşifini sınıfa nasıl entegre ederek, pasif öğrencileri coşkulu oyun yapımcılarına dönüştürebileceği konusunda bazı pratik örnekler verdiği bu videoya bir göz atın.</p>
<p>Faaliyetlerimizi koordine etmenin kolay ve hızlı bir yolu olduğu için uygulamaları hepimiz kullanıyoruz. Ayrıca kişiselleştirilmiş öğrenmeye izin verdikleri ve kullanıcıların bilgi edinmelerini sağladıkları için eğitimde gittikçe daha fazla kullanılmaktadırlar. Öyleyse neden öğrencilerinize başkaları için bir eğitim uygulaması oluşturma yetkisi vermiyorsunuz?</p>',
            'activities' => [
        ...
        '7' => [
            ...
            'text' => '<p>Meslekler ve iş yerleri değişiyor ve eğitim bunların adımlarını takip ediyor. Öğrencileri 21inci yüzyılın kariyerlerine hazırlarken, okul ile gerçeklik arasındaki boşluğu daralttıkları için deneme-yanılma, yapma ve bilgisayar korsanlığı yapma (hackleme) gibi yeni beceriler zorunlu hale gelmektedir. Sınıfı, problem çözmeye odaklanan işbirliğine dayalı bir ortama dönüştürerek, öğrenciler etkileşime girebilir ve gelişebilirler. Bu etkinlikler tartışmayı teşvik eder, böylece sınıfın her katkının önemli olduğu bir iletişim merkezi haline gelmesini sağlar.</p>
<p>Escola Global üyesi olan Portekizli STEAM öğretmeni Diogo da Silva, öğrencilerinizin deneme-yanılmalarına, yapmalarına ve bir çözüm yolu yaratmalarına yarayan bir ders geliştirerek sizi adım adım yönlendiren aşağıdaki videoya bir göz atın.</p>',
            'activities' => [
                '1' => 'Etkinlik 1 - İlkokul Adı',
                '2' => 'Etkinlik 2 - Ortaokul Adı',
                '3' => 'Etkinlik 3 - Lise Adı',
        ...
        '8' => [
            ...
            'text' => '<p>Sınıfta kodlamayı düşündüğünüzde, akla gelen ilk görüntü bilgisayar, Teknoloji, Matematik veya Bilim\'dir. Ancak, öğrencilerin birçok ilgi alanı ve konusu olduğu göz önüne alındığında, neden bunu lehimize kullanmıyor ve tüm müfredat boyunca kodlama uygulamıyoruz?</p>
<p>Kodlamayı sınıfa entegre etmenin, öğrencilerin eleştirel düşünme ve problem çözme becerilerini geliştirmelerine, aktif kullanıcı olmalarına ve okullarda gerekli olan kendi öğrenme süreçlerine liderlik etmelerine yardımcı olduğundan, birçok yararı vardır. Ancak, en önemlisi, öğrencilerinizin eğlenirken öğrenmesidir!</p>
<p>Diller, Müzik veya STEM (Bilim, Teknoloji, Mühendislik, Matematik) öğretmenlerin geleceğin bilim adamları, müzisyenleri, sanatçıları ve aslında herkes için kodlayabileceği konulardan sadece birkaçıdır! Tüm öğretmenler, kodlama ve hesaplamalı düşünmeyi sınıfta bütünleştirebilir. Günlük yaşam algoritmasını açıklamak için bir CLIL (İçerik ve dil bazlı eğitim) dersi kullanmak, bilim hakkında bilgi edinmek için keçeli bir oyun çubuğu oluşturmak veya Matematik dersinde motivasyonu arttırmak için eğitim robotlarını kullanmak, sınıfta yapabileceğiniz bazı etkinlik örnekleridir.</p>
<p>Müzik, Fen veya Dil öğretmenlerinin daha önce deneyiminiz olmasa bile, kodlama ve bilgisayarlı düşünmeyi sınıfta nasıl kolayca bütünleştirebildiklerini görmek için aşağıdaki videoya bakın.</p>',
            'activities' => [
...
Bu videoda, Kod Haftası ekibi size özellikle görme bozukluğu, Down sendromu ve Otizm Spektrumu bulunan öğrencilere uygun hale getirilmiş bazı pratik, kolay ve eğlenceli kodlama aktivitelerini gösterecek.                   
        ...
        '14' => [
            'title' => ' Akıllı Makineler Çağında Öğrenmek',
    ...
    'choose_lessons' => 'Aşağıdaki ders planlarından birini seçin ve öğrencilerinizle bir aktivite düzenleyin.',
    'footer' => [
